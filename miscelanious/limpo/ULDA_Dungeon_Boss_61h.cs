...
public class ULDA_Dungeon_Boss_61h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_01,
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_03,
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_04
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_01,
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_02,
    (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrackleDestroyMinion_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrowdRoaster_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerDragonRoar_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Death_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_03,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPower_04,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPowerRare_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_02,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Idle_03,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Intro_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_IntroResponseBrann_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_PlayerDragon_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_PlayerLightningSpell_01,
      (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_TurnOne_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "ULDA_Brann")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_IntroResponseBrann_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
  ...
  {
    ULDA_Dungeon_Boss_61h uldaDungeonBoss61h = this;
    while (uldaDungeonBoss61h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) uldaDungeonBoss61h.PlayBossLine(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_TurnOne_01);
        break;
      case 102:
        yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_HeroPowerRare_01);
        break;
      case 103:
        yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_PlayerDragon_01);
        break;
      case 104:
        yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrackleDestroyMinion_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) uldaDungeonBoss61h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_61h uldaDungeonBoss61h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss61h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss61h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss61h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss61h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss61h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "EX1_251" || cardId == "CFM_707" || cardId == "EX1_238" || cardId == "EX1_259" || cardId == "OG_206")
        yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_PlayerLightningSpell_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss61h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss61h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss61h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      {
        if (cardId == "TRL_362")
          yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerDragonRoar_01);
      }
      else
        yield return (object) uldaDungeonBoss61h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_61h.VO_ULDA_BOSS_61h_Female_Dragon_BossTriggerCrowdRoaster_01);
    }
  }
}
