...
public class GIL_Dungeon_Boss_23h : GIL_Dungeon
{
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_23h_Male_Ettin_Intro_01.prefab:bfc78b140b25432439cb2605adbe4519", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_23h_Male_Ettin_EmoteResponse_02.prefab:1eb9f9e18bad1594ea54fc761490bb26", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override string GetBossDeathLine() => "VO_GILA_BOSS_23h_Male_Ettin_Death_01.prefab:e098c858c01788c408eb0392c5ec7c5f";
