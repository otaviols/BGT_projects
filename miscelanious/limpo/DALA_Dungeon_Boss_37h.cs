...
public class DALA_Dungeon_Boss_37h : DALA_Dungeon
{
  ...
  {
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_01,
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_02,
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_03
  };
  private static List<string> m_IdleLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_01,
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_02,
    (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_BossElise_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Death_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_DefeatPlayer_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_EmoteResponse_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_02,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerDraw_03,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerShuffle_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerShuffle_02,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_HeroPowerShuffle_03,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_02,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Idle_03,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Intro_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerDeathKnight_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerDestroyMarinTreasure_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerGoldenCandle_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerKingsbane_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerMarin_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerPirate_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerTogglewagglesChest_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerTracking_01,
      (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_TurnStart_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Intro_01;
    this.m_deathLine = (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_Death_01;
    this.m_standardEmoteResponseLine = (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_EmoteResponse_01;
  }

  public override List<string> GetIdleLines() => DALA_Dungeon_Boss_37h.m_IdleLines;
  ...
  {
    DALA_Dungeon_Boss_37h dalaDungeonBoss37h = this;
    while (dalaDungeonBoss37h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) dalaDungeonBoss37h.PlayAndRemoveRandomLineOnlyOnce(actor, DALA_Dungeon_Boss_37h.m_HeroPowerDraw);
        break;
      case 102:
        yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerDestroyMarinTreasure_01);
        break;
      case 103:
        yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerPirate_01);
        break;
      case 104:
        yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_TurnStart_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) dalaDungeonBoss37h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DALA_Dungeon_Boss_37h dalaDungeonBoss37h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dalaDungeonBoss37h.\u003C\u003En__1(entity);
    while (dalaDungeonBoss37h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaDungeonBoss37h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      yield return (object) dalaDungeonBoss37h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss37h.m_playedLines.Add(cardId);
      switch (cardId)
      {
        case "DALA_701":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerTogglewagglesChest_01);
          break;
        case "DALA_709":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerGoldenCandle_01);
          break;
        case "DS1_184":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerTracking_01);
          break;
        case "ICC_481":
        case "ICC_827":
        case "ICC_828":
        ...
        case "ICC_833":
        case "ICC_834":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerDeathKnight_01);
          break;
        case "LOOT_357":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerMarin_01);
          break;
        case "LOOT_542":
          yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_PlayerKingsbane_01);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) dalaDungeonBoss37h.\u003C\u003En__2(entity);
      yield return (object) dalaDungeonBoss37h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss37h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "LOE_079")
        yield return (object) dalaDungeonBoss37h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_37h.VO_DALA_BOSS_37h_Male_Troll_BossElise_01);
    }
  }
}
