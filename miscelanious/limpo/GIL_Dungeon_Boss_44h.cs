...
public class GIL_Dungeon_Boss_44h : GIL_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_GILA_BOSS_44h_Male_Troll_Death_01.prefab:a2acdebd26eb1374dab8e62b6677b3de";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_44h_Male_Troll_Intro_01.prefab:9dd32ba7833dcfd44840ca37fba0b27b", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_44h_Male_Troll_EmoteResponse_01.prefab:058769cea8ad45d4da1351f69ff6a0dd", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    GIL_Dungeon_Boss_44h gilDungeonBoss44h = this;
    while (gilDungeonBoss44h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        string line1 = gilDungeonBoss44h.PopRandomLineWithChance(gilDungeonBoss44h.m_BossHeal);
        if (line1 == null)
          break;
        yield return (object) gilDungeonBoss44h.PlayLineOnlyOnce(actor, line1);
        break;
      case 102:
        string line2 = gilDungeonBoss44h.PopRandomLineWithChance(gilDungeonBoss44h.m_PlayerHeal);
        if (line2 == null)
          break;
        yield return (object) gilDungeonBoss44h.PlayLineOnlyOnce(actor, line2);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!gilDungeonBoss44h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) gilDungeonBoss44h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      gilDungeonBoss44h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "GILA_506t")
        yield return (object) gilDungeonBoss44h.PlayEasterEggLine(actor, "VO_GILA_BOSS_44h_Male_Troll_EventPlaysBandages_01.prefab:a37d44a72287bbb48abe47ac1092dc61");
    }
  }
}
