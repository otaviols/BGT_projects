...
public class BoH_Malfurion_06 : BoH_Malfurion_Dungeon
{
  ...
  {
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_01,
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_02,
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_01,
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_02,
    (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_03
  };
  ...
  public BoH_Malfurion_06() => this.m_gameOptions.AddBooleanOptions(BoH_Malfurion_06.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeA_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeB_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeB_04,
      (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6Intro_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6Victory_02,
      (string) BoH_Malfurion_06.VO_Prologue_Xavius_Male_Satyr_Prologue_Xavius_Death_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6_Victory_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6EmoteResponse_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeC_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeD_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeD_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6HeroPower_03,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_02,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Idle_03,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Intro_01,
      (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Loss_01,
      (string) BoH_Malfurion_06.VO_Story_Minion_Broll_Male_NightElf_Story_Malfurion_Mission6ExchangeB_01,
      (string) BoH_Malfurion_06.VO_Story_Minion_Broll_Male_NightElf_Story_Malfurion_Mission6ExchangeB_03,
      (string) BoH_Malfurion_06.VO_Story_Minion_Ysera_Female_Dragon_Story_Malfurion_Mission6_Victory_03,
      (string) BoH_Malfurion_06.VO_Story_Minion_Ysera_Female_Dragon_Story_Malfurion_Mission6ExchangeA_01
    };
  ...
  {
    BoH_Malfurion_06 boHMalfurion06 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHMalfurion06.MissionPlayVO(actor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Intro_01);
    yield return (object) boHMalfurion06.MissionPlayVO(friendlyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6Intro_02);
  ...
  public override void OnCreateGame()
  {
    ...
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6EmoteResponse_01;
  }
  ...
  {
    BoH_Malfurion_06 boHMalfurion06 = this;
    while (boHMalfurion06.m_enemySpeaking)
    ...
    {
      case 101:
        yield return (object) boHMalfurion06.PlayLineAlways((string) BoH_Malfurion_06.BrollBrassRing, (string) BoH_Malfurion_06.VO_Story_Minion_Broll_Male_NightElf_Story_Malfurion_Mission6ExchangeB_01);
        yield return (object) boHMalfurion06.PlayLineAlways(friendlyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeB_02);
        yield return (object) boHMalfurion06.PlayLineAlways((string) BoH_Malfurion_06.BrollBrassRing, (string) BoH_Malfurion_06.VO_Story_Minion_Broll_Male_NightElf_Story_Malfurion_Mission6ExchangeB_03);
        yield return (object) boHMalfurion06.PlayLineAlways(friendlyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeB_04);
        break;
      case 102:
        GameState.Get().SetBusy(true);
        yield return (object) boHMalfurion06.PlayLineAlways(actor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6_Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHMalfurion06.PlayLineAlways(friendlyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6Victory_02);
        yield return (object) boHMalfurion06.PlayLineAlways((string) BoH_Malfurion_06.YseraBrassRing, (string) BoH_Malfurion_06.VO_Story_Minion_Ysera_Female_Dragon_Story_Malfurion_Mission6_Victory_03);
        GameState.Get().SetBusy(false);
        break;
      case 507:
        GameState.Get().SetBusy(true);
        yield return (object) boHMalfurion06.PlayLineAlways(actor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHMalfurion06.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Malfurion_06 boHMalfurion06 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHMalfurion06.\u003C\u003En__1(entity);
    while (boHMalfurion06.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHMalfurion06.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHMalfurion06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHMalfurion06.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHMalfurion06.\u003C\u003En__2(entity);
      yield return (object) boHMalfurion06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHMalfurion06.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHMalfurion06.PlayLineAlways((string) BoH_Malfurion_06.YseraBrassRing, (string) BoH_Malfurion_06.VO_Story_Minion_Ysera_Female_Dragon_Story_Malfurion_Mission6ExchangeA_01);
        yield return (object) boHMalfurion06.PlayLineAlways(friendlyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission6ExchangeA_02);
        break;
      case 5:
        yield return (object) boHMalfurion06.PlayLineAlways(enemyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeC_01);
        break;
      case 7:
        yield return (object) boHMalfurion06.PlayLineAlways(enemyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeD_01);
        yield return (object) boHMalfurion06.PlayLineAlways(enemyActor, (string) BoH_Malfurion_06.VO_Story_Hero_Xavius_Male_Satyr_Story_Malfurion_Mission6ExchangeD_02);
        break;
    }
  }
}
