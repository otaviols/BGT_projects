...
{
  public override sealed AdventureDbId GetAdventureID() => AdventureDbId.BTA_HEROIC;
  ...
  {
    BTA_MissionEntity_Heroic missionEntityHeroic = this;
    string line = missionEntityHeroic.PopRandomLine(lines);
    if (line != null)
      yield return (object) missionEntityHeroic.PlayLineOnlyOnce(actor, line);
  }
