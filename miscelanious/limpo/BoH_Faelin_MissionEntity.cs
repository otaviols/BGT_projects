...
public abstract class BoH_Faelin_MissionEntity : GenericDungeonMissionEntity
{
  ...
  {
    BoH_Faelin_MissionEntity faelinMissionEntity = this;
    float bossHeroPowerVoLine = faelinMissionEntity.ChanceToPlayBossHeroPowerVOLine();
    float num = UnityEngine.Random.Range(0.0f, 1f);
    if (!faelinMissionEntity.m_enemySpeaking && !faelinMissionEntity.m_MissionDisableAutomaticVO && (double) bossHeroPowerVoLine >= (double) num)
    {
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!((UnityEngine.Object) actor == (UnityEngine.Object) null))
      {
        List<string> powerRandomLines = faelinMissionEntity.GetBossHeroPowerRandomLines();
        string str = "";
        ...
        if (!(str == ""))
          yield return (object) faelinMissionEntity.MissionPlayVO(actor, str);
      }
    }
  }
  ...
  {
    BoH_Faelin_MissionEntity faelinMissionEntity = this;
    if (!faelinMissionEntity.m_MissionDisableAutomaticVO && !faelinMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.OPPOSING)
      yield return (object) faelinMissionEntity.OnBossHeroPowerPlayed(entity);
  }
  ...
  {
    BoH_Faelin_MissionEntity faelinMissionEntity = this;
    if (!faelinMissionEntity.m_enemySpeaking)
    {
      Player currentPlayer = GameState.Get().GetCurrentPlayer();
      if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
      {
        GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
        if ((faelinMissionEntity.m_Mission_FriendlyPlayIdleLines || faelinMissionEntity.m_Mission_EnemyPlayIdleLines) && (double) faelinMissionEntity.GetThinkIdleChancePercentage() >= (double) UnityEngine.Random.Range(0.0f, 1f))
        {
          if ((double) faelinMissionEntity.GetThinkEmoteBossIdleChancePercentage() < (double) UnityEngine.Random.Range(0.0f, 1f) || !faelinMissionEntity.m_Mission_FriendlyPlayIdleLines && faelinMissionEntity.m_Mission_EnemyPlayIdleLines)
          {
            Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
            string line = faelinMissionEntity.PopRandomLine(faelinMissionEntity.m_BossIdleLinesCopy);
            if (faelinMissionEntity.m_BossIdleLinesCopy.Count == 0)
              faelinMissionEntity.m_BossIdleLinesCopy = new List<string>((IEnumerable<string>) faelinMissionEntity.m_BossIdleLines);
            yield return (object) faelinMissionEntity.MissionPlayVO(actor, line);
          }
          else if (faelinMissionEntity.m_Mission_FriendlyPlayIdleLines)
          {
  ...
  {
    BoH_Faelin_MissionEntity faelinMissionEntity = this;
    while (faelinMissionEntity.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (GameState.Get().GetGameEntity().GetTag(GAME_TAG.PREVIOUS_PUZZLE_COMPLETED) == 0)
    {
      faelinMissionEntity.MissionPause(true);
      yield return (object) faelinMissionEntity.HandleMissionEventWithTiming(520);
      faelinMissionEntity.MissionPause(false);
    }
  }
  ...
  {
    BoH_Faelin_MissionEntity faelinMissionEntity = this;
    Notification.SpeechBubbleDirection speakerDirection = faelinMissionEntity.GetDirection(actor);
    if (faelinMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlayLine(actor, line, shouldPlay, 2.5f));
    if (shouldPlay() == faelinMissionEntity.InternalShouldPlayAlways())
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlaySoundAndBlockSpeech(line, speakerDirection, actor, 2.5f));
    else if (shouldPlay() == faelinMissionEntity.InternalShouldPlayOnlyOnce())
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlaySoundAndBlockSpeechOnce(line, speakerDirection, actor, 2.5f));
  ...
  public IEnumerator MissionPlayVO(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(faelinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(faelinMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    bool bPlayOrder = false)
  {
    ...
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Once && !faelinMissionEntity.m_forceAlwaysPlayLine)
      removeLine = true;
    string line = !bPlayOrder ? faelinMissionEntity.PopNextLine(lines, removeLine) : faelinMissionEntity.PopRandomLine(lines, removeLine);
    if (line != null)
      yield return (object) faelinMissionEntity.MissionPlayVO(speaker, line, bUseBubble, shouldPlay);
  }
  ...
  public IEnumerator MissionPlaySound(Actor actor, string line)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlaySoundAndWait(line, (string) null, Notification.SpeechBubbleDirection.None, (Actor) null, waitTimeScale, parentBubbleToActor, delayCardSoundSpells));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVO(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(faelinMissionEntity.InternalShouldPlayAlways), false);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(((MissionEntity) faelinMissionEntity).InternalShouldPlayOnlyOnce), false);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    if (faelinMissionEntity.m_enemySpeaking)
      yield return (object) null;
    faelinMissionEntity.m_enemySpeaking = true;
    if (faelinMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Always)
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    else if (shouldPlay() == MissionEntity.ShouldPlayValue.Once)
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(faelinMissionEntity.PlayBigCharacterQuoteAndWaitOnce(brassRing, line));
      NotificationManager.Get().ForceAddSoundToPlayedList(line);
    }
    faelinMissionEntity.m_enemySpeaking = false;
  }
  ...
  public IEnumerator MissionPlayVO(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(faelinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) faelinMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(faelinMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
