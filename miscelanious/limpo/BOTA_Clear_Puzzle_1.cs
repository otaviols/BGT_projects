...
public class BOTA_Clear_Puzzle_1 : BOTA_MissionEntity
{
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_EmoteResponse_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_EmoteResponse_02,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_EmoteResponse_03,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_02,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_03,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_04,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_05,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_06,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Idle_07,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Intro_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_PlaySap_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Puzzle_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Puzzle_02,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Restart_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Restart_02,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Restart_03,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Restart_04,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Restart_05,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Return_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Complete_01,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_02,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_03,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_06,
      (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_07
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Return_01;
    this.s_victoryLine_1 = (string) null;
    this.s_victoryLine_2 = (string) null;
    this.s_victoryLine_3 = (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Puzzle_01;
    this.s_victoryLine_4 = (string) null;
    this.s_victoryLine_5 = (string) null;
    this.s_victoryLine_6 = (string) null;
    this.s_victoryLine_7 = (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_Puzzle_02;
  ...
  {
    BOTA_Clear_Puzzle_1 botaClearPuzzle1 = this;
    int currentMissionEvent = GameState.Get().GetGameEntity().GetTag(GAME_TAG.MISSION_EVENT);
    if (currentMissionEvent == 10)
      yield return (object) botaClearPuzzle1.PlayBigCharacterQuoteAndWait("FlobbidinousFloop_BrassRing_Quote.prefab:bdd400552a67a6e4381cf9a680ebf952", (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_02, "VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_02");
    if (currentMissionEvent == 20)
      yield return (object) botaClearPuzzle1.PlayBigCharacterQuoteAndWait("FlobbidinousFloop_BrassRing_Quote.prefab:bdd400552a67a6e4381cf9a680ebf952", (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_03, "VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_03");
    if (currentMissionEvent == 50)
      yield return (object) botaClearPuzzle1.PlayBigCharacterQuoteAndWait("FlobbidinousFloop_BrassRing_Quote.prefab:bdd400552a67a6e4381cf9a680ebf952", (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_07, "VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_07");
    if (currentMissionEvent == 80)
      yield return (object) botaClearPuzzle1.PlayBigCharacterQuoteAndWait("FlobbidinousFloop_BrassRing_Quote.prefab:bdd400552a67a6e4381cf9a680ebf952", (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_06, "VO_BOTA_BOSS_07h_Male_Ooze_Tutorial_06");
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    if (missionEvent == 99)
    {
      while (botaClearPuzzle1.m_enemySpeaking)
        yield return (object) null;
      GameState.Get().SetBusy(true);
      yield return (object) botaClearPuzzle1.PlayBigCharacterQuoteAndWait("FlobbidinousFloop_BrassRing_Quote.prefab:bdd400552a67a6e4381cf9a680ebf952", (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_07h_Male_Ooze_Complete_01, "VO_BOTA_BOSS_07h_Male_Ooze_Complete_01");
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!botaClearPuzzle1.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) botaClearPuzzle1.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      botaClearPuzzle1.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "EX1_581")
        yield return (object) botaClearPuzzle1.PlayEasterEggLine(actor, (string) BOTA_Clear_Puzzle_1.VO_BOTA_BOSS_06h_Male_Goblin_PlaySap_01);
    }
  }
}
