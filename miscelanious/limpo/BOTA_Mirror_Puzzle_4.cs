...
public class BOTA_Mirror_Puzzle_4 : BOTA_MissionEntity
{
  ...
  private string COMPLETE_LINE = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Complete_03;
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Complete_03,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_EmoteResponse_01,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_EmoteResponse_02,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_03,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_04,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_05,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_07,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_08,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_09,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_10,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Idle_11,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Intro_01,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_01,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_02,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_03,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Restart_01,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Restart_02,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Restart_03,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Restart_04,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Restart_06,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Return_01,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Stuck_02,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Stuck_03,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Stuck_04,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Stuck_05,
      (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_20h_Male_Goblin_UI_Wing2_Complete_01
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Return_01;
    this.s_victoryLine_1 = (string) null;
    this.s_victoryLine_2 = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_01;
    this.s_victoryLine_3 = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_03;
    this.s_victoryLine_4 = (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_05h_Male_Ethereal_Puzzle_02;
  ...
  {
    BOTA_Mirror_Puzzle_4 botaMirrorPuzzle4 = this;
    if (gameResult == TAG_PLAYSTATE.WON)
    {
      yield return (object) new WaitForSeconds(2f);
      yield return (object) botaMirrorPuzzle4.PlayClosingLine("DrBoom_Banner_Quote.prefab:ff8653a27a00c464ea5552e3c6b6dc5c", (string) BOTA_Mirror_Puzzle_4.VO_BOTA_BOSS_20h_Male_Goblin_UI_Wing2_Complete_01);
    }
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    if (missionEvent == 99)
    {
      while (botaMirrorPuzzle4.m_enemySpeaking)
        yield return (object) null;
      GameState.Get().SetBusy(true);
      yield return (object) botaMirrorPuzzle4.PlayBossLine(enemyActor, botaMirrorPuzzle4.COMPLETE_LINE);
