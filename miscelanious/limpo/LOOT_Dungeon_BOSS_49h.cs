...
public class LOOT_Dungeon_BOSS_49h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_49h_Male_Elemental_Death_01.prefab:4acf15c5d3b4a8347bec1d0959a526bf";

  protected override bool GetShouldSupressDeathTextBubble() => true;

  protected override float ChanceToPlayBossHeroPowerVOLine() => 1f;
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_49h_Male_Elemental_Intro_01.prefab:ac8ed0481b700e54ea96b415b7254a29", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_49h_Male_Elemental_EmoteResponse_01.prefab:fea117c2a4e020b4d8db820b9a991c51", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_49h lootDungeonBoss49h = this;
    while (lootDungeonBoss49h.m_enemySpeaking)
      yield return (object) null;
    yield return (object) lootDungeonBoss49h.PlayLoyalSideKickBetrayal(missionEvent);
  }
}
