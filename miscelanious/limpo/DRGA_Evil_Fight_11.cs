...
public class DRGA_Evil_Fight_11 : DRGA_Dungeon
{
  ...
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_01_Anduin_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_02_Anduin_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_03_Anduin_01
  };
  private List<string> m_Galakrond_Awesome = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_01_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_02_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_03_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_04_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_05_01
  };
  private List<string> m_Galakrond_Devastation = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_01_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_02_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_03_01
  };
  private List<string> m_Galakrond_Lategame = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_02_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_03_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_04_01
  };
  private List<string> m_missionEventTriggerRenoHeroPower = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_01_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_02_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_03_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_04_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_05_Reno_01
  };
  ...
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_01_Sylvanas_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_02_Sylvanas_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_03_Sylvanas_01
  };
  private List<string> m_InvokeGalakrond = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_01_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_02_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_03_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_04_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_05_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_06_01
  };
  private static List<string> m_AnduinIdleLines = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Idle_01_Anduin_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Idle_02_Anduin_01
  };
  private List<string> m_AnduinIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_AnduinIdleLines);
  private static List<string> m_SylvanasIdleLines = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_01_Sylvanas_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_02_Sylvanas_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_03_Sylvanas_01
  };
  private List<string> m_SylvanasIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_SylvanasIdleLines);
  private static List<string> m_RenoIdleLines = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_01_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_02_Reno_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_03_Reno_01
  };
  private List<string> m_RenoIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_RenoIdleLines);
  private List<string> m_VO_BossHasGalakrond = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_01_Galakrond_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_02_Galakrond_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_03_Galakrond_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_04_Galakrond_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_05_Galakrond_01
  };
  private List<string> m_VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_ExpositionLines = new List<string>()
  {
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_01_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_02_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_03_01,
    (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_04_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_Death_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_Death_Reno_Alt_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_01_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_02_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_03_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_04_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_HeroPower_05_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_BossAttack_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_BossStart_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_EmoteResponse_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_01_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_02_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Idle_03_Reno_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_01_01,
      ...
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_04_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_05_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_06a_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_06b_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Born_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_01a_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_01b_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_02_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_03_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_04_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Victory_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Sylvanas_a_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Sylvanas_b_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_Death_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_01_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_02_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_HeroPower_03_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_BossAttack_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_BossStart_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_EmoteResponse_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Idle_01_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Idle_02_Anduin_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_Death_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_01_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_02_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_HeroPower_03_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_BossAttack_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_BossStart_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_EmoteResponse_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_01_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_02_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Idle_03_Sylvanas_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_01_01,
      ...
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_05_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Boss_Invoke_06_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_BossAttack_Gala_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_BossAttack_NoGala_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_01_Galakrond_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_02_Galakrond_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_03_Galakrond_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_04_Galakrond_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_05_Galakrond_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_RenoDragon_Misc_05_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Idle_02_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_01_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_02_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_03_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Idle_04_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Laugh_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_01_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_02_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Boss_HeroPower_03_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Good_Fight_11_Misc_04_01,
      (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_BossStartHeroic_01,
      (string) DRGA_Evil_Fight_11.VO_DRG_610_Male_Dragon_Play_01,
      (string) DRGA_Evil_Fight_11.VO_DRG_600_Male_Dragon_Start_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_deathLine = (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_Death_Sylvanas_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (!this.m_Heroic)
      {
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_BossStart_Reno_01, Notification.SpeechBubbleDirection.TopRight, actor));
        return;
      }
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_03_BossStartHeroic_01, Notification.SpeechBubbleDirection.TopRight, actor));
    }
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    string cardId = GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
    if (cardId == "DRGA_BOSS_01h4")
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_EmoteResponse_Reno_01, Notification.SpeechBubbleDirection.TopRight, actor));
    else if (cardId == "DRGA_BOSS_37h")
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_EmoteResponse_Anduin_01, Notification.SpeechBubbleDirection.TopRight, actor));
    else if (cardId == "DRGA_BOSS_38h")
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_EmoteResponse_Sylvanas_01, Notification.SpeechBubbleDirection.TopRight, actor));
    else
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_EmoteResponse_Reno_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }
  ...
  {
    DRGA_Evil_Fight_11 drgaEvilFight11 = this;
    if (missionEvent == 911)
    {
      GameState.Get().SetBusy(true);
      while (drgaEvilFight11.m_enemySpeaking)
    ...
    else
    {
      ...
      {
        case 100:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_AnduinBossHeroPower);
          break;
        case 101:
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_BossAttack_Anduin_01);
          break;
        case 102:
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_BossStart_Anduin_01);
          break;
        case 103:
          yield return (object) drgaEvilFight11.PlayLineInOrderOnce(friendlyActor, drgaEvilFight11.m_Galakrond_Awesome);
          break;
        case 104:
          yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Born_01);
          break;
        case 106:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Victory_01);
          GameState.Get().SetBusy(false);
          break;
        case 107:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_Death_Anduin_01);
          GameState.Get().SetBusy(false);
          break;
        case 109:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_Death_Reno_01);
          GameState.Get().SetBusy(false);
          break;
        case 110:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_BossAttack_Reno_01);
          GameState.Get().SetBusy(false);
          break;
        case 112:
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_Boss_Death_Sylvanas_01);
          break;
        case 113:
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_BossAttack_Sylvanas_01);
          break;
        case 114:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_missionEventTriggerRenoHeroPower);
          break;
        case 115:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_missionEventTriggerAnduinHeroPower);
          break;
        case 116:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_missionEventTriggerSylvanasHeroPower);
          break;
        case 126:
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_RenoDragon_Misc_05_01);
          break;
        case 132:
          if (drgaEvilFight11.m_Galakrond)
            yield return (object) drgaEvilFight11.PlayLineOnlyOnce(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_BossAttack_Gala_01);
          if (drgaEvilFight11.m_Galakrond)
            break;
          yield return (object) drgaEvilFight11.PlayLineOnlyOnce(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_BossAttack_NoGala_01);
          break;
        case 133:
          if (!drgaEvilFight11.m_Galakrond)
            break;
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_VO_BossHasGalakrond);
          break;
        case 134:
          yield return (object) drgaEvilFight11.PlayLineInOrderOnce(friendlyActor, drgaEvilFight11.m_InvokeGalakrond);
          break;
        case 136:
          yield return (object) drgaEvilFight11.PlayLineInOrderOnce(friendlyActor, drgaEvilFight11.m_VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_ExpositionLines);
          break;
        case 137:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnceWithBrassRing(drgaEvilFight11.GetFriendlyActorByCardId("DRGA_005"), (AssetReference) null, drgaEvilFight11.m_Galakrond_Devastation);
          break;
        case 138:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_BossStart_Anduin_01);
          GameState.Get().SetBusy(false);
          break;
        case 139:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_38h_Female_Forsaken_Evil_Fight_11_BossStart_Sylvanas_01);
          GameState.Get().SetBusy(false);
          yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Sylvanas_a_01);
          yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Sylvanas_b_01);
          break;
        case 140:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Born_01);
          ...
          break;
        case 141:
          drgaEvilFight11.m_Galakrond = true;
          yield return (object) drgaEvilFight11.PlayLineAlwaysWithBrassRing(drgaEvilFight11.GetFriendlyActorByCardId("DRGA_005"), (AssetReference) null, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Idle_02_01);
          if (!(enemyHeroCardID == "DRGA_BOSS_01h4"))
            break;
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Good_Fight_11_Misc_04_01);
          break;
        case 142:
          GameState.Get().SetBusy(true);
          drgaEvilFight11.m_Galakrond = true;
        ...
        case 143:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_PlayerStart_Anduin_01);
          GameState.Get().SetBusy(false);
          break;
        case 144:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(drgaEvilFight11.GetFriendlyActorByCardId("DRGA_005"), (string) null, (string) DRGA_Evil_Fight_11.VO_DRG_610_Male_Dragon_Play_01);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_01h_Male_Human_Evil_Fight_11_Boss_Death_Reno_01);
          GameState.Get().SetBusy(false);
          break;
        case 145:
          GameState.Get().SetBusy(true);
          yield return (object) drgaEvilFight11.PlayLineAlways(drgaEvilFight11.GetFriendlyActorByCardId("DRGA_005"), (string) null, (string) DRGA_Evil_Fight_11.VO_DRG_600_Male_Dragon_Start_01);
          yield return (object) drgaEvilFight11.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_37h_Male_Human_Evil_Fight_11_Boss_Death_Anduin_01);
          GameState.Get().SetBusy(false);
          break;
        case 199:
          yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(enemyActor, drgaEvilFight11.m_RenoHeroPower);
          break;
        case 250:
          int num = drgaEvilFight11.GetTag(GAME_TAG.TURN) - GameState.Get().GetGameEntity().GetTag(GAME_TAG.EXTRA_TURNS_TAKEN_THIS_GAME);
          if (drgaEvilFight11.m_TurnOfGalakrondLine >= num)
            break;
          drgaEvilFight11.m_TurnOfGalakrondLine = num;
          if (drgaEvilFight11.m_GalakrondFirstAttack)
          {
            GameState.Get().SetBusy(true);
            yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Good_Fight_12_Misc_02_Galakrond_01);
            drgaEvilFight11.m_GalakrondFirstAttack = false;
            GameState.Get().SetBusy(false);
            break;
          }
          if (drgaEvilFight11.m_GalakrondAnduinFirstAttack && enemyHeroCardID == "DRGA_BOSS_37h")
          {
            yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_06a_01);
            yield return (object) drgaEvilFight11.PlayLineAlwaysWithBrassRing(drgaEvilFight11.GetFriendlyActorByCardId("DRGA_005"), (AssetReference) null, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_24h_Male_Dragon_Evil_Fight_12_Laugh_01);
            yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_Awesome_06b_01);
            drgaEvilFight11.m_GalakrondAnduinFirstAttack = false;
            break;
          }
          if (enemyHeroCardID == "DRGA_BOSS_37h" || enemyHeroCardID == "DRGA_BOSS_01h4")
          {
            yield return (object) drgaEvilFight11.PlayAndRemoveRandomLineOnlyOnce(friendlyActor, drgaEvilFight11.m_Galakrond_Awesome);
            break;
          }
          if (!(enemyHeroCardID == "DRGA_BOSS_38h"))
            break;
          if (drgaEvilFight11.m_GalakrondLategameFirstAttack)
          {
            yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_01a_01);
            yield return (object) drgaEvilFight11.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_11.VO_DRGA_BOSS_07h_Male_Ethereal_Evil_Fight_11_Galakrond_LateGame_01b_01);
            drgaEvilFight11.m_GalakrondLategameFirstAttack = false;
            break;
          }
          yield return (object) drgaEvilFight11.PlayLineInOrderOnce(friendlyActor, drgaEvilFight11.m_Galakrond_Lategame);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) drgaEvilFight11.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DRGA_Evil_Fight_11 drgaEvilFight11 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) drgaEvilFight11.\u003C\u003En__1(entity);
    while (drgaEvilFight11.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!drgaEvilFight11.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) drgaEvilFight11.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      drgaEvilFight11.m_playedLines.Add(cardId);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) drgaEvilFight11.\u003C\u003En__2(entity);
      yield return (object) drgaEvilFight11.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      drgaEvilFight11.m_playedLines.Add(cardId);
    }
  ...
  public override void OnPlayThinkEmote()
  {
    ...
    if ((double) this.GetThinkEmoteBossThinkChancePercentage() > (double) Random.Range(0.0f, 1f))
    {
      ...
      if (cardId == "DRGA_BOSS_01h4")
      {
        string line = this.PopRandomLine(this.m_RenoIdleLinesCopy);
        if (this.m_RenoIdleLinesCopy.Count == 0)
          this.m_RenoIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_RenoIdleLines);
        Gameplay.Get().StartCoroutine(this.PlayBossLine(actor, line));
      }
      else if (cardId == "DRGA_BOSS_37h")
      {
        string line = this.PopRandomLine(this.m_AnduinIdleLinesCopy);
        if (this.m_AnduinIdleLinesCopy.Count == 0)
          this.m_AnduinIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_AnduinIdleLines);
        Gameplay.Get().StartCoroutine(this.PlayBossLine(actor, line));
      }
      else
      {
        if (!(cardId == "DRGA_BOSS_38h"))
          return;
        string line = this.PopRandomLine(this.m_SylvanasIdleLinesCopy);
        if (this.m_SylvanasIdleLinesCopy.Count == 0)
          this.m_SylvanasIdleLinesCopy = new List<string>((IEnumerable<string>) DRGA_Evil_Fight_11.m_SylvanasIdleLines);
        Gameplay.Get().StartCoroutine(this.PlayBossLine(actor, line));
      }
    }
    else
