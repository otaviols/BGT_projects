...
public abstract class BoH_Andiun_MissionEntity : GenericDungeonMissionEntity
{
  ...
  {
    BoH_Andiun_MissionEntity andiunMissionEntity = this;
    float bossHeroPowerVoLine = andiunMissionEntity.ChanceToPlayBossHeroPowerVOLine();
    float num = UnityEngine.Random.Range(0.0f, 1f);
    if (!andiunMissionEntity.m_enemySpeaking && !andiunMissionEntity.m_MissionDisableAutomaticVO && (double) bossHeroPowerVoLine >= (double) num)
    {
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!((UnityEngine.Object) actor == (UnityEngine.Object) null))
      {
        List<string> powerRandomLines = andiunMissionEntity.GetBossHeroPowerRandomLines();
        string str = "";
        ...
        if (!(str == ""))
          yield return (object) andiunMissionEntity.MissionPlayVO(actor, str);
      }
    }
  }
  ...
  {
    BoH_Andiun_MissionEntity andiunMissionEntity = this;
    if (!andiunMissionEntity.m_MissionDisableAutomaticVO && !andiunMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.OPPOSING)
      yield return (object) andiunMissionEntity.OnBossHeroPowerPlayed(entity);
  }
  ...
  {
    BoH_Andiun_MissionEntity andiunMissionEntity = this;
    if (!andiunMissionEntity.m_enemySpeaking)
    {
      Player currentPlayer = GameState.Get().GetCurrentPlayer();
      if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
      {
        GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
        if ((andiunMissionEntity.m_Mission_FriendlyPlayIdleLines || andiunMissionEntity.m_Mission_EnemyPlayIdleLines) && (double) andiunMissionEntity.GetThinkIdleChancePercentage() >= (double) UnityEngine.Random.Range(0.0f, 1f))
        {
          if ((double) andiunMissionEntity.GetThinkEmoteBossIdleChancePercentage() < (double) UnityEngine.Random.Range(0.0f, 1f) || !andiunMissionEntity.m_Mission_FriendlyPlayIdleLines && andiunMissionEntity.m_Mission_EnemyPlayIdleLines)
          {
            Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
            string line = andiunMissionEntity.PopRandomLine(andiunMissionEntity.m_BossIdleLinesCopy);
            if (andiunMissionEntity.m_BossIdleLinesCopy.Count == 0)
              andiunMissionEntity.m_BossIdleLinesCopy = new List<string>((IEnumerable<string>) andiunMissionEntity.m_BossIdleLines);
            yield return (object) andiunMissionEntity.MissionPlayVO(actor, line);
          }
          else if (andiunMissionEntity.m_Mission_FriendlyPlayIdleLines)
          {
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    if (!((UnityEngine.Object) actor == (UnityEngine.Object) null))
    {
      Notification.SpeechBubbleDirection speakerDirection = andiunMissionEntity.GetDirection(actor);
      if (andiunMissionEntity.m_forceAlwaysPlayLine)
        yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlayLine(actor, line, shouldPlay, 2.5f));
      if (shouldPlay() == andiunMissionEntity.InternalShouldPlayAlways())
        yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlaySoundAndBlockSpeech(line, speakerDirection, actor, 2.5f));
      else if (shouldPlay() == andiunMissionEntity.InternalShouldPlayOnlyOnce())
      {
        yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlaySoundAndBlockSpeechOnce(line, speakerDirection, actor, 2.5f));
  ...
  public IEnumerator MissionPlayVO(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) andiunMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(andiunMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) andiunMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(andiunMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    bool bPlayOrder = false)
  {
    ...
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Once && !andiunMissionEntity.m_forceAlwaysPlayLine)
      removeLine = true;
    string line = !bPlayOrder ? andiunMissionEntity.PopNextLine(lines, removeLine) : andiunMissionEntity.PopRandomLine(lines, removeLine);
    if (line != null)
      yield return (object) andiunMissionEntity.MissionPlayVO(speaker, line, bUseBubble, shouldPlay);
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) andiunMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(((MissionEntity) andiunMissionEntity).InternalShouldPlayOnlyOnce), false);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    andiunMissionEntity.m_enemySpeaking = true;
    if (andiunMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Always)
      yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    else if (shouldPlay() == MissionEntity.ShouldPlayValue.Once)
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(andiunMissionEntity.PlayBigCharacterQuoteAndWaitOnce(brassRing, line));
      NotificationManager.Get().ForceAddSoundToPlayedList(line);
    }
    andiunMissionEntity.m_enemySpeaking = false;
  }
  ...
  public IEnumerator MissionPlayVO(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) andiunMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(andiunMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
