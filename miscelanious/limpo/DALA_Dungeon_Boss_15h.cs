...
public class DALA_Dungeon_Boss_15h : DALA_Dungeon
{
  ...
  {
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Idle_01,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Idle_02,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Idle_03
  };
  private List<string> m_HeroPowerLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_01,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_02,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_03,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_04,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_05,
    (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_06
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Death_02,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_DefeatPlayer_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_EmoteResponse_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_02,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_03,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_HeroPowerTrigger_04,
      ...
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Idle_02,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Idle_03,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Intro_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_IntroKriziki_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_PlayerDemon_01,
      (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_PlayerHeal_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Intro_01;
    this.m_deathLine = (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_Death_02;
    this.m_standardEmoteResponseLine = (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_EmoteResponse_01;
  }

  public override List<string> GetIdleLines() => DALA_Dungeon_Boss_15h.m_IdleLines;

  protected override bool GetShouldSuppressDeathTextBubble() => true;

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    DALA_Dungeon_Boss_15h dalaDungeonBoss15h = this;
    while (dalaDungeonBoss15h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) dalaDungeonBoss15h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_PlayerHeal_01);
        break;
      case 102:
        yield return (object) dalaDungeonBoss15h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_15h.VO_DALA_BOSS_15h_Female_NightElf_PlayerDemon_01);
        break;
      case 103:
        yield return (object) dalaDungeonBoss15h.PlayAndRemoveRandomLineOnlyOnce(actor, dalaDungeonBoss15h.m_HeroPowerLines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) dalaDungeonBoss15h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DALA_Dungeon_Boss_15h dalaDungeonBoss15h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dalaDungeonBoss15h.\u003C\u003En__1(entity);
    while (dalaDungeonBoss15h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaDungeonBoss15h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) dalaDungeonBoss15h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss15h.m_playedLines.Add(cardId);
    }
  }
