...
public class RP_Fight_03 : RP_Dungeon
{
  ...
  {
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_01_01,
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_02_01,
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_03_01
  };
  ...
  {
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_01_01,
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_02_01,
    (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_03_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_ExchangeA_02_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_ExchangeC_02_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Intro01_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Intro03_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Turn01_Response_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Turn02_Intro_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Victory_01,
      (string) RP_Fight_03.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission3_Turn01_Intro_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeA_01_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeB_01_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeC_01_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_Intro02_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_Turn02_Response_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Death_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_EmoteResponse_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_01_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_02_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_03_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_01_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_02_01,
      (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_03_01,
      (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Loss_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Idle_Lines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_HeroPower_Lines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_deathLine = (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_Death_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START || !MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_TB_ReturningPlayer_Houndmastr2_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    RP_Fight_03 rpFight03 = this;
    while (rpFight03.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        ...
        yield return (object) rpFight03.PlayLineAlways((string) RP_Fight_03.IllidanBrassRing, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 503:
        yield return (object) new WaitForSeconds(7f);
        yield return (object) rpFight03.PlayLineAlways((string) RP_Fight_03.IllidanBrassRing, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Intro01_01);
        yield return (object) rpFight03.PlayLineAlways(enemyActor, (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_Intro02_01);
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Intro03_01);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) rpFight03.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    RP_Fight_03 rpFight03 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) rpFight03.\u003C\u003En__1(entity);
    while (rpFight03.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!rpFight03.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) rpFight03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      rpFight03.m_playedLines.Add(cardId);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) rpFight03.\u003C\u003En__2(entity);
      yield return (object) rpFight03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      rpFight03.m_playedLines.Add(cardId);
    }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) rpFight03.PlayLineAlways((string) RP_Fight_03.MalfurionBrassRing, (string) RP_Fight_03.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission3_Turn01_Intro_01);
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Turn01_Response_01);
        break;
      case 3:
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_Turn02_Intro_01);
        yield return (object) rpFight03.PlayLineAlways(enemyActor, (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_Turn02_Response_01);
        break;
      case 6:
        yield return (object) rpFight03.PlayLineAlways(enemyActor, (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeA_01_01);
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_ExchangeA_02_01);
        break;
      case 11:
        yield return (object) rpFight03.PlayLineAlways(enemyActor, (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeB_01_01);
        break;
      case 15:
        yield return (object) rpFight03.PlayLineAlways(enemyActor, (string) RP_Fight_03.VO_TB_ReturningPlayer_Houndmastr2_Male_Demon_RP_Mission3_ExchangeC_01_01);
        yield return (object) rpFight03.PlayLineAlways(friendlyActor, (string) RP_Fight_03.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission3_ExchangeC_02_01);
        break;
    }
  }
