...
public class ULDA_Dungeon_Boss_06h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_01,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_02,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_03,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_04,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Idle_01,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Idle_02,
    (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Livewire_Lance_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Mirage_Blade_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_DeathALT_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_02,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_03,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_HeroPower_04,
      ...
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Idle_02,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Idle_03,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Intro_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_IntroBrannRespose_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Armored_Goon_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Madam_Goya_01,
      (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Mischief_Maker_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_DeathALT_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "ULDA_Brann")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_IntroBrannRespose_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
  ...
  {
    ULDA_Dungeon_Boss_06h uldaDungeonBoss06h = this;
    while (uldaDungeonBoss06h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    if (missionEvent == 101)
    {
      yield return (object) uldaDungeonBoss06h.PlayAndRemoveRandomLineOnlyOnce(actor, uldaDungeonBoss06h.m_HeroPowerLines);
    }
    else
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss06h.\u003C\u003En__0(missionEvent);
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_06h uldaDungeonBoss06h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss06h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss06h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss06h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss06h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss06h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_709"))
      {
        if (!(cardId == "CFM_672"))
        {
          if (cardId == "ULD_229")
            yield return (object) uldaDungeonBoss06h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Mischief_Maker_01);
        }
        else
          yield return (object) uldaDungeonBoss06h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Madam_Goya_01);
      }
      else
        yield return (object) uldaDungeonBoss06h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_PlayerTrigger_Armored_Goon_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss06h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss06h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss06h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      {
        if (cardId == "ULD_708")
          yield return (object) uldaDungeonBoss06h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Livewire_Lance_01);
      }
      else
        yield return (object) uldaDungeonBoss06h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_06h.VO_ULDA_BOSS_06h_Male_Pandaren_BossTrigger_Mirage_Blade_01);
    }
  }
}
