...
public class BoH_Anduin_03 : BoH_Anduin_Dungeon
{
  ...
  {
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_01,
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_02,
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_01,
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_02,
    (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_03
  };
  ...
  public BoH_Anduin_03() => this.m_gameOptions.AddBooleanOptions(BoH_Anduin_03.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeA_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeB_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeC_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3Intro_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3Victory_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3EmoteResponse_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3ExchangeC_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3ExchangeD_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3HeroPower_03,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_02,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Idle_03,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Loss_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Intro_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3ExchangeC_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3ExchangeD_01,
      (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3Victory_02,
      (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerAnduin_01,
      (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerHeal_01,
      (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerMoira_01
    };
  ...
  {
    BoH_Anduin_03 boHAnduin03 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHAnduin03.MissionPlayVO(actor, (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Intro_01);
    yield return (object) boHAnduin03.MissionPlayVO(friendlyActor, (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3Intro_02);
  ...
  public override void OnCreateGame()
  {
    ...
    this.m_standardEmoteResponseLine = (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3EmoteResponse_01;
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    {
      GameState.Get().SetBusy(true);
      while (boHAnduin03.m_enemySpeaking)
    ...
    else
    {
      ...
      {
        case 102:
          yield return (object) boHAnduin03.MissionPlayVOOnce(boHAnduin03.GetFriendlyActorByCardId("Story_05_HighPriestRohan"), (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerHeal_01);
          break;
        case 103:
          yield return (object) boHAnduin03.MissionPlayVOOnce(boHAnduin03.GetFriendlyActorByCardId("Story_05_HighPriestRohan"), (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerAnduin_01);
          break;
        case 105:
          yield return (object) boHAnduin03.MissionPlayVOOnce(boHAnduin03.GetFriendlyActorByCardId("Story_05_HighPriestRohan"), (string) BoH_Anduin_03.VO_Story_Minion_Rohan_Male_Dwarf_TriggerMoira_01);
          break;
        case 110:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin03.MissionPlayVO(BoH_Anduin_03.VarianBrassRing, (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3ExchangeC_01);
          yield return (object) boHAnduin03.MissionPlayVO(enemyActor, (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3ExchangeC_02);
          yield return (object) boHAnduin03.MissionPlayVO(friendlyActor, (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeC_01);
          GameState.Get().SetBusy(false);
          break;
        case 504:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin03.MissionPlayVO(friendlyActor, (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3Victory_02);
          yield return (object) boHAnduin03.MissionPlayVO(BoH_Anduin_03.VarianBrassRing, (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3Victory_02);
          GameState.Get().SetBusy(false);
          break;
        case 507:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin03.MissionPlayVO(enemyActor, (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3Loss_01);
          GameState.Get().SetBusy(false);
          break;
        case 515:
          yield return (object) boHAnduin03.MissionPlayVO(enemyActor, boHAnduin03.m_standardEmoteResponseLine);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) boHAnduin03.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Anduin_03 boHAnduin03 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHAnduin03.\u003C\u003En__1(entity);
    while (boHAnduin03.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHAnduin03.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHAnduin03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHAnduin03.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHAnduin03.\u003C\u003En__2(entity);
      yield return (object) boHAnduin03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHAnduin03.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHAnduin03.MissionPlayVO(friendlyActor, (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeA_01);
        break;
      case 3:
        yield return (object) boHAnduin03.MissionPlayVO(friendlyActor, (string) BoH_Anduin_03.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission3ExchangeB_01);
        break;
      case 5:
        GameState.Get().SetBusy(true);
        yield return (object) boHAnduin03.MissionPlayVO(BoH_Anduin_03.VarianBrassRing, (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3ExchangeC_01);
        ...
        break;
      case 7:
        yield return (object) boHAnduin03.MissionPlayVO(BoH_Anduin_03.VarianBrassRing, (string) BoH_Anduin_03.VO_Story_Hero_Varian_Male_Human_Story_Anduin_Mission3ExchangeD_01);
        yield return (object) boHAnduin03.MissionPlayVO(enemyActor, (string) BoH_Anduin_03.VO_Story_Hero_Moira_Female_Dwarf_Story_Anduin_Mission3ExchangeD_02);
        break;
    }
  }
}
