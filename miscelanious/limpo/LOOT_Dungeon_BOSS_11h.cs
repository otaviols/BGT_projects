...
public class LOOT_Dungeon_BOSS_11h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_11h_Male_Trogg_Death_01.prefab:5563abda7ad8407499b671cd4b63b3f8";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_11h_Male_Trogg_Intro_01.prefab:54f6017f84e6d824e93a04abd27f6f01", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_11h_Male_Trogg_EmoteResponse_01.prefab:ed6cf5a2a048fea4e98c50eff13cd707", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    LOOT_Dungeon_BOSS_11h lootDungeonBoss11h = this;
    while (lootDungeonBoss11h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!lootDungeonBoss11h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) lootDungeonBoss11h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      lootDungeonBoss11h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "EX1_619")
        yield return (object) lootDungeonBoss11h.PlayEasterEggLine(actor, "VO_LOOTA_BOSS_11h_Male_Trogg_EventEquality_01.prefab:6b570bed497bd2e458e70d929695c99c");
    }
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    while (lootDungeonBoss11h.m_enemySpeaking)
      yield return (object) null;
    yield return (object) lootDungeonBoss11h.PlayLoyalSideKickBetrayal(missionEvent);
  }
}
