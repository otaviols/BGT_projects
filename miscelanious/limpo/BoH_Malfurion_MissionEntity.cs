...
public abstract class BoH_Malfurion_MissionEntity : GenericDungeonMissionEntity
{
  ...
  {
    BoH_Malfurion_MissionEntity malfurionMissionEntity = this;
    float bossHeroPowerVoLine = malfurionMissionEntity.ChanceToPlayBossHeroPowerVOLine();
    float num = UnityEngine.Random.Range(0.0f, 1f);
    if (!malfurionMissionEntity.m_enemySpeaking && !malfurionMissionEntity.m_MissionDisableAutomaticVO && (double) bossHeroPowerVoLine >= (double) num)
    {
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!((UnityEngine.Object) actor == (UnityEngine.Object) null))
      {
        List<string> powerRandomLines = malfurionMissionEntity.GetBossHeroPowerRandomLines();
        string str = "";
        ...
        if (!(str == ""))
          yield return (object) malfurionMissionEntity.MissionPlayVO(actor, str);
      }
    }
  }
  ...
  {
    BoH_Malfurion_MissionEntity malfurionMissionEntity = this;
    if (!malfurionMissionEntity.m_MissionDisableAutomaticVO && !malfurionMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.OPPOSING)
      yield return (object) malfurionMissionEntity.OnBossHeroPowerPlayed(entity);
  }
  ...
  {
    BoH_Malfurion_MissionEntity malfurionMissionEntity = this;
    if (!malfurionMissionEntity.m_enemySpeaking)
    {
      Player currentPlayer = GameState.Get().GetCurrentPlayer();
      if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
      {
        GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
        if ((malfurionMissionEntity.m_Mission_FriendlyPlayIdleLines || malfurionMissionEntity.m_Mission_EnemyPlayIdleLines) && (double) malfurionMissionEntity.GetThinkIdleChancePercentage() >= (double) UnityEngine.Random.Range(0.0f, 1f))
        {
          if ((double) malfurionMissionEntity.GetThinkEmoteBossIdleChancePercentage() < (double) UnityEngine.Random.Range(0.0f, 1f) || !malfurionMissionEntity.m_Mission_FriendlyPlayIdleLines && malfurionMissionEntity.m_Mission_EnemyPlayIdleLines)
          {
            Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
            string line = malfurionMissionEntity.PopRandomLine(malfurionMissionEntity.m_BossIdleLinesCopy);
            if (malfurionMissionEntity.m_BossIdleLinesCopy.Count == 0)
              malfurionMissionEntity.m_BossIdleLinesCopy = new List<string>((IEnumerable<string>) malfurionMissionEntity.m_BossIdleLines);
            yield return (object) malfurionMissionEntity.MissionPlayVO(actor, line);
          }
          else if (malfurionMissionEntity.m_Mission_FriendlyPlayIdleLines)
          {
  ...
  {
    BoH_Malfurion_MissionEntity malfurionMissionEntity = this;
    Notification.SpeechBubbleDirection speakerDirection = malfurionMissionEntity.GetDirection(actor);
    if (malfurionMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlayLine(actor, line, shouldPlay, 2.5f));
    if (shouldPlay() == malfurionMissionEntity.InternalShouldPlayAlways())
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlaySoundAndBlockSpeech(line, speakerDirection, actor, 2.5f));
    else if (shouldPlay() == malfurionMissionEntity.InternalShouldPlayOnlyOnce())
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlaySoundAndBlockSpeechOnce(line, speakerDirection, actor, 2.5f));
  ...
  public IEnumerator MissionPlayVO(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) malfurionMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(malfurionMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    malfurionMissionEntity.m_enemySpeaking = true;
    if (malfurionMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Always)
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    else if (shouldPlay() == MissionEntity.ShouldPlayValue.Once)
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(malfurionMissionEntity.PlayBigCharacterQuoteAndWaitOnce(brassRing, line));
      NotificationManager.Get().ForceAddSoundToPlayedList(line);
    }
    malfurionMissionEntity.m_enemySpeaking = false;
  }
  ...
  public IEnumerator MissionPlayVO(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) malfurionMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(malfurionMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
