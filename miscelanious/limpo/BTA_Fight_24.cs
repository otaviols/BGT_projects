...
public class BTA_Fight_24 : BTA_Dungeon_Heroic
{
  ...
  {
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangElite_01,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangElite_02
  };
  private List<string> m_missionEventTrigger507Lines = new List<string>()
  {
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_01,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_02,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_03,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_04
  };
  private List<string> m_VO_BTA_BOSS_24h_IdleLines = new List<string>()
  {
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_IdleA_01,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_IdleB_01,
    (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_IdleC_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_Attack_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_BowEquip_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangElite_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangElite_02,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangWarlord_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_DeadlyShot_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossDeath_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStart_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStartIllidan_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Emote_Response_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Hero_LadyVashj_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_02,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_03,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_HeroPower_04,
      ...
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_IdleB_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_IdleC_01,
      (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_UI_Mission_Fight_24_CoinSelect_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_BTA_BOSS_24h_IdleLines;
  ...
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossDeath_01;
    this.m_standardEmoteResponseLine = (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Emote_Response_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "HERO_10" || cardId == "HERO_10a")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStartIllidan_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_BossStart_01, Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
  ...
  {
    BTA_Fight_24 btaFight24 = this;
    while (btaFight24.m_enemySpeaking)
    ...
    {
      case 500:
        yield return (object) btaFight24.PlayLineOnlyOnce(actor, (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_Attack_01);
        break;
      case 507:
        yield return (object) btaFight24.PlayAndRemoveRandomLineOnlyOnce(actor, btaFight24.m_missionEventTrigger507Lines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight24.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_24 btaFight24 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight24.\u003C\u003En__1(entity);
    while (btaFight24.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight24.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight24.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight24.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "BT_109")
        yield return (object) btaFight24.PlayLineOnlyOnce(actor, (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Hero_LadyVashj_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight24.\u003C\u003En__2(entity);
      yield return (object) btaFight24.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight24.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      if (!(cardId == "BTA_BOSS_24t"))
      {
        if (!(cardId == "BT_110"))
        {
          ...
          {
            if (cardId == "EX1_238")
              yield return (object) btaFight24.PlayLineOnlyOnce(actor, (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_DeadlyShot_01);
          }
          else
            yield return (object) btaFight24.PlayLineOnlyOnce(actor, (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangWarlord_01);
        }
        else
          yield return (object) btaFight24.PlayLineOnlyOnce(actor, (string) BTA_Fight_24.VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_BowEquip_01);
      }
      else
        yield return (object) btaFight24.PlayAndRemoveRandomLineOnlyOnce(actor, btaFight24.m_VO_BTA_BOSS_24h_Female_Naga_Mission_Fight_24_Boss_CoilfangEliteLines);
    }
  }
