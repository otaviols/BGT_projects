...
public class ULDA_Dungeon_Boss_27h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_01,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_02,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_03,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_04,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Idle_01,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Idle_02,
    (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossCleverDisguise_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossTriggerTreasure_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossWastewanderSapper_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Death_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_02,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_03,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_HeroPower_04,
      ...
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Idle_02,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Idle_03,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Intro_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_IntroElise_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_PlayerHeroTreasure_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_PlayerZephyrs_01,
      (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_TurnOne_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "ULDA_Elise")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_IntroElise_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
  ...
  {
    ULDA_Dungeon_Boss_27h uldaDungeonBoss27h = this;
    while (uldaDungeonBoss27h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) uldaDungeonBoss27h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_PlayerHeroTreasure_01);
        break;
      case 102:
        yield return (object) uldaDungeonBoss27h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossTriggerTreasure_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) uldaDungeonBoss27h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_27h uldaDungeonBoss27h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss27h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss27h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss27h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss27h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss27h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_280"))
      {
        if (cardId == "ULD_003")
          yield return (object) uldaDungeonBoss27h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_PlayerZephyrs_01);
      }
      else
        yield return (object) uldaDungeonBoss27h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossWastewanderSapper_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss27h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss27h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss27h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "ULD_328")
        yield return (object) uldaDungeonBoss27h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_27h.VO_ULDA_BOSS_27h_Male_Troll_BossCleverDisguise_01);
    }
  }
}
