...
public class BnetFriendChangelist
{
  ...
  public List<BnetInvitation> GetAddedReceivedInvites() => this.m_receivedInvitesAdded;

  public List<BnetInvitation> GetRemovedReceivedInvites() => this.m_receivedInvitesRemoved;

  public bool IsEmpty() => (this.m_friendsAdded == null || this.m_friendsAdded.Count <= 0) && (this.m_friendsRemoved == null || this.m_friendsRemoved.Count <= 0) && (this.m_receivedInvitesAdded == null || this.m_receivedInvitesAdded.Count <= 0) && (this.m_receivedInvitesRemoved == null || this.m_receivedInvitesRemoved.Count <= 0) && (this.m_sentInvitesAdded == null || this.m_sentInvitesAdded.Count <= 0) && (this.m_sentInvitesRemoved == null || this.m_sentInvitesRemoved.Count <= 0);
  ...
  public bool RemoveAddedReceivedInvite(BnetInvitation invite) => this.m_receivedInvitesAdded != null && this.m_receivedInvitesAdded.Remove(invite);
