...
public class DALA_Tavern : DALA_Dungeon
{
  ...
  {
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Idle_01,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Idle_02,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Idle_03
  };
  private static List<string> m_Bartendortron_IdleLines = new List<string>()
  {
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_01,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_02,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_03
  };
  private static List<string> m_OutroLinesCopy = new List<string>();
  private static List<string> m_OutroLines = new List<string>()
  {
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_01,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_02,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_03,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_04,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_05
  };
  ...
  {
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_01,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_02,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_03
  };
  private List<string> m_IntroLines = new List<string>()
  {
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_02,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_03,
    (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_04
  };
  private List<string> m_Bartendortron_IntroLines = new List<string>()
  {
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_01,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_02,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_03,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_04,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_05,
    (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_06
  };
  private HashSet<string> m_playedLines = new HashSet<string>();
  public bool m_thinkEmoteFirstRun = true;

  public DALA_Tavern() => SceneMgr.Get().RegisterSceneLoadedEvent(new SceneMgr.SceneLoadedCallback(this.OnGameplaySceneLoaded));
  ...
  public override void PreloadAssets()
  {
    ...
    List<string> VOLines = new List<string>()
    {
      ...
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Idle_02,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Idle_03,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_02,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_03,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_04,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_05,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroChu_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroEudora_02,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroGeorge_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroKriziki_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroOlBarkeye_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroRakanishu_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroSqueamlish_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroTekahn_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroVessina_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_02,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_03,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_04,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Outro_05,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerBrood_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerBrood_02,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerDismiss_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerGoodFood_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerKindle_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRecruit_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRecruitAVeteran_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRightHandMan_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRoundOfDrinks_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTakeAChance_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTallTales_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTellAStory_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTheGangsAllHere_01,
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerYoureAllFired_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Death_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_02,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Idle_03,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_01,
      ...
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_05,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Intro_06,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroChu_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroEudora_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroGeorge_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroKriziki_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroOlBarkeye_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroRakanishu_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroSqueamlish_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroTekahn_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroVessina_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_02,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_Outro_03,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerBrood_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerBrood_02,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerDismiss_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerGoodFood_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerKindle_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRecruit_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRecruitAVeteran_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRightHandMan_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRightHandMan_02,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRoundOfDrinks_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTakeAChance_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTallTales_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTellAStory_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTheChallenge_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTheGangsAllHere_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerYoureAllFired_01,
      (string) DALA_Tavern.VO_DALA_901h_Male_Mech_TurnOne_01
    };
    this.SetBossVOLines(VOLines);
    foreach (string soundPath in VOLines)
      this.PreloadSound(soundPath);
    this.m_VOPools.Add(909, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_DRUID_VO));
    this.m_VOPools.Add(910, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_HUNTER_VO));
    this.m_VOPools.Add(911, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_MAGE_VO));
    this.m_VOPools.Add(912, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_PALADIN_VO));
    this.m_VOPools.Add(913, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_PRIEST_VO));
    this.m_VOPools.Add(914, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_ROGUE_VO));
    this.m_VOPools.Add(915, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_SHAMAN_VO));
    this.m_VOPools.Add(916, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_WARLOCK_VO));
    this.m_VOPools.Add(917, new GenericDungeonMissionEntity.VOPool(new List<string>()
    {
      (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_01
    }, 1f, MissionEntity.ShouldPlayValue.Once, GenericDungeonMissionEntity.VOSpeaker.OPPONENT_HERO, (string) null, GameSaveKeySubkeyId.DAL_DUNGEON_HAS_SEEN_TAVERN_WARRIOR_VO));
  }

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) DALA_Tavern.VO_DALA_900h_Male_Human_Intro_05;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (cardId == DALA_Tavern.BARTENDOTRON_CARDID)
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DALA_Tavern.VO_DALA_901h_Male_Mech_TurnOne_01, Notification.SpeechBubbleDirection.TopRight, actor));
    else
  ...
  {
    DALA_Tavern dalaTavern = this;
    while (dalaTavern.m_enemySpeaking)
      yield return (object) null;
    string cardId1 = GameState.Get().GetFriendlySidePlayer().GetHero().GetCardId();
    GenericDungeonMissionEntity.VOPool voPool1 = (GenericDungeonMissionEntity.VOPool) null;
    int num1 = 0;
    ...
    if (cardId2 == DALA_Tavern.BARTENDERBOB_CARDID)
    {
      ...
      {
        case 101:
          if (cardId1 == "DALA_Squeamlish")
          {
            num1 = 909;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroSqueamlish_01;
          }
          if (cardId1 == "DALA_Barkeye")
          {
            num1 = 910;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroOlBarkeye_01;
          }
          if (cardId1 == "DALA_Rakanishu")
          {
            num1 = 911;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroRakanishu_01;
          }
          if (cardId1 == "DALA_George")
          {
            num1 = 912;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroGeorge_01;
          }
          if (cardId1 == "DALA_Kriziki")
          {
            num1 = 913;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroKriziki_01;
          }
          if (cardId1 == "DALA_Eudora")
          {
            num1 = 913;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroEudora_02;
          }
          if (cardId1 == "DALA_Vessina")
          {
            num1 = 915;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroVessina_01;
          }
          if (cardId1 == "DALA_Tekahn")
          {
            num1 = 916;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroTekahn_01;
          }
          if (cardId1 == "DALA_Chu")
          {
            num1 = 917;
            voPool1 = dalaTavern.m_VOPools[num1];
            str = (string) DALA_Tavern.VO_DALA_900h_Male_Human_IntroChu_01;
          }
          long num2;
          GameSaveDataManager.Get().GetSubkeyValue(GameSaveKeyId.ADVENTURE_DATA_CLIENT_DALARAN, voPool1.m_oncePerAccountGameSaveSubkey, out num2);
          if (num2 > 0L)
          {
            for (int index = 0; index < 3; ++index)
              dalaTavern.m_IntroLines.Add(str);
            string soundPath = dalaTavern.PopRandomLine(dalaTavern.m_IntroLines);
            yield return (object) Gameplay.Get().StartCoroutine(dalaTavern.PlaySoundAndBlockSpeech(soundPath, Notification.SpeechBubbleDirection.TopRight, actor));
            break;
          }
          // ISSUE: reference to a compiler-generated method
          yield return (object) Gameplay.Get().StartCoroutine(dalaTavern.\u003C\u003En__0(num1));
          break;
        case 102:
          GameState.Get().SetBusy(true);
          if (DALA_Tavern.m_OutroLinesCopy.Count == 0)
            DALA_Tavern.m_OutroLinesCopy = new List<string>((IEnumerable<string>) DALA_Tavern.m_OutroLines);
          string soundPath1 = dalaTavern.PopRandomLine(DALA_Tavern.m_OutroLinesCopy);
          yield return (object) Gameplay.Get().StartCoroutine(dalaTavern.PlaySoundAndBlockSpeech(soundPath1, Notification.SpeechBubbleDirection.TopRight, actor));
          GameState.Get().SetBusy(false);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) dalaTavern.\u003C\u003En__0(missionEvent);
          break;
      }
    }
    else if (cardId2 == DALA_Tavern.BARTENDOTRON_CARDID)
    {
      switch (missionEvent)
      {
        case 101:
          GenericDungeonMissionEntity.VOPool voPool2;
          if (cardId1 == "DALA_Squeamlish")
          {
            int key = 909;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroSqueamlish_01;
          }
          if (cardId1 == "DALA_Barkeye")
          {
            int key = 910;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroOlBarkeye_01;
          }
          if (cardId1 == "DALA_Rakanishu")
          {
            int key = 911;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroRakanishu_01;
          }
          if (cardId1 == "DALA_George")
          {
            int key = 912;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroGeorge_01;
          }
          if (cardId1 == "DALA_Kriziki")
          {
            int key = 913;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroKriziki_01;
          }
          if (cardId1 == "DALA_Eudora")
          {
            int key = 913;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroEudora_01;
          }
          if (cardId1 == "DALA_Vessina")
          {
            int key = 915;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroVessina_01;
          }
          if (cardId1 == "DALA_Tekahn")
          {
            int key = 916;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroTekahn_01;
          }
          if (cardId1 == "DALA_Chu")
          {
            int key = 917;
            voPool2 = dalaTavern.m_VOPools[key];
            str = (string) DALA_Tavern.VO_DALA_901h_Male_Mech_IntroChu_01;
          }
          for (int index = 0; index < 3; ++index)
            dalaTavern.m_Bartendortron_IntroLines.Add(str);
          string soundPath2 = dalaTavern.PopRandomLine(dalaTavern.m_Bartendortron_IntroLines);
          yield return (object) Gameplay.Get().StartCoroutine(dalaTavern.PlaySoundAndBlockSpeech(soundPath2, Notification.SpeechBubbleDirection.TopRight, actor));
          break;
        case 102:
          GameState.Get().SetBusy(true);
          if (DALA_Tavern.m_Bartendortron_OutroLinesCopy.Count == 0)
            DALA_Tavern.m_Bartendortron_OutroLinesCopy = new List<string>((IEnumerable<string>) DALA_Tavern.m_Bartendortron_OutroLines);
          string soundPath3 = dalaTavern.PopRandomLine(DALA_Tavern.m_Bartendortron_OutroLinesCopy);
          yield return (object) Gameplay.Get().StartCoroutine(dalaTavern.PlaySoundAndBlockSpeech(soundPath3, Notification.SpeechBubbleDirection.TopRight, actor));
          GameState.Get().SetBusy(false);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaTavern.m_playedLines.Contains(entity.GetCardId()))
    {
      string enemyHeroCardID = GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
      yield return (object) dalaTavern.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaTavern.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
      if (enemyHeroCardID == DALA_Tavern.BARTENDERBOB_CARDID)
      {
        ...
        {
          case "DALA_901":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRecruit_01);
            break;
          case "DALA_902":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerDismiss_01);
            break;
          case "DALA_903":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTakeAChance_01);
            break;
          case "DALA_904":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerGoodFood_01);
            break;
          case "DALA_905":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRightHandMan_01);
            break;
          case "DALA_906":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRoundOfDrinks_01);
            break;
          case "DALA_907":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerRecruitAVeteran_01);
            break;
          case "DALA_908":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTellAStory_01);
            break;
          case "DALA_909":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerYoureAllFired_01);
            break;
          case "DALA_910":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTheGangsAllHere_01);
            break;
          case "DALA_911":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerKindle_01);
            break;
          case "DALA_912":
            if (Random.Range(1, 11) == 1)
            {
              yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerBrood_02);
              break;
            }
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerBrood_01);
            break;
          case "DALA_913":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_900h_Male_Human_PlayerTallTales_01);
            break;
        }
      }
      else if (enemyHeroCardID == DALA_Tavern.BARTENDOTRON_CARDID)
      {
        ...
        {
          case "DALA_901":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRecruit_01);
            break;
          case "DALA_902":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerDismiss_01);
            break;
          case "DALA_903":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTakeAChance_01);
            break;
          case "DALA_904":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerGoodFood_01);
            break;
          case "DALA_905":
            if (Random.Range(1, 3) == 1)
            {
              yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRightHandMan_01);
              break;
            }
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRightHandMan_02);
            break;
          case "DALA_906":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRoundOfDrinks_01);
            break;
          case "DALA_907":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerRecruitAVeteran_01);
            break;
          case "DALA_908":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTellAStory_01);
            break;
          case "DALA_909":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerYoureAllFired_01);
            break;
          case "DALA_910":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTheGangsAllHere_01);
            break;
          case "DALA_911":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerKindle_01);
            break;
          case "DALA_912":
            if (Random.Range(1, 11) == 1)
            {
              yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerBrood_02);
              break;
            }
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerBrood_01);
            break;
          case "DALA_913":
            yield return (object) dalaTavern.PlayLineOnlyOnce(actor, (string) DALA_Tavern.VO_DALA_901h_Male_Mech_PlayerTallTales_01);
            break;
        }
      }
    }
  ...
  public override void OnPlayThinkEmote()
  {
    ...
    if (this.m_thinkEmoteFirstRun)
    {
      if (cardId == DALA_Tavern.BARTENDOTRON_CARDID)
      {
        this.m_BossIdleLines = new List<string>((IEnumerable<string>) DALA_Tavern.m_Bartendortron_IdleLines);
        this.m_BossIdleLinesCopy = new List<string>((IEnumerable<string>) DALA_Tavern.m_Bartendortron_IdleLines);
      }
      else
      {
        this.m_BossIdleLines = new List<string>((IEnumerable<string>) DALA_Tavern.m_IdleLines);
        this.m_BossIdleLinesCopy = new List<string>((IEnumerable<string>) DALA_Tavern.m_IdleLines);
      }
  ...
  public override string[] GetOverrideBoardClickSounds() => new string[4]
  {
