...
public class BoH_Jaina_02 : BoH_Jaina_Dungeon
{
  ...
  {
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_01,
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_02,
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_03
  };
  private List<string> m_VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2IdleLines = new List<string>()
  {
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_01,
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_02,
    (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_03
  };
  ...
  public BoH_Jaina_02() => this.m_gameOptions.AddBooleanOptions(BoH_Jaina_02.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeA_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeB_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeC_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2Intro_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2Victory_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission1EmoteResponse_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeA_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeB_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeC_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeC_02,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_02,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2HeroPower_03,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_02,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Idle_03,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Intro_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Loss_01,
      (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Victory_01
    };
  ...
  {
    BoH_Jaina_02 boHJaina02 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHJaina02.PlayLineAlways(actor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Intro_01);
    yield return (object) boHJaina02.PlayLineAlways(friendlyActor, (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2Intro_01);
    GameState.Get().SetBusy(false);
  }

  public override List<string> GetIdleLines() => this.m_VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2IdleLines;
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission1EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    BoH_Jaina_02 boHJaina02 = this;
    while (boHJaina02.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) boHJaina02.PlayLineAlways(actor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Victory_01);
        yield return (object) boHJaina02.PlayLineAlways(friendlyActor, (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHJaina02.PlayLineAlways(actor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHJaina02.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Jaina_02 boHJaina02 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHJaina02.\u003C\u003En__1(entity);
    while (boHJaina02.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHJaina02.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHJaina02.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHJaina02.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHJaina02.\u003C\u003En__2(entity);
      yield return (object) boHJaina02.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHJaina02.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHJaina02.PlayLineAlways(enemyActor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeA_01);
        yield return (object) boHJaina02.PlayLineAlways(friendlyActor, (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeA_01);
        break;
      case 5:
        yield return (object) boHJaina02.PlayLineAlways(enemyActor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeB_01);
        yield return (object) boHJaina02.PlayLineAlways(friendlyActor, (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeB_01);
        break;
      case 7:
        yield return (object) boHJaina02.PlayLineAlways(enemyActor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeC_01);
        yield return (object) boHJaina02.PlayLineAlways(friendlyActor, (string) BoH_Jaina_02.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission2ExchangeC_01);
        yield return (object) boHJaina02.PlayLineAlways(enemyActor, (string) BoH_Jaina_02.VO_Story_Hero_Kaelthas_Male_BloodElf_Story_Jaina_Mission2ExchangeC_02);
        break;
    }
  }

  public override void StartGameplaySoundtracks() => MusicManager.Get().StartPlaylist(MusicPlaylistType.InGame_Karazhan);
}
