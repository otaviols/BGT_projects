...
public class BoH_Garrosh_06 : BoH_Garrosh_Dungeon
{
  ...
  {
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_01,
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_02,
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_03
  };
  private List<string> m_VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6IdleLines = new List<string>()
  {
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_01,
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_02,
    (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeA_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeB_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeC_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeD_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6ExchangeA_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6Intro_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6Victory_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6EmoteResponse_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeC_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeD_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_02,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPower_03,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_02,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Idle_03,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Loss_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Victory_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6ExchangeA_01,
      (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6Intro_01
    };
  ...
  {
    BoH_Garrosh_06 boHGarrosh06 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6Intro_01);
    yield return (object) boHGarrosh06.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6Intro_01);
    GameState.Get().SetBusy(false);
  }

  public override List<string> GetIdleLines() => this.m_VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6IdleLines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6HeroPowerLines;
  ...
  {
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6EmoteResponse_01;
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    {
      GameState.Get().SetBusy(true);
      while (boHGarrosh06.m_enemySpeaking)
    ...
    else
    {
      ...
      switch (missionEvent)
      {
        ...
        case 105:
          ...
          break;
        case 501:
          yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6Victory_01);
          yield return (object) boHGarrosh06.PlayLineAlways(enemyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Victory_01);
          break;
        case 502:
          ++boHGarrosh06.GatesAttackedCounter;
          if (boHGarrosh06.GatesAttackedCounter == 4)
          {
            yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeB_01);
            break;
          }
          yield return (object) null;
          break;
        case 504:
          GameState.Get().SetBusy(true);
          yield return (object) boHGarrosh06.PlayLineAlways(enemyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6Loss_01);
          GameState.Get().SetBusy(false);
          break;
        case 911:
          GameState.Get().SetBusy(true);
        ...
        default:
          ...
          yield return (object) boHGarrosh06.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Garrosh_06 boHGarrosh06 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHGarrosh06.\u003C\u003En__1(entity);
    while (boHGarrosh06.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHGarrosh06.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHGarrosh06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHGarrosh06.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHGarrosh06.\u003C\u003En__2(entity);
      yield return (object) boHGarrosh06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHGarrosh06.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission6ExchangeA_01);
        yield return (object) boHGarrosh06.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Jaina_Mission6ExchangeA_01);
        break;
      case 3:
        yield return (object) boHGarrosh06.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeA_01);
        break;
      case 5:
        yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeC_01);
        yield return (object) boHGarrosh06.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeC_01);
        break;
      case 7:
        yield return (object) boHGarrosh06.PlayLineAlways(actor, (string) BoH_Garrosh_06.VO_Story_Hero_Jaina_Female_Human_Story_Garrosh_Mission6ExchangeD_01);
        yield return (object) boHGarrosh06.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_06.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission6ExchangeD_01);
        break;
    }
  }
