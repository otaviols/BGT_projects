...
public class BOM_10_Dawngrasp_Dungeon : BOM_10_Dawngrasp_MissionEntity
{
  ...
  {
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Cariel_Female_Human_BOM_Scabbs_HeroPower_01,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Cariel_Female_Human_BOM_Scabbs_HeroPower_02,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Cariel_Female_Human_BOM_Scabbs_HeroPower_03
  };
  private List<string> m_Kurtrus_HeroPowerLines = new List<string>()
  {
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Kurtrus_Male_NightElf_BOM_Scabbs_HeroPower_01,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Kurtrus_Male_NightElf_BOM_Scabbs_HeroPower_02,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Kurtrus_Male_NightElf_BOM_Scabbs_HeroPower_03
  };
  private List<string> m_Tavish_HeroPowerLines = new List<string>()
  {
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Tavish_Male_Dwarf_BOM_Scabbs_HeroPower_01,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Tavish_Male_Dwarf_BOM_Scabbs_HeroPower_02,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Tavish_Male_Dwarf_BOM_Scabbs_HeroPower_03
  };
  private List<string> m_Xyrella_HeroPowerLines = new List<string>()
  {
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Xyrella_Female_Draenei_BOM_Scabbs_HeroPower_01,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Xyrella_Female_Draenei_BOM_Scabbs_HeroPower_02,
    (string) BOM_10_Dawngrasp_Dungeon.VO_Story_Hero_Xyrella_Female_Draenei_BOM_Scabbs_HeroPower_03
  };
  ...
  {
    BOM_10_Dawngrasp_Dungeon dawngraspDungeon = this;
    GameState.Get().GetFriendlySidePlayer().GetHeroCard().GetActor();
    GameState.Get().GetFriendlySidePlayer().GetHero().GetCardId();
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dawngraspDungeon.\u003C\u003En__0(entity);
    yield return (object) dawngraspDungeon.WaitForEntitySoundToFinish(entity);
    entity.GetCardId();
  }
  ...
  public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
  {
    ...
    if (num != 0)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.\u003C\u003E1__state = -1;
      dawngraspDungeon.MissionPause(false);
      return false;
    }
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    dawngraspDungeon.MissionPause(true);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) dawngraspDungeon.HandleMissionEventWithTiming(514);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  {
    BOM_10_Dawngrasp_Dungeon dawngraspDungeon = this;
    while (dawngraspDungeon.m_enemySpeaking)
      yield return (object) null;
    if (missionEvent == 911)
    {
    ...
    else
    {
      ...
      dawngraspDungeon.GetTag(GAME_TAG.TURN);
      GameState.Get().GetGameEntity().GetTag(GAME_TAG.EXTRA_TURNS_TAKEN_THIS_GAME);
      double num2 = (double) Random.Range(0.0f, 1f);
      switch (missionEvent)
      {
        case 508:
          if (dawngraspDungeon.HeroPowerIsCariel)
            yield return (object) dawngraspDungeon.MissionPlaySound(friendlyHeroPowerActor, dawngraspDungeon.m_Cariel_HeroPowerLines);
          if (dawngraspDungeon.HeroPowerIsKurtrus)
            yield return (object) dawngraspDungeon.MissionPlaySound(friendlyHeroPowerActor, dawngraspDungeon.m_Kurtrus_HeroPowerLines);
          if (dawngraspDungeon.HeroPowerIsTavish)
            yield return (object) dawngraspDungeon.MissionPlaySound(friendlyHeroPowerActor, dawngraspDungeon.m_Tavish_HeroPowerLines);
          if (!dawngraspDungeon.HeroPowerIsXyrella)
            break;
          yield return (object) dawngraspDungeon.MissionPlaySound(friendlyHeroPowerActor, dawngraspDungeon.m_Xyrella_HeroPowerLines);
          break;
        case 600:
          dawngraspDungeon.m_Mission_EnemyHeroShouldExplodeOnDefeat = false;
          break;
        case 601:
          dawngraspDungeon.m_Mission_FriendlyHeroShouldExplodeOnDefeat = false;
          break;
        case 602:
          dawngraspDungeon.m_MissionDisableAutomaticVO = true;
          break;
        case 603:
          dawngraspDungeon.m_MissionDisableAutomaticVO = false;
          break;
        case 610:
          dawngraspDungeon.m_Mission_EnemyHeroShouldExplodeOnDefeat = true;
          break;
        case 611:
          dawngraspDungeon.m_Mission_FriendlyHeroShouldExplodeOnDefeat = true;
          break;
        case 612:
          dawngraspDungeon.m_DoEmoteDrivenStart = true;
          break;
        case 1000:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
          if (dawngraspDungeon.m_PlayPlayerVOLineIndex + 1 >= dawngraspDungeon.m_PlayerVOLines.Count)
            dawngraspDungeon.m_PlayPlayerVOLineIndex = 0;
          else
            ++dawngraspDungeon.m_PlayPlayerVOLineIndex;
          SceneDebugger.Get().AddMessage(dawngraspDungeon.m_PlayerVOLines[dawngraspDungeon.m_PlayPlayerVOLineIndex]);
          yield return (object) dawngraspDungeon.PlayBossLine(actor, dawngraspDungeon.m_PlayerVOLines[dawngraspDungeon.m_PlayPlayerVOLineIndex]);
          break;
        case 1001:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
          SceneDebugger.Get().AddMessage(dawngraspDungeon.m_PlayerVOLines[dawngraspDungeon.m_PlayPlayerVOLineIndex]);
        ...
        case 1002:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
          if (dawngraspDungeon.m_PlayBossVOLineIndex + 1 >= dawngraspDungeon.m_BossVOLines.Count)
            dawngraspDungeon.m_PlayBossVOLineIndex = 0;
          else
            ++dawngraspDungeon.m_PlayBossVOLineIndex;
          SceneDebugger.Get().AddMessage(dawngraspDungeon.m_BossVOLines[dawngraspDungeon.m_PlayBossVOLineIndex]);
          yield return (object) dawngraspDungeon.PlayBossLine(enemyActor, dawngraspDungeon.m_BossVOLines[dawngraspDungeon.m_PlayBossVOLineIndex]);
          break;
        case 1003:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
          SceneDebugger.Get().AddMessage(dawngraspDungeon.m_BossVOLines[dawngraspDungeon.m_PlayBossVOLineIndex]);
          ...
          break;
        case 1010:
          if (dawngraspDungeon.m_forceAlwaysPlayLine)
          {
            dawngraspDungeon.m_forceAlwaysPlayLine = false;
            break;
          }
          dawngraspDungeon.m_forceAlwaysPlayLine = true;
          break;
        case 1011:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
          foreach (string bossVoLine in dawngraspDungeon.m_BossVOLines)
          {
            SceneDebugger.Get().AddMessage(bossVoLine);
            yield return (object) dawngraspDungeon.MissionPlayVO(enemyActor, bossVoLine);
          }
          foreach (string playerVoLine in dawngraspDungeon.m_PlayerVOLines)
          {
            SceneDebugger.Get().AddMessage(playerVoLine);
            yield return (object) dawngraspDungeon.MissionPlayVO(enemyActor, playerVoLine);
          }
          break;
        case 1012:
          GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        ...
        case 58023:
          ...
          break;
        case 58024:
          dawngraspDungeon.HeroPowerIsCariel = true;
          dawngraspDungeon.HeroPowerIsKurtrus = false;
          dawngraspDungeon.HeroPowerIsTavish = false;
          dawngraspDungeon.HeroPowerIsXyrella = false;
          break;
        case 58025:
          dawngraspDungeon.HeroPowerIsCariel = false;
          dawngraspDungeon.HeroPowerIsKurtrus = true;
          dawngraspDungeon.HeroPowerIsTavish = false;
          dawngraspDungeon.HeroPowerIsXyrella = false;
          break;
        case 58026:
          dawngraspDungeon.HeroPowerIsCariel = false;
          dawngraspDungeon.HeroPowerIsKurtrus = false;
          dawngraspDungeon.HeroPowerIsTavish = true;
          dawngraspDungeon.HeroPowerIsXyrella = false;
          break;
        case 58027:
          dawngraspDungeon.HeroPowerIsCariel = false;
          dawngraspDungeon.HeroPowerIsKurtrus = false;
          dawngraspDungeon.HeroPowerIsTavish = false;
          dawngraspDungeon.HeroPowerIsXyrella = true;
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) dawngraspDungeon.\u003C\u003En__1(missionEvent);
          break;
      }
    }
  }
