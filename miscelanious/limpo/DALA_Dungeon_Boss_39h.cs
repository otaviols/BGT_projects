...
public class DALA_Dungeon_Boss_39h : DALA_Dungeon
{
  ...
  {
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_01,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_02,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_03,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_04,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_05,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_06
  };
  private HashSet<string> m_playedLines = new HashSet<string>();
  private static List<string> m_IdleLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Idle_01,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Idle_02,
    (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Death_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_DefeatPlayer_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_EmoteResponse_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_02,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_03,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_HeroPower_04,
      ...
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Idle_02,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Idle_03,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Intro_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_IntroGeorge_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerDeathKnight_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorge_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorgeSTART_01,
      (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerHolySpell_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Intro_01;
    this.m_deathLine = (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_Death_01;
    this.m_standardEmoteResponseLine = (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_EmoteResponse_01;
  }

  protected override bool GetShouldSuppressDeathTextBubble() => true;

  public override List<string> GetIdleLines() => DALA_Dungeon_Boss_39h.m_IdleLines;

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    DALA_Dungeon_Boss_39h dalaDungeonBoss39h = this;
    while (dalaDungeonBoss39h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) dalaDungeonBoss39h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorge_01);
        break;
      case 102:
        yield return (object) dalaDungeonBoss39h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerGeorgeSTART_01);
        break;
      case 103:
        yield return (object) dalaDungeonBoss39h.PlayAndRemoveRandomLineOnlyOnce(actor, DALA_Dungeon_Boss_39h.m_HeroPower);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) dalaDungeonBoss39h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DALA_Dungeon_Boss_39h dalaDungeonBoss39h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dalaDungeonBoss39h.\u003C\u003En__1(entity);
    while (dalaDungeonBoss39h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaDungeonBoss39h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      yield return (object) dalaDungeonBoss39h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss39h.m_playedLines.Add(cardId);
      switch (cardId)
      {
        case "AT_011":
        case "CS1_112":
        ...
        case "EX1_624":
        case "GIL_134":
          yield return (object) dalaDungeonBoss39h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerHolySpell_01);
          break;
        case "ICC_481":
        case "ICC_827":
        case "ICC_828":
        ...
        case "ICC_833":
        case "ICC_834":
          yield return (object) dalaDungeonBoss39h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_39h.VO_DALA_BOSS_39h_Male_Draenei_PlayerDeathKnight_01);
          break;
      }
    }
  }
