...
public class BOTA_Lethal_Puzzle_4 : BOTA_MissionEntity
{
  ...
  private string COMPLETE_LINE = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Complete_01;
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Complete_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_EmoteResponse_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_EmoteResponse_02,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_EmoteResponse_03,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_02,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_03,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_04,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_06,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_07,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Idle_08,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Intro_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_02,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_03,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_04,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_05,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Restart_06,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Return_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_01,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_02,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_03,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_04,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_06,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_07,
      (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_20h_Male_Goblin_UI_Wing1_Complete_01
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Return_01;
    this.s_victoryLine_1 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_03;
    this.s_victoryLine_2 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_02;
    this.s_victoryLine_3 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_01;
    this.s_victoryLine_4 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_04;
    this.s_victoryLine_5 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_07;
    this.s_victoryLine_6 = (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_13h_Female_Elemental_Puzzle_06;
  ...
  {
    BOTA_Lethal_Puzzle_4 botaLethalPuzzle4 = this;
    if (gameResult == TAG_PLAYSTATE.WON)
    {
      yield return (object) new WaitForSeconds(2f);
      yield return (object) botaLethalPuzzle4.PlayClosingLine("DrBoom_Banner_Quote.prefab:ff8653a27a00c464ea5552e3c6b6dc5c", (string) BOTA_Lethal_Puzzle_4.VO_BOTA_BOSS_20h_Male_Goblin_UI_Wing1_Complete_01);
    }
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    if (missionEvent == 99)
    {
      while (botaLethalPuzzle4.m_enemySpeaking)
        yield return (object) null;
      GameState.Get().SetBusy(true);
      yield return (object) botaLethalPuzzle4.PlayBossLine(enemyActor, botaLethalPuzzle4.COMPLETE_LINE);
