...
public class BTA_Prologue_Dungeon : BTA_Prologue_MissionEntity
{
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    BTA_Prologue_Dungeon btaPrologueDungeon = this;
    if (num != 0)
      return false;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if (btaPrologueDungeon.m_enemySpeaking || entity.GetCardType() == TAG_CARDTYPE.INVALID || entity.GetCardType() != TAG_CARDTYPE.HERO_POWER || entity.GetControllerSide() != Player.Side.OPPOSING)
      return false;
    btaPrologueDungeon.OnBossHeroPowerPlayed(entity);
    return false;
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (btaPrologueDungeon.m_enemySpeaking)
      yield return (object) null;
    yield return (object) btaPrologueDungeon.WaitForEntitySoundToFinish(entity);
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    switch (missionEvent)
    {
      case 1000:
        ...
        if (btaPrologueDungeon.m_PlayPlayerVOLineIndex + 1 >= btaPrologueDungeon.m_PlayerVOLines.Count)
          btaPrologueDungeon.m_PlayPlayerVOLineIndex = 0;
        else
          ++btaPrologueDungeon.m_PlayPlayerVOLineIndex;
        SceneDebugger.Get().AddMessage(btaPrologueDungeon.m_PlayerVOLines[btaPrologueDungeon.m_PlayPlayerVOLineIndex]);
        yield return (object) btaPrologueDungeon.PlayBossLine(actor1, btaPrologueDungeon.m_PlayerVOLines[btaPrologueDungeon.m_PlayPlayerVOLineIndex]);
        break;
      case 1001:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(btaPrologueDungeon.m_PlayerVOLines[btaPrologueDungeon.m_PlayPlayerVOLineIndex]);
      ...
      case 1002:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        if (btaPrologueDungeon.m_PlayBossVOLineIndex + 1 >= btaPrologueDungeon.m_BossVOLines.Count)
          btaPrologueDungeon.m_PlayBossVOLineIndex = 0;
        else
          ++btaPrologueDungeon.m_PlayBossVOLineIndex;
        SceneDebugger.Get().AddMessage(btaPrologueDungeon.m_BossVOLines[btaPrologueDungeon.m_PlayBossVOLineIndex]);
        yield return (object) btaPrologueDungeon.PlayBossLine(actor2, btaPrologueDungeon.m_BossVOLines[btaPrologueDungeon.m_PlayBossVOLineIndex]);
        break;
      case 1003:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(btaPrologueDungeon.m_BossVOLines[btaPrologueDungeon.m_PlayBossVOLineIndex]);
        ...
        break;
      case 1010:
        if (btaPrologueDungeon.m_forceAlwaysPlayLine)
        {
          btaPrologueDungeon.m_forceAlwaysPlayLine = false;
          break;
        }
        btaPrologueDungeon.m_forceAlwaysPlayLine = true;
        break;
      case 58023:
      ...
      default:
        ...
        yield return (object) btaPrologueDungeon.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  {
    BTA_Prologue_Dungeon btaPrologueDungeon = this;
    string line = btaPrologueDungeon.PopRandomLine(lines);
    if (line != null)
      yield return (object) btaPrologueDungeon.PlayLineOnlyOnce(actor, line);
  }
