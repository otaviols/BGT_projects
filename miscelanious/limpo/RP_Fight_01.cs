...
public class RP_Fight_01 : RP_Dungeon
{
  ...
  {
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_01_01,
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_02_01,
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_03_01
  };
  private List<string> m_VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_Lines = new List<string>()
  {
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_01_01,
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_02_01,
    (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_03_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeA_02_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeB_02_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeC_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Intro02_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Turn01_Response_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Turn02_Intro_01,
      (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Victory02_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_ExchangeA_01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_ExchangeB_01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Intro01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Turn01_Intro_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Turn02_Response_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Victory01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_EmoteResponse_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_02_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_03_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_01_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_02_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_03_01,
      (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Loss_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_Idle_Lines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_HeroPower_Lines;
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Intro02_01, Notification.SpeechBubbleDirection.BottomLeft, actor2));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_TB_Hero_Malfurion_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, actor1));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    RP_Fight_01 rpFight01 = this;
    while (rpFight01.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        ...
        yield return (object) rpFight01.PlayLineAlways(actor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Victory01_01);
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Victory02_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) rpFight01.PlayLineAlways(actor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) rpFight01.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    RP_Fight_01 rpFight01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) rpFight01.\u003C\u003En__1(entity);
    while (rpFight01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!rpFight01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) rpFight01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      rpFight01.m_playedLines.Add(cardId);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) rpFight01.\u003C\u003En__2(entity);
      yield return (object) rpFight01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      rpFight01.m_playedLines.Add(cardId);
    }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) rpFight01.PlayLineAlways(enemyActor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Turn01_Intro_01);
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Turn01_Response_01);
        break;
      case 3:
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_Turn02_Intro_01);
        yield return (object) rpFight01.PlayLineAlways(enemyActor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_Turn02_Response_01);
        break;
      case 6:
        yield return (object) rpFight01.PlayLineAlways(enemyActor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_ExchangeA_01_01);
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeA_02_01);
        break;
      case 11:
        yield return (object) rpFight01.PlayLineAlways(enemyActor, (string) RP_Fight_01.VO_TB_Hero_Malfurion_Male_NightElf_RP_Mission1_ExchangeB_01_01);
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeB_02_01);
        break;
      case 15:
        yield return (object) rpFight01.PlayLineAlways(friendlyActor, (string) RP_Fight_01.VO_TB_Hero_Illidan2_Male_NightElf_RP_Mission1_ExchangeC_01);
        break;
    }
  }
}
