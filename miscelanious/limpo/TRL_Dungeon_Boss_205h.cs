...
public class TRL_Dungeon_Boss_205h : TRL_Dungeon
{
  ...
  {
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_MinionBuff_04
  };
  private List<string> m_BondLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_02,
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_03
  };
  private List<string> m_ArmorLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_01,
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_02,
    (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Greetings_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Wow_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Threaten_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Well_Played_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Thanks_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Oops_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Sorry_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Generic_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Shaman_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Rogue_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Paladin_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Mage_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Kill_Shrine_Priest_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Shrine_Killed_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Shrine_Killed_02,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Shrine_Killed_03,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Death_Long_02,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineComesBack_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineComesBack_02,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_MinionBuff_04,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_02,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_03,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_02,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_Mana_03,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_Gonk_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_SpiritOfTheRaptor_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_MarkOfTheLoa_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_Hakkar_01,
      (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_CorneredSentry_01
    })
  ...
  {
    base.OnCreateGame();
    TRL_Dungeon.s_deathLine = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Death_Long_02;
    TRL_Dungeon.s_responseLineGreeting = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Greetings_01;
    TRL_Dungeon.s_responseLineOops = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Oops_01;
    TRL_Dungeon.s_responseLineSorry = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Sorry_01;
    TRL_Dungeon.s_responseLineThanks = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Thanks_01;
    TRL_Dungeon.s_responseLineThreaten = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Threaten_01;
    TRL_Dungeon.s_responseLineWellPlayed = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Well_Played_01;
    TRL_Dungeon.s_responseLineWow = (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Emote_Respond_Wow_01;
  ...
  {
    TRL_Dungeon_Boss_205h trlDungeonBoss205h = this;
    while (trlDungeonBoss205h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 1001:
        yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineComesBack_01);
        break;
      case 1002:
        yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineComesBack_02);
        break;
      case 1003:
        yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_ShrineEvent_PlusAttack_01);
        break;
      case 1004:
        yield return (object) trlDungeonBoss205h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss205h.m_WildLines);
        break;
      case 1005:
        yield return (object) trlDungeonBoss205h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss205h.m_BondLines);
        break;
      case 1006:
        yield return (object) trlDungeonBoss205h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss205h.m_ArmorLines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) trlDungeonBoss205h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!trlDungeonBoss205h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) trlDungeonBoss205h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      trlDungeonBoss205h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "UNG_926")
        yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_CorneredSentry_01);
    }
  }
    ...
    if (!trlDungeonBoss205h.m_playedLines.Contains(entity.GetCardId()))
    {
      ...
      if (!(cardId == "TRL_241"))
      {
        if (!(cardId == "TRL_223"))
        {
          ...
          {
            if (cardId == "TRL_541")
              yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_Hakkar_01);
          }
          else
            yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_MarkOfTheLoa_01);
        }
        else
          yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_SpiritOfTheRaptor_01);
      }
      else
        yield return (object) trlDungeonBoss205h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_205h.VO_TRLA_205h_Female_Troll_Play_Gonk_01);
    }
  }
}
