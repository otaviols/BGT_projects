...
public class GIL_Dungeon_Boss_31h : GIL_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_GILA_BOSS_31h_Male_Treant_Death_01.prefab:4704b92b67a05464f9f21ef411b296b0";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_31h_Male_Treant_Intro_01.prefab:fb24cfa4d71468640bb99d805d9b00b2", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_31h_Male_Treant_Emote Response_01:6a0f7ce3a070b034694f0b2b774baec5", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }
}
