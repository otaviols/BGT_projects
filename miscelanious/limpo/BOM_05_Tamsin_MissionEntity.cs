...
public abstract class BOM_05_Tamsin_MissionEntity : GenericDungeonMissionEntity
{
  ...
  private static Map<GameEntityOption, bool> s_booleanOptions = BOM_05_Tamsin_MissionEntity.InitBooleanOptions();
  ...
  public BOM_05_Tamsin_MissionEntity() => this.m_gameOptions.AddBooleanOptions(BOM_05_Tamsin_MissionEntity.s_booleanOptions);
  ...
  {
    BOM_05_Tamsin_MissionEntity tamsinMissionEntity = this;
    float bossHeroPowerVoLine = tamsinMissionEntity.ChanceToPlayBossHeroPowerVOLine();
    float num = UnityEngine.Random.Range(0.0f, 1f);
    if (!tamsinMissionEntity.m_enemySpeaking && !tamsinMissionEntity.m_MissionDisableAutomaticVO && (double) bossHeroPowerVoLine >= (double) num && !((UnityEngine.Object) GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor() == (UnityEngine.Object) null))
      yield return (object) tamsinMissionEntity.HandleMissionEventWithTiming(510);
  }

  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BOM_05_Tamsin_MissionEntity tamsinMissionEntity = this;
    if (!tamsinMissionEntity.m_MissionDisableAutomaticVO && !tamsinMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.FRIENDLY)
      yield return (object) tamsinMissionEntity.HandleMissionEventWithTiming(508);
  }

  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    BOM_05_Tamsin_MissionEntity tamsinMissionEntity = this;
    if (!tamsinMissionEntity.m_MissionDisableAutomaticVO && !tamsinMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.OPPOSING)
      yield return (object) tamsinMissionEntity.OnBossHeroPowerPlayed(entity);
  }
  ...
  public override IEnumerator OnPlayThinkEmoteWithTiming()
  {
    ...
    if (!tamsinMissionEntity.m_enemySpeaking)
    {
      Player currentPlayer = GameState.Get().GetCurrentPlayer();
      if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
      {
        GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
        if ((tamsinMissionEntity.m_Mission_FriendlyPlayIdleLines || tamsinMissionEntity.m_Mission_EnemyPlayIdleLines) && (double) tamsinMissionEntity.GetThinkIdleChancePercentage() >= (double) UnityEngine.Random.Range(0.0f, 1f))
        {
          if (((double) tamsinMissionEntity.GetThinkEmoteBossIdleChancePercentage() < (double) UnityEngine.Random.Range(0.0f, 1f) || !tamsinMissionEntity.m_Mission_FriendlyPlayIdleLines) && tamsinMissionEntity.m_Mission_EnemyPlayIdleLines)
          {
            if (tamsinMissionEntity.m_Mission_EnemyPlayIdleLinesUseingEmoteSystem)
              yield return (object) tamsinMissionEntity.MissionPlayThinkEmote(actor1);
            else
              yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.HandleMissionEventWithTiming(517));
          }
          else if (tamsinMissionEntity.m_Mission_FriendlyPlayIdleLines)
          {
            if (tamsinMissionEntity.m_Mission_FriendlyPlayIdleLinesUseingEmoteSystem)
              yield return (object) tamsinMissionEntity.MissionPlayThinkEmote(actor2);
            else
              yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.HandleMissionEventWithTiming(518));
          }
        }
      }
    }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    {
      Notification.SpeechBubbleDirection speakerDirection = tamsinMissionEntity.GetDirection(actor);
      if (tamsinMissionEntity.m_forceAlwaysPlayLine)
        yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlayLine(actor, line, shouldPlay, 2.5f));
      ...
      if (shouldPlay() == tamsinMissionEntity.InternalShouldPlayAlways())
        yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlaySoundAndBlockSpeech(line, speakerDirection, actor, 2.5f, parentBubbleToActor: parentBubbleToActor));
      else if (shouldPlay() == tamsinMissionEntity.InternalShouldPlayOnlyOnce())
      {
        yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlaySoundAndBlockSpeechOnce(line, speakerDirection, actor, 2.5f, parentBubbleToActor: parentBubbleToActor));
        NotificationManager.Get().ForceAddSoundToPlayedList(line);
      }
      tamsinMissionEntity.m_lastVOplayFinshtime = Time.time;
    }
  }
  ...
  public IEnumerator MissionPlayVO(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    bool bPlayOrder = true)
  {
    ...
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Once && !tamsinMissionEntity.m_forceAlwaysPlayLine)
      removeLine = true;
    string line = !bPlayOrder ? tamsinMissionEntity.PopNextLine(lines, removeLine) : tamsinMissionEntity.PopRandomLine(lines, removeLine);
    if (line != null)
      yield return (object) tamsinMissionEntity.MissionPlayVO(speaker, line, bUseBubble, shouldPlay);
  }
  ...
  public IEnumerator MissionPlayVO(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnceInOrder(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(((MissionEntity) tamsinMissionEntity).InternalShouldPlayOnlyOnce), bPlayOrder: false);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    tamsinMissionEntity.m_enemySpeaking = true;
    if (tamsinMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Always)
      yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    else if (shouldPlay() == MissionEntity.ShouldPlayValue.Once)
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlayBigCharacterQuoteAndWaitOnce(brassRing, line));
      NotificationManager.Get().ForceAddSoundToPlayedList(line);
    }
    tamsinMissionEntity.m_enemySpeaking = false;
  }
  ...
  public IEnumerator MissionPlayVO(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(string minionSpeaker, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(tamsinMissionEntity.GetActorByCardId(minionSpeaker), line, true, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVO(string minionSpeaker, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) tamsinMissionEntity.MissionPlayVO(tamsinMissionEntity.GetActorByCardId(minionSpeaker), line, true, new MissionEntity.ShouldPlay(tamsinMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlaySound(string line)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) GameEntity.Coroutines.StartCoroutine(tamsinMissionEntity.PlaySoundAndWait(line, (string) null, Notification.SpeechBubbleDirection.None, (Actor) null, waitTimeScale, parentBubbleToActor, delayCardSoundSpells));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
