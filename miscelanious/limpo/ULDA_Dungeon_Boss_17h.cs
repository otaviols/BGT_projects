...
public class ULDA_Dungeon_Boss_17h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_01,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_02,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_03,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_04,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Idle_01,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Idle_02,
    (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossCheatDeathTriggerLeperGnome_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossNecriumBlade_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossPlagueScientist_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Death_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_02,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_03,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_HeroPower_04,
      ...
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Idle_02,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Idle_03,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Intro_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_PlayerTrigger_Diseased_Vulture_01,
      (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_PlayerTrigger_Gnomebliterator_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_EmoteResponse_01;
  }
  ...
  {
    ULDA_Dungeon_Boss_17h uldaDungeonBoss17h = this;
    while (uldaDungeonBoss17h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    if (missionEvent == 101)
    {
      yield return (object) uldaDungeonBoss17h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossCheatDeathTriggerLeperGnome_01);
    }
    else
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss17h.\u003C\u003En__0(missionEvent);
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_17h uldaDungeonBoss17h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss17h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss17h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss17h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss17h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss17h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULDA_115"))
      {
        if (cardId == "ULD_167")
          yield return (object) uldaDungeonBoss17h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_PlayerTrigger_Diseased_Vulture_01);
      }
      else
        yield return (object) uldaDungeonBoss17h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_PlayerTrigger_Gnomebliterator_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss17h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss17h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss17h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      {
        if (cardId == "ICC_809")
          yield return (object) uldaDungeonBoss17h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossPlagueScientist_01);
      }
      else
        yield return (object) uldaDungeonBoss17h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_17h.VO_ULDA_BOSS_17h_Male_Gnome_BossNecriumBlade_01);
    }
  }
}
