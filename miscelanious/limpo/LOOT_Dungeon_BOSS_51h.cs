...
public class LOOT_Dungeon_BOSS_51h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_51h_Male_Dwarf_Death_01.prefab:e5c8b619095374542bac028ed3654007";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      this.PlaySound("RussellTheBard_Intro_Underlay.prefab:19ca7e93a4a3ef541a154a5dd830c1a7");
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_51h_Male_Dwarf_Intro_01.prefab:c513358ed8344364dbf85ee7bb4f8eca", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      this.PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_51h_Male_Dwarf_EmoteResponse_01.prefab:777b3055ee92eae42b1b27826e242da7", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_51h lootDungeonBoss51h = this;
    while (lootDungeonBoss51h.m_enemySpeaking)
      yield return (object) null;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    string str = "PLAYED_MISSION_EVENT_" + (object) missionEvent;
    if (!lootDungeonBoss51h.m_playedLines.Contains(str))
    {
      yield return (object) lootDungeonBoss51h.PlayLoyalSideKickBetrayal(missionEvent);
      switch (missionEvent)
      {
        case 101:
          lootDungeonBoss51h.PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
          yield return (object) lootDungeonBoss51h.PlayLineOnlyOnce(enemyActor, "VO_LOOTA_BOSS_51h_Male_Dwarf_StealDoomsayer_01.prefab:44f418a3c657052439d81529f24d64ed");
          break;
        case 102:
          lootDungeonBoss51h.PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
          yield return (object) lootDungeonBoss51h.PlayLineOnlyOnce(enemyActor, "VO_LOOTA_BOSS_51h_Male_Dwarf_StealMinstrel_01.prefab:8cfb6f7ad88bd1443b6047f37bd70954");
          break;
        case 103:
          int num1 = 100;
          int num2 = Random.Range(0, 100);
          if (lootDungeonBoss51h.m_heroPowerLines.Count == 0 || num1 < num2)
            break;
          string randomLine = lootDungeonBoss51h.m_heroPowerLines[Random.Range(0, lootDungeonBoss51h.m_heroPowerLines.Count)];
          lootDungeonBoss51h.PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
          yield return (object) lootDungeonBoss51h.PlayLineOnlyOnce(enemyActor, randomLine);
          lootDungeonBoss51h.m_heroPowerLines.Remove(randomLine);
          yield return (object) null;
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!lootDungeonBoss51h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) lootDungeonBoss51h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      lootDungeonBoss51h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "LOOTA_838")
      {
        lootDungeonBoss51h.PlaySound("RussellTheBard_Short_Strum_Underlay.prefab:09e52281d7049da458f12cb79ee395da");
        yield return (object) lootDungeonBoss51h.PlayEasterEggLine(actor, "VO_LOOTA_BOSS_51h_Male_Dwarf_EventBoombox_01.prefab:d031062f6c4754b42a8a0975a1b221a1");
      }
    }
  }
}
