...
public class BOTA_Clear_Puzzle_2 : BOTA_MissionEntity
{
  ...
  private string COMPLETE_LINE = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Complete_02;
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Complete_02,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_EmoteResponse_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_EmoteResponse_03,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_EmoteResponse_04,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_02,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_03,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_05,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_06,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_07,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Idle_09,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Intro_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Restart_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Restart_02,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Restart_03,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Restart_04,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Restart_05,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Return_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_01,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_02,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_03,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Stuck_02,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Stuck_03,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Stuck_04,
      (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Stuck_01
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Return_01;
    this.s_victoryLine_1 = (string) null;
    this.s_victoryLine_2 = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Stuck_01;
    this.s_victoryLine_3 = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_01;
    this.s_victoryLine_4 = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_02;
    this.s_victoryLine_5 = (string) null;
    this.s_victoryLine_6 = (string) BOTA_Clear_Puzzle_2.VO_BOTA_BOSS_07h_Male_Ooze_Puzzle_03;
  ...
  {
    BOTA_Clear_Puzzle_2 botaClearPuzzle2 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    if (missionEvent == 99)
    {
      while (botaClearPuzzle2.m_enemySpeaking)
        yield return (object) null;
      GameState.Get().SetBusy(true);
      yield return (object) botaClearPuzzle2.PlayBossLine(enemyActor, botaClearPuzzle2.COMPLETE_LINE);
