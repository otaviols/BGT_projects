...
public class GIL_Dungeon_Boss_48h : GIL_Dungeon
{
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      string randomIntroLine = this.m_RandomIntroLines[Random.Range(0, this.m_RandomIntroLines.Count)];
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech(randomIntroLine, Notification.SpeechBubbleDirection.TopRight, actor));
    }
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_48h_Female_Gnome_EmoteResponse_01.prefab:7a5cb51ef214a804fae3c933aae63b57", Notification.SpeechBubbleDirection.TopRight, actor));
  }

  public override void StartGameplaySoundtracks() => MusicManager.Get().StartPlaylist(MusicPlaylistType.InGame_GILFinalBoss);

  protected override string GetBossDeathLine() => "VO_GILA_BOSS_48h_Female_Gnome_Death_01.prefab:081f92f8c5206444c8058b5c38a0beb2";

  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    GIL_Dungeon_Boss_48h gilDungeonBoss48h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) gilDungeonBoss48h.\u003C\u003En__0(entity);
    while (gilDungeonBoss48h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!gilDungeonBoss48h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) gilDungeonBoss48h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "UNG_028t" && gilDungeonBoss48h.m_RandomBossTimeWarpLines.Count != 0)
      {
        string bossTimeWarpLine = gilDungeonBoss48h.m_RandomBossTimeWarpLines[Random.Range(0, gilDungeonBoss48h.m_RandomBossTimeWarpLines.Count)];
        gilDungeonBoss48h.m_RandomBossTimeWarpLines.Remove(bossTimeWarpLine);
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(actor, bossTimeWarpLine);
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    if (!gilDungeonBoss48h.m_playedLines.Contains(entity.GetCardId()))
    {
      ...
      string cardId = entity.GetCardId();
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "UNG_028t" && gilDungeonBoss48h.m_RandomPlayerTimeWarpLines.Count != 0)
      {
        string playerTimeWarpLine = gilDungeonBoss48h.m_RandomPlayerTimeWarpLines[Random.Range(0, gilDungeonBoss48h.m_RandomPlayerTimeWarpLines.Count)];
        gilDungeonBoss48h.m_RandomPlayerTimeWarpLines.Remove(playerTimeWarpLine);
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(actor, playerTimeWarpLine);
      }
    }
  }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    switch (turn)
    {
      case 2:
        ...
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(actor, "VO_GILA_900h_Female_Gnome_EVENT_NEMESIS_TURN2_02.prefab:bc3fdc2e58660c2488283fe53df5a36a");
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_48h_Female_Gnome_EventTurn2_01.prefab:01cb517eae8bb3348998cad51c11b852");
        GameState.Get().SetBusy(false);
        break;
      case 4:
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_48h_Female_Gnome_EventTurn4_01.prefab:5e7d08c465247eb429a85b2c801289e0");
        break;
      case 8:
        GameState.Get().SetBusy(true);
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(actor, "VO_GILA_900h_Female_Gnome_EVENT_NEMESIS_TURN6_01.prefab:dff37aa4d569154418338aab31cdaf95");
        yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, "VO_GILA_BOSS_48h_Female_Gnome_EventTurn6_01.prefab:a9d92540402e85342b3e744c002ec395");
        GameState.Get().SetBusy(false);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToResetGameFinishedWithTiming(Entity entity)
  {
    ...
    if (!gilDungeonBoss48h.m_playedLines.Contains(entity.GetCardId()))
    {
      ...
      if (entity.GetControllerSide() == Player.Side.FRIENDLY)
      {
        ...
        if (!(str == "GILA_900p"))
        {
          if (str == "GILA_BOSS_48t" && gilDungeonBoss48h.m_RandomPlayerAltTimeLines.Count != 0)
          {
            string playerAltTimeLine = gilDungeonBoss48h.m_RandomPlayerAltTimeLines[Random.Range(0, gilDungeonBoss48h.m_RandomPlayerAltTimeLines.Count)];
            gilDungeonBoss48h.m_RandomPlayerAltTimeLines.Remove(playerAltTimeLine);
            yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, playerAltTimeLine);
          }
        }
        else
        {
          string line = gilDungeonBoss48h.PopRandomLineWithChance(gilDungeonBoss48h.m_RandomPlayerHeroPowerLines);
          if (line != null)
            yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, line);
        }
      }
      if (entity.GetControllerSide() == Player.Side.OPPOSING && cardID == "GILA_BOSS_48t")
      {
        string line = gilDungeonBoss48h.PopRandomLineWithChance(gilDungeonBoss48h.m_RandomBossAltTimeLines);
        if (line != null)
          yield return (object) gilDungeonBoss48h.PlayLineOnlyOnce(enemyActor, line);
      }
    }
