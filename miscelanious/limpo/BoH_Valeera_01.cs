...
public class BoH_Valeera_01 : BoH_Valeera_Dungeon
{
  ...
  {
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_01,
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_02,
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_01,
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_02,
    (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1EmoteResponse_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1ExchangeC_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_02,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1HeroPower_03,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_02,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Idle_03,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Intro_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Loss_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Victory_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeA_02,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeB_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeB_03,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeC_03,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1Intro_02,
      (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1Victory_01,
      (string) BoH_Valeera_01.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission1ExchangeB_02,
      (string) BoH_Valeera_01.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission1ExchangeC_04,
      (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeA_01,
      (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeA_03,
      (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeC_02
    };
  ...
  {
    BoH_Valeera_01 boHValeera01 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHValeera01.MissionPlayVO(actor, (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Intro_01);
    yield return (object) boHValeera01.MissionPlayVO(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1Intro_02);
  ...
  public override void OnCreateGame()
  {
    ...
    this.m_standardEmoteResponseLine = (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1EmoteResponse_01;
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    {
      GameState.Get().SetBusy(true);
      while (boHValeera01.m_enemySpeaking)
    ...
    else
    {
      ...
      {
        case 101:
          yield return (object) boHValeera01.PlayLineAlways(actor, (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Loss_01);
          break;
        case 228:
          GameState.Get().SetBusy(true);
          boHValeera01.ShowMinionMoveTutorial();
          yield return (object) new WaitForSeconds(3f);
          boHValeera01.HideNotification(boHValeera01.m_minionMoveTutorialNotification);
          GameState.Get().SetBusy(false);
          break;
        case 504:
          GameState.Get().SetBusy(true);
          yield return (object) boHValeera01.PlayLineAlways(actor, (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1Victory_01);
          yield return (object) boHValeera01.PlayLineAlways(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1Victory_01);
          GameState.Get().SetBusy(false);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) boHValeera01.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Valeera_01 boHValeera01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHValeera01.\u003C\u003En__1(entity);
    while (boHValeera01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHValeera01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHValeera01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHValeera01.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHValeera01.\u003C\u003En__2(entity);
      yield return (object) boHValeera01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHValeera01.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 3:
        yield return (object) boHValeera01.PlayLineAlways((string) BoH_Valeera_01.BrollBrassRing, (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeA_01);
        yield return (object) boHValeera01.PlayLineAlways(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeA_02);
        yield return (object) boHValeera01.PlayLineAlways((string) BoH_Valeera_01.BrollBrassRing, (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeA_03);
        break;
      case 7:
        yield return (object) boHValeera01.PlayLineAlways(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeB_01);
        yield return (object) boHValeera01.PlayLineAlways((string) BoH_Valeera_01.LoGoshBrassRing, (string) BoH_Valeera_01.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission1ExchangeB_02);
        yield return (object) boHValeera01.PlayLineAlways(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeB_03);
        break;
      case 11:
        yield return (object) boHValeera01.PlayLineAlways(actor, (string) BoH_Valeera_01.VO_Story_Hero_Rehgar_Male_Orc_Story_Valeera_Mission1ExchangeC_01);
        yield return (object) boHValeera01.PlayLineAlways((string) BoH_Valeera_01.BrollBrassRing, (string) BoH_Valeera_01.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission1ExchangeC_02);
        yield return (object) boHValeera01.PlayLineAlways(friendlyActor, (string) BoH_Valeera_01.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission1ExchangeC_03);
        yield return (object) boHValeera01.PlayLineAlways((string) BoH_Valeera_01.LoGoshBrassRing, (string) BoH_Valeera_01.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission1ExchangeC_04);
        break;
    }
  }
