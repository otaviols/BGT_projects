...
public class CardBurstRare : Spell
{
  ...
  {
    CardBurstRare cardBurstRare = this;
    yield return (object) new WaitForSeconds(0.2f);
    if ((bool) (Object) cardBurstRare.m_EdgeGlow)
      cardBurstRare.m_EdgeGlow.GetComponent<Renderer>().enabled = false;
    cardBurstRare.OnSpellFinished();
  }
}
