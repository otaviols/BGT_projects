...
public class BTA_Fight_16 : BTA_Dungeon
{
  ...
  {
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_IdleA_01,
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_IdleB_01
  };
  private List<string> m_missionEventTrigger501_Lines = new List<string>()
  {
    (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryB_01,
    (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryD_01,
    (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryA_01,
    (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryC_01
  };
  private List<string> m_missionEventTrigger100_Lines = new List<string>()
  {
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_01,
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_02,
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_03
  };
  private List<string> m_missionEventTrigger101_Lines = new List<string>()
  {
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerHatredTrigger_01,
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerHatredTrigger_02,
    (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerHatredTrigger_03
  };
  ...
  public BTA_Fight_16() => this.m_gameOptions.AddBooleanOptions(BTA_Fight_16.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_MidpointB_01,
      (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_PlayerStart_01,
      (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_Turn1_Story_01,
      (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryB_01,
      (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryD_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_Attack_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_DarkPortal_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_Deteriorate_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_EndlessLegion_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_RustedFungalGiant_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_BossDeath_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_BossStart_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Emote_Response_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Blur_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Demon_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_HiddenAmulet_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_InnerDemon_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Sklibb_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_SpectralSight_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_02,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerFelTrigger_03,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_HeroPowerHatredTrigger_01,
      ...
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_IdleA_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_IdleB_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_MidpointA_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Misc_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryA_01,
      (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryC_01,
      (string) BTA_Fight_16.VO_BTA_08_Male_Orc_Misc_03,
      (string) BTA_Fight_16.VO_BTA_10_Female_Naga_Misc_02
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_BTA_BOSS_16h_IdleLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_BossDeath_01;
  }
  ...
  {
    BTA_Fight_16 btaFight16 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_PlayerStart_01);
    yield return (object) btaFight16.PlayLineAlways(enemyActor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_BossStart_01);
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    BTA_Fight_16 btaFight16 = this;
    while (btaFight16.m_enemySpeaking)
    ...
    {
      case 100:
        yield return (object) btaFight16.PlayRandomLineAlways(actor, btaFight16.m_missionEventTrigger100_Lines);
        break;
      case 101:
        yield return (object) btaFight16.PlayRandomLineAlways(actor, btaFight16.m_missionEventTrigger101_Lines);
        break;
      case 102:
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_MidpointA_01);
        yield return (object) btaFight16.PlayLineAlways(friendlyActor, (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_MidpointB_01);
        break;
      case 103:
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Demon_01);
        break;
      case 104:
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_HiddenAmulet_01);
        break;
      case 105:
        yield return (object) btaFight16.PlayLineAlways((string) BTA_Dungeon.IllidanBrassRing, (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Misc_01);
        break;
      case 500:
        btaFight16.PlaySound((string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_Attack_01);
        break;
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight16.PlayLineAlways((string) BTA_Dungeon.IllidanBrassRing, (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryA_01);
        yield return (object) btaFight16.PlayLineAlways(friendlyActor, (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryB_01);
        yield return (object) btaFight16.PlayLineAlways((string) BTA_Dungeon.IllidanBrassRing, (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Mission_Fight_16_VictoryC_01);
        yield return (object) btaFight16.PlayLineAlways(friendlyActor, (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_VictoryD_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight16.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_16 btaFight16 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight16.\u003C\u003En__1(entity);
    while (btaFight16.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight16.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight16.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight16.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
        ...
        if (!(cardId == "BT_512"))
        {
          if (!(cardId == "BT_752"))
          {
            if (!(cardId == "BTA_05") && !(cardId == "BTA_06"))
            {
              ...
              yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Sklibb_01);
          }
          else
            yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_Blur_01);
        }
        else
          yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_InnerDemon_01);
      }
      else
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Hero_SpectralSight_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight16.\u003C\u003En__2(entity);
      yield return (object) btaFight16.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight16.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      if (!(cardId == "BT_302"))
      {
        if (!(cardId == "BTA_13"))
        {
          ...
          {
            if (cardId == "BTA_16")
              yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_RustedFungalGiant_01);
          }
          else
            yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_EndlessLegion_01);
        }
        else
          yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_Deteriorate_01);
      }
      else
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_BOSS_16h_Male_Demon_Mission_Fight_16_Boss_DarkPortal_01);
    }
  }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) btaFight16.PlayLineAlways(actor, (string) BTA_Fight_16.VO_BTA_01_Female_NightElf_Mission_Fight_16_Turn1_Story_01);
        yield return (object) btaFight16.PlayLineAlways(btaFight16.GetFriendlyActorByCardId("BTA_07"), (string) BTA_Dungeon.KarnukBrassRingDemonHunter, (string) BTA_Fight_16.VO_BTA_08_Male_Orc_Misc_03);
        yield return (object) btaFight16.PlayLineAlways(btaFight16.GetFriendlyActorByCardId("BTA_09"), (string) BTA_Dungeon.ShaljaBrassRingDemonHunter, (string) BTA_Fight_16.VO_BTA_10_Female_Naga_Misc_02);
        break;
      case 5:
        yield return (object) btaFight16.PlayLineAlways((string) BTA_Dungeon.IllidanBrassRing, (string) BTA_Fight_16.VO_BTA_BOSS_17h_Male_NightElf_Misc_01);
        break;
  ...
  public override void StartGameplaySoundtracks() => MusicManager.Get().StartPlaylist(MusicPlaylistType.InGame_BT_FinalBoss);
}
