...
public class ULDA_Dungeon_Boss_04h : ULDA_Dungeon
{
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_Death_01,
      (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_Defeat_01,
      (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_Intro_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_04h.VO_ULDA_BOSS_04h_NashTheGreatworm_EmoteResponse_01;
  }
}
