...
public class TRL_Dungeon_Boss_206h : TRL_Dungeon
{
  ...
  {
    (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_01,
    (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_02
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Death_Long_Alt_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Greetings_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Wow_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Threaten_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Well_Played_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Thanks_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Oops_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Sorry_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Generic_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Warrior_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Shaman_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Rogue_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Hunter_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Kill_Shrine_Priest_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_Killed_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_Killed_02,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_Killed_03,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_02,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_General_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_02,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_03,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_HakkarReponse_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_Lanathel_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_Hireek_01,
      (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_SpiritofBat_01
    })
  ...
  {
    base.OnCreateGame();
    TRL_Dungeon.s_deathLine = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Death_Long_Alt_01;
    TRL_Dungeon.s_responseLineGreeting = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Greetings_01;
    TRL_Dungeon.s_responseLineOops = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Oops_01;
    TRL_Dungeon.s_responseLineSorry = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Sorry_01;
    TRL_Dungeon.s_responseLineThanks = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Thanks_01;
    TRL_Dungeon.s_responseLineThreaten = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Threaten_01;
    TRL_Dungeon.s_responseLineWellPlayed = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Well_Played_01;
    TRL_Dungeon.s_responseLineWow = (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Emote_Respond_Wow_01;
  ...
  {
    TRL_Dungeon_Boss_206h trlDungeonBoss206h = this;
    while (trlDungeonBoss206h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 1001:
        yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_02);
        break;
      case 1002:
        yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_General_01);
        break;
      case 1003:
        yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_BounceDamage_03);
        break;
      case 1004:
        yield return (object) trlDungeonBoss206h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss206h.m_BounceLines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) trlDungeonBoss206h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!trlDungeonBoss206h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) trlDungeonBoss206h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      trlDungeonBoss206h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "TRL_541")
        yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_HakkarReponse_01);
    }
  }
    ...
    if (!trlDungeonBoss206h.m_playedLines.Contains(entity.GetCardId()))
    {
      ...
      if (!(cardId == "TRLA_181"))
      {
        if (!(cardId == "ICC_841"))
        {
          ...
          {
            if (cardId == "TRL_251")
              yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_SpiritofBat_01);
          }
          else
            yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_Hireek_01);
        }
        else
          yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Play_Lanathel_01);
      }
      else
        yield return (object) trlDungeonBoss206h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_206h.VO_TRLA_206h_Female_Troll_Shrine_CheapSpell_01);
    }
  }
}
