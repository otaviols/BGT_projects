...
public class BTA_Fight_20 : BTA_Dungeon_Heroic
{
  ...
  {
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_01,
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_02,
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_03,
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_04
  };
  private List<string> m_VO_BTA_BOSS_20h_IdleLines = new List<string>()
  {
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_IdleA_01,
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_IdleB_01,
    (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_IdleC_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Bladestorm_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_Attack_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMighty_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMightyDragon_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossDeath_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossDeathDragon_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossStart_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Emote_Response_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Deathwing_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Dragon_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_FighT_20_Hero_Gruul_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Khadgar_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_02,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_03,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_HeroPower_04,
      ...
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_IdleB_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_IdleC_01,
      (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_UI_Mission_Fight_20_CoinSelect_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_BTA_BOSS_20h_IdleLines;
  ...
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossDeath_01;
    this.m_standardEmoteResponseLine = (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Emote_Response_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_BossStart_01, Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
  ...
  {
    BTA_Fight_20 btaFight20 = this;
    while (btaFight20.m_enemySpeaking)
    ...
    {
      case 110:
        yield return (object) btaFight20.PlayLineOnlyOnce(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Dragon_01);
        break;
      case 115:
        yield return (object) btaFight20.PlayLineOnlyOnce(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMighty_01);
        break;
      case 116:
        yield return (object) btaFight20.PlayLineOnlyOnce(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_SlayeroftheMightyDragon_01);
        break;
      case 500:
        yield return (object) btaFight20.PlayLineAlways(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Boss_Attack_01);
        break;
      case 507:
        yield return (object) btaFight20.PlayAndRemoveRandomLineOnlyOnce(actor, btaFight20.m_missionEventTrigger507Lines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight20.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_20 btaFight20 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight20.\u003C\u003En__1(entity);
    while (btaFight20.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight20.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight20.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight20.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "NEW1_030") && !(cardId == "DRG_026"))
      {
        ...
        {
          if (cardId == "NEW1_038")
            yield return (object) btaFight20.PlayLineAlways(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_FighT_20_Hero_Gruul_01);
        }
        else
          yield return (object) btaFight20.PlayLineAlways(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Khadgar_01);
      }
      else
        yield return (object) btaFight20.PlayLineAlways(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Hero_Deathwing_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight20.\u003C\u003En__2(entity);
      yield return (object) btaFight20.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight20.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "CS2_108")
        yield return (object) btaFight20.PlayLineOnlyOnce(actor, (string) BTA_Fight_20.VO_BTA_BOSS_20h_Male_Gronn_Mission_Fight_20_Bladestorm_01);
    }
  }
