...
public class DragRotator : MonoBehaviour
{
  ...
  private void Update()
  {
    ...
    this.transform.localRotation = Quaternion.Euler(this.m_originalAngles.x + this.m_pitchDeg, this.m_originalAngles.y, this.m_originalAngles.z + this.m_rollDeg);
    this.m_prevPos = position;
  }

  public DragRotatorInfo GetInfo() => this.m_info;

  public void SetInfo(DragRotatorInfo info) => this.m_info = info;
