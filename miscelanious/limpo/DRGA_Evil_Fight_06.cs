...
public class DRGA_Evil_Fight_06 : DRGA_Dungeon
{
  ...
  {
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_01_01,
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_02_01,
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_03_01
  };
  private List<string> m_VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_IdleLines = new List<string>()
  {
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_01_01,
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_02_01,
    (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_03_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_01_Hero_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_02_Hero_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_03_Hero_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_04_Hero_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_Death_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_01_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_02_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPower_03_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_BossAttack_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_BossStart_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_EmoteResponse_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_01_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_02_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Idle_03_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_01_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_02_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_03_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_04a_01,
      (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_04b_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_IdleLines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_HeroPowerLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_deathLine = (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Boss_Death_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_BossStart_01, Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    DRGA_Evil_Fight_06 drgaEvilFight06 = this;
    while (drgaEvilFight06.m_enemySpeaking)
    ...
    {
      case 102:
        if (drgaEvilFight06.m_Heroic)
          break;
        yield return (object) drgaEvilFight06.PlayLineAlways(actor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_02_Hero_01);
        break;
      case 103:
        if (drgaEvilFight06.m_Heroic)
          break;
        yield return (object) drgaEvilFight06.PlayLineAlways(actor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_03_Hero_01);
        break;
      case 104:
        if (drgaEvilFight06.m_Heroic)
          break;
        yield return (object) drgaEvilFight06.PlayLineAlways(actor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_04_Hero_01);
        break;
      case 105:
        if (drgaEvilFight06.m_Heroic)
          break;
        yield return (object) drgaEvilFight06.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_01_01);
        break;
      case 107:
        if (drgaEvilFight06.m_Heroic)
          break;
        yield return (object) drgaEvilFight06.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_03_01);
        break;
      case 108:
        yield return (object) drgaEvilFight06.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_04a_01);
        yield return (object) drgaEvilFight06.PlayLineAlways(enemyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_04b_01);
        break;
      case 110:
        yield return (object) drgaEvilFight06.PlayLineOnlyOnce(enemyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_BossAttack_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) drgaEvilFight06.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DRGA_Evil_Fight_06 drgaEvilFight06 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) drgaEvilFight06.\u003C\u003En__1(entity);
    while (drgaEvilFight06.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!drgaEvilFight06.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) drgaEvilFight06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      drgaEvilFight06.m_playedLines.Add(cardId);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) drgaEvilFight06.\u003C\u003En__2(entity);
      yield return (object) drgaEvilFight06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      drgaEvilFight06.m_playedLines.Add(cardId);
      ...
      {
        yield return (object) drgaEvilFight06.PlayLineAlways(actor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_20h_Male_Dragon_Evil_Fight_06_Misc_02_01);
        if (!drgaEvilFight06.m_Heroic)
          yield return (object) drgaEvilFight06.PlayLineAlways(friendlyActor, (string) DRGA_Evil_Fight_06.VO_DRGA_BOSS_06h_Female_Orc_Evil_Fight_06_Misc_01_Hero_01);
      }
    }
  }
}
