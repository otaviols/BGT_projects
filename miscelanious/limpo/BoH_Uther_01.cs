...
public class BoH_Uther_01 : BoH_Uther_Dungeon
{
  ...
  {
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_01,
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_02,
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_03
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_01,
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_02,
    (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1EmoteResponse_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeA_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeB_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeC_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeD_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeE_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_02,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1HeroPower_03,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_02,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Idle_03,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Intro_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Loss_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Victory_01,
      (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Victory_02,
      (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1ExchangeA_01,
      (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1ExchangeB_01,
      (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1Victory_01,
      (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1Intro_02
    };
  ...
  {
    BoH_Uther_01 boHUther01 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHUther01.PlayLineAlways(actor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Intro_01);
    yield return (object) boHUther01.PlayLineAlways(friendlyActor, (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1Intro_02);
  ...
  {
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1EmoteResponse_01;
  }
  ...
  {
    BoH_Uther_01 boHUther01 = this;
    while (boHUther01.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Victory_01);
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Victory_02);
        GameState.Get().SetBusy(false);
        break;
      case 502:
        GameState.Get().SetBusy(true);
        yield return (object) boHUther01.PlayLineAlways(actor, (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1Loss_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHUther01.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Uther_01 boHUther01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHUther01.\u003C\u003En__1(entity);
    while (boHUther01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHUther01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHUther01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHUther01.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "CS1_112"))
      {
        if (cardId == "GIL_134")
          yield return (object) boHUther01.PlayLineOnlyOnce(actor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeD_01);
      }
      else
        yield return (object) boHUther01.PlayLineOnlyOnce(actor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeE_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHUther01.\u003C\u003En__2(entity);
      yield return (object) boHUther01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHUther01.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 3:
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeA_01);
        yield return (object) boHUther01.PlayLineAlways(friendlyActor, (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1ExchangeA_01);
        break;
      case 5:
        yield return (object) boHUther01.PlayLineAlways(friendlyActor, (string) BoH_Uther_01.VO_Story_Hero_Uther_Male_Human_Story_Uther_Mission1ExchangeB_01);
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeB_01);
        break;
      case 7:
        yield return (object) boHUther01.PlayLineAlways(enemyActor, (string) BoH_Uther_01.VO_Story_03_Alonsus_Male_Human_Story_Uther_Mission1ExchangeC_01);
        break;
    }
  }

  public override void StartGameplaySoundtracks() => MusicManager.Get().StartPlaylist(MusicPlaylistType.InGame_Default);
}
