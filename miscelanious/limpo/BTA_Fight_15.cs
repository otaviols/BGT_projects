...
public class BTA_Fight_15 : BTA_Dungeon
{
  ...
  {
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleA_01,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleB_01,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleC_01,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleD_01
  };
  private List<string> m_missionEventTrigger103_Lines = new List<string>()
  {
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_EasterEggAmulet_01,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_EasterEggAmulet_02
  };
  private List<string> m_missionEventTrigger100_Lines = new List<string>()
  {
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_01,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_02,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_03,
    (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_04
  };
  ...
  public BTA_Fight_15() => this.m_gameOptions.AddBooleanOptions(BTA_Fight_15.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_MidpointB_01,
      (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_PlayerStart_01,
      (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_VictoryA_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_AmbushTrigger_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_AshtongueSlayer_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Attack_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Betrayal_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Sprint_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_BossDeath_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_BossStart_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_EasterEggAmulet_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_EasterEggAmulet_02,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Emote_Response_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_BladeDance_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_Demon_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_Metamorphosis_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_PriestessofFury_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_02,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_03,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_HeroPowerTrigger_04,
      ...
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleC_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_IdleD_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_MidpointA_01,
      (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_MidpointC_01,
      (string) BTA_Fight_15.VO_BTA_03_Female_Broken_Mission_Fight_15_VictoryB_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_BTA_BOSS_15h_IdleLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_BossDeath_01;
  }

  protected override bool GetShouldSuppressDeathTextBubble() => true;

  public override bool ShouldPlayHeroBlowUpSpells(TAG_PLAYSTATE playState) => this.shouldEnemyActorExplode || playState != TAG_PLAYSTATE.WON;

  public override IEnumerator DoActionsBeforeDealingBaseMulliganCards()
  {
    BTA_Fight_15 btaFight15 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_PlayerStart_01);
    yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_BossStart_01);
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    BTA_Fight_15 btaFight15 = this;
    while (btaFight15.m_enemySpeaking)
    ...
    {
      case 100:
        yield return (object) btaFight15.PlayRandomLineAlways(enemyActor, btaFight15.m_missionEventTrigger100_Lines);
        break;
      case 101:
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_AmbushTrigger_01);
        break;
      case 102:
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_Demon_01);
        break;
      case 103:
        GameState.Get().SetBusy(true);
        btaFight15.shouldEnemyActorExplode = false;
        btaFight15.m_deathLine = (string) null;
        yield return (object) btaFight15.PlayRandomLineAlways(enemyActor, btaFight15.m_missionEventTrigger103_Lines);
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_03_Female_Broken_Mission_Fight_15_VictoryB_01);
        GameState.Get().SetBusy(false);
        break;
      case 104:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_MidpointA_01);
        yield return (object) btaFight15.PlayLineAlways(friendlyActor, (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_MidpointB_01);
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_MidpointC_01);
        GameState.Get().SetBusy(false);
        break;
      case 500:
        btaFight15.PlaySound((string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Attack_01);
        break;
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight15.PlayLineAlways(friendlyActor, (string) BTA_Fight_15.VO_BTA_01_Female_NightElf_Mission_Fight_15_VictoryA_01);
        yield return (object) btaFight15.PlayLineAlways(enemyActor, (string) BTA_Fight_15.VO_BTA_03_Female_Broken_Mission_Fight_15_VictoryB_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight15.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_15 btaFight15 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight15.\u003C\u003En__1(entity);
    while (btaFight15.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight15.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight15.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight15.m_playedLines.Add(cardId);
      ...
      if (!(cardId == "BT_354"))
      {
        ...
        {
          if (cardId == "BT_493")
            yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_PriestessofFury_01);
        }
        else
          yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_Metamorphosis_01);
      }
      else
        yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Hero_BladeDance_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight15.\u003C\u003En__2(entity);
      yield return (object) btaFight15.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight15.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      if (!(cardId == "BT_702"))
      {
        ...
        {
          if (cardId == "EX1_126")
            yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Betrayal_01);
        }
        else
          yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_Sprint_01);
      }
      else
        yield return (object) btaFight15.PlayLineAlways(actor, (string) BTA_Fight_15.VO_BTA_BOSS_15h_Female_Broken_Mission_Fight_15_Boss_AshtongueSlayer_01);
    }
  }
