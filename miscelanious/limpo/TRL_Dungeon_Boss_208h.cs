...
public class TRL_Dungeon_Boss_208h : TRL_Dungeon
{
  ...
  {
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_01,
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Seance_02
  };
  private List<string> m_HealingLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_02,
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_03
  };
  private List<string> m_SpellLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_01,
    (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventCopies_01
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Death_Long_03,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Greetings_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Oops_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Sorry_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Thanks_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Threaten_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Well_Played_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Wow_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Kill_Shrine_Generic_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Kill_Shrine_Warrior_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Kill_Shrine_Rogue_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_Killed_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_Killed_02,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_Killed_03,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_02,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_03,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_02,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_03,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_02,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigDamage_03,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_AuchenaiPhantasm_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Seance_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Seance_02,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Surrender_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventMedic_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventMender_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventSoulbreaker_01,
      (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventCopies_01
    })
  ...
  {
    base.OnCreateGame();
    TRL_Dungeon.s_deathLine = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Death_Long_03;
    TRL_Dungeon.s_responseLineGreeting = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Greetings_01;
    TRL_Dungeon.s_responseLineOops = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Oops_01;
    TRL_Dungeon.s_responseLineSorry = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Sorry_01;
    TRL_Dungeon.s_responseLineThanks = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Thanks_01;
    TRL_Dungeon.s_responseLineThreaten = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Threaten_01;
    TRL_Dungeon.s_responseLineWellPlayed = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Well_Played_01;
    TRL_Dungeon.s_responseLineWow = (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Emote_Respond_Wow_01;
  ...
  {
    TRL_Dungeon_Boss_208h trlDungeonBoss208h = this;
    while (trlDungeonBoss208h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 1001:
        yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_02);
        break;
      case 1002:
        yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_02);
        break;
      case 1003:
        yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigSummon_03);
        break;
      case 1004:
        yield return (object) trlDungeonBoss208h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss208h.m_DeathrattleLines);
        break;
      case 1005:
        yield return (object) trlDungeonBoss208h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss208h.m_HealingLines);
        break;
      case 1006:
        yield return (object) trlDungeonBoss208h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss208h.m_SpellLines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) trlDungeonBoss208h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!trlDungeonBoss208h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) trlDungeonBoss208h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      trlDungeonBoss208h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      switch (cardId)
      {
        case "TRLA_150":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventMedic_01);
          break;
        case "TRLA_151":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventMender_01);
          break;
        case "TRLA_152":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_EventSoulbreaker_01);
          break;
        case "TRL_097":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Seance_01);
          break;
        case "TRL_260":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_01);
          break;
        case "TRL_500":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_Surrender_01);
          break;
        case "TRL_501":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Play_AuchenaiPhantasm_01);
          break;
        case "TRL_502":
          yield return (object) trlDungeonBoss208h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_208h.VO_TRLA_208h_Female_Troll_Shrine_BigRez_03);
          break;
      }
    }
  }
