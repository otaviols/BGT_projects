...
public class TB_RoadToNR_Tavern : ULDA_Dungeon
{
  ...
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle_03,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle1_01
  };
  private List<string> m_IntroLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Intro_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Intro_02
  };
  private List<string> m_OutroLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_03,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_04
  };
  private List<string> m_PlayerBroodLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_03
  };
  private List<string> m_PlayerDismissLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerDismiss_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerDismiss_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerDismiss_03
  };
  private List<string> m_PlayerGoodFoodLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerGoodFood_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerGoodFood_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerGoodFood_03
  };
  private List<string> m_PlayerKindleLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerKindle_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerKindle_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerKindle_03
  };
  private List<string> m_PlayerRecruitLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruit_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruit_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruit_03
  };
  private List<string> m_PlayerRecruitAVeteranLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRecruitAVeteran_03
  };
  private List<string> m_PlayerRightHandManLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRightHandMan_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRightHandMan_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRightHandMan_03
  };
  private List<string> m_PlayerRoundofDrinksLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerRoundofDrinks_03
  };
  private List<string> m_PlayerTakeAChanceLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTakeAChance_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTakeAChance_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTakeAChance_03
  };
  private List<string> m_PlayerTallTalesLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTallTales_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTallTales_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTallTales_03
  };
  private List<string> m_PlayerTellAStoryLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTellAStory_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTellAStory_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTellAStory_03
  };
  private List<string> m_PlayerTheChallengeLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_02
  };
  private List<string> m_PlayerTheGangsAllHereLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_03
  };
  private List<string> m_PlayerYoureAllFiredLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_03
  };
  private List<string> m_IntroRenoLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_Reno_Male_Human_Entering_The_Inn_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Reno_Male_Human_Entering_The_Inn_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Reno_Male_Human_Entering_The_Inn_03
  };
  private List<string> m_IntroBrannLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_03
  };
  private List<string> m_IntroEliseLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_03
  };
  private List<string> m_IntroFinleyLines = new List<string>()
  {
    (string) TB_RoadToNR_Tavern.VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_01,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_02,
    (string) TB_RoadToNR_Tavern.VO_ULDA_Finley_Male_Murloc_Entering_The_Inn_03
  };
  ...
  {
    base.OnCreateGame();
    this.m_deathLine = (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Death_01;
    this.m_standardEmoteResponseLine = (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_03;
  }
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Death_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle1_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Idle2_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Intro_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Intro_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroBrann_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroDesert_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroElise_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroFinley_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroHallsofOrigination_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroLostCity_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroReno_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroTomb_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_Outro_04,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_OutroTomb_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerBrood_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerDismiss_01,
      ...
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheChallenge_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerTheGangsAllHere_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_PlayerYoureAllFired_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_RareTreasure_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_01,
      (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_02,
      (string) TB_RoadToNR_Tavern.VO_ULDA_Brann_Male_Dwarf_Entering_The_Inn_03,
      (string) TB_RoadToNR_Tavern.VO_ULDA_Elise_Female_NightElf_Entering_The_Inn_01,
  ...
  {
    TB_RoadToNR_Tavern tbRoadToNrTavern = this;
    while (tbRoadToNrTavern.m_enemySpeaking)
        ...
        if (!(cardId == "ULDA_Reno"))
        {
          if (!(cardId == "ULDA_Brann"))
          {
            if (!(cardId == "ULDA_Finley"))
            {
              ...
              {
                yield return (object) tbRoadToNrTavern.PlayRandomLineAlways(actor, tbRoadToNrTavern.m_IntroEliseLines);
                tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroElise_01);
              }
            }
            else
            {
              yield return (object) tbRoadToNrTavern.PlayRandomLineAlways(actor, tbRoadToNrTavern.m_IntroFinleyLines);
              tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroFinley_01);
            }
          }
          else
          {
            yield return (object) tbRoadToNrTavern.PlayRandomLineAlways(actor, tbRoadToNrTavern.m_IntroBrannLines);
            tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroBrann_01);
          }
        }
        else
        {
          yield return (object) tbRoadToNrTavern.PlayRandomLineAlways(actor, tbRoadToNrTavern.m_IntroRenoLines);
          tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroReno_01);
        }
        yield return (object) tbRoadToNrTavern.PlayRandomLineAlways(enemyActor, tbRoadToNrTavern.m_IntroLines);
        break;
      case 102:
        GameState.Get().SetBusy(true);
        yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(enemyActor, tbRoadToNrTavern.m_OutroLines);
        GameState.Get().SetBusy(false);
        break;
      case 103:
        GameState.Get().SetBusy(true);
        yield return (object) tbRoadToNrTavern.PlayBossLine(enemyActor, (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_OutroTomb_01);
        GameState.Get().SetBusy(false);
        break;
      case 110:
        tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroLostCity_01);
        break;
      case 111:
        tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroDesert_01);
        break;
      case 112:
        tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroTomb_01);
        break;
      case 113:
        tbRoadToNrTavern.m_IntroLines.Add((string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_IntroHallsofOrigination_01);
        break;
      case 60313:
        GameState.Get().SetBusy(true);
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    yield return (object) tbRoadToNrTavern.\u003C\u003En__0(entity);
    while (tbRoadToNrTavern.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!tbRoadToNrTavern.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) tbRoadToNrTavern.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      tbRoadToNrTavern.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      switch (cardId)
      {
        case "DALA_901":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerRecruitLines);
          break;
        case "DALA_902":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerDismissLines);
          break;
        case "DALA_903":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerTakeAChanceLines);
          break;
        case "DALA_904":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerGoodFoodLines);
          break;
        case "DALA_905":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerRightHandManLines);
          break;
        case "DALA_906":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerRoundofDrinksLines);
          break;
        case "DALA_907":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerRecruitAVeteranLines);
          break;
        case "DALA_909":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerYoureAllFiredLines);
          break;
        case "DALA_910":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerTheGangsAllHereLines);
          break;
        case "DALA_911":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerKindleLines);
          break;
        case "DALA_912":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerBroodLines);
          break;
        case "DALA_913":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerTallTalesLines);
          break;
        case "ULDA_602":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerTellAStoryLines);
          break;
        case "ULDA_607":
          yield return (object) tbRoadToNrTavern.PlayLineOnlyOnce(actor, (string) TB_RoadToNR_Tavern.VO_ULDA_900h_Male_Human_RareTreasure_01);
          break;
        case "ULDA_608":
          yield return (object) tbRoadToNrTavern.PlayAndRemoveRandomLineOnlyOnce(actor, tbRoadToNrTavern.m_PlayerTheChallengeLines);
          break;
      }
    }
  }
