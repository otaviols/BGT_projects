...
public class ULDA_Dungeon_Boss_19h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_01,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_02,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_03,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_04,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Idle_01,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Idle_02,
    (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_BossTriggerExecute_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_BossTriggerReinforcements_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Death_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_02,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_03,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_HeroPower_04,
      ...
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Idle_02,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Idle_03,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Intro_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_IntroBrannResponse_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTrigger_5AtkorGreaterWeapon_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTrigger_Colossus_of_the_Moon_01,
      (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTriggerTitanRingTreasure_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "ULDA_Brann")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_IntroBrannResponse_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
  ...
  {
    ULDA_Dungeon_Boss_19h uldaDungeonBoss19h = this;
    while (uldaDungeonBoss19h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    if (missionEvent == 101)
    {
      yield return (object) uldaDungeonBoss19h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTrigger_5AtkorGreaterWeapon_01);
    }
    else
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss19h.\u003C\u003En__0(missionEvent);
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_19h uldaDungeonBoss19h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss19h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss19h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss19h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss19h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss19h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_721"))
      {
        if (cardId == "ULDA_208")
          yield return (object) uldaDungeonBoss19h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTriggerTitanRingTreasure_01);
      }
      else
        yield return (object) uldaDungeonBoss19h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_PlayerTrigger_Colossus_of_the_Moon_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss19h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss19h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss19h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      {
        if (cardId == "ULD_256")
          yield return (object) uldaDungeonBoss19h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_BossTriggerReinforcements_01);
      }
      else
        yield return (object) uldaDungeonBoss19h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_19h.VO_ULDA_BOSS_19h_Male_TitanWatcher_BossTriggerExecute_01);
    }
  }
}
