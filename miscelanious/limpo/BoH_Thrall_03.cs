...
public class BoH_Thrall_03 : BoH_Thrall_Dungeon
{
  ...
  {
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_01,
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_02,
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_01,
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_02,
    (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_03
  };
  ...
  public BoH_Thrall_03() => this.m_gameOptions.AddBooleanOptions(BoH_Thrall_03.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Thrall_03.VO_Story_Hero_DrekThar_Male_Orc_Story_Thrall_Mission3Victory_03,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3EmoteResponse_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeA_02,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeB_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeE_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_02,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3HeroPower_03,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_02,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Idle_03,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Intro_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Loss_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_04,
      (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeA_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeB_02,
      (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeC_01,
      (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3Intro_02,
      (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3Victory_02
    };
  ...
  {
    BoH_Thrall_03 boHThrall03 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHThrall03.MissionPlayVO(actor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Intro_01);
    yield return (object) boHThrall03.MissionPlayVO(friendlyActor, (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3Intro_02);
  ...
  public override void OnCreateGame()
  {
    ...
    this.m_standardEmoteResponseLine = (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3EmoteResponse_01;
  }
  ...
  {
    BoH_Thrall_03 boHThrall03 = this;
    while (boHThrall03.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 102:
        GameState.Get().SetBusy(true);
        yield return (object) boHThrall03.PlayLineAlways(actor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_01);
        yield return (object) boHThrall03.PlayLineAlways(friendlyActor, (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3Victory_02);
        yield return (object) boHThrall03.PlayLineAlways((string) BoH_Thrall_03.DrekTharBrassRing, (string) BoH_Thrall_03.VO_Story_Hero_DrekThar_Male_Orc_Story_Thrall_Mission3Victory_03);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHThrall03.PlayLineAlways(actor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Victory_04);
        GameState.Get().SetBusy(false);
        break;
      case 507:
        GameState.Get().SetBusy(true);
        yield return (object) boHThrall03.PlayLineAlways(actor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHThrall03.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Thrall_03 boHThrall03 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHThrall03.\u003C\u003En__1(entity);
    while (boHThrall03.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHThrall03.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHThrall03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHThrall03.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHThrall03.\u003C\u003En__2(entity);
      yield return (object) boHThrall03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHThrall03.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHThrall03.PlayLineAlways(friendlyActor, (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeA_01);
        yield return (object) boHThrall03.PlayLineAlways(enemyActor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeA_02);
        break;
      case 3:
        yield return (object) boHThrall03.PlayLineAlways(enemyActor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeB_01);
        yield return (object) boHThrall03.PlayLineAlways(friendlyActor, (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeB_02);
        break;
      case 7:
        yield return (object) boHThrall03.PlayLineAlways(friendlyActor, (string) BoH_Thrall_03.VO_Story_Hero_Thrall_Male_Orc_Story_Thrall_Mission3ExchangeC_01);
        break;
      case 11:
        yield return (object) boHThrall03.PlayLineAlways(enemyActor, (string) BoH_Thrall_03.VO_Story_Hero_Orgrim2_Male_Orc_Story_Thrall_Mission3ExchangeE_01);
        break;
    }
  }
}
