...
public class ULDA_Dungeon_Boss_53h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_01,
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_03,
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_04,
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Idle_01,
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Idle_02,
    (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerDaringEscape_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerJarDealer_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerWastelandSapper_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Death_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_03,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_04,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_HeroPower_05,
      ...
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Idle_02,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Idle_03,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Intro_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_IntroSpecial_Finley_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_PlayerTrigger_Beaming_Sidekick_01,
      (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_PlayerTrigger_Weaponized_Wasp_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "ULDA_Finley")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_IntroSpecial_Finley_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else
  ...
  {
    ULDA_Dungeon_Boss_53h uldaDungeonBoss53h = this;
    while (uldaDungeonBoss53h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    if (missionEvent == 101)
    {
      yield return (object) uldaDungeonBoss53h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerWastelandSapper_01);
    }
    else
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss53h.\u003C\u003En__0(missionEvent);
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_53h uldaDungeonBoss53h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss53h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss53h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss53h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss53h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss53h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_191"))
      {
        if (cardId == "ULD_170")
          yield return (object) uldaDungeonBoss53h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_PlayerTrigger_Weaponized_Wasp_01);
      }
      else
        yield return (object) uldaDungeonBoss53h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_PlayerTrigger_Beaming_Sidekick_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss53h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss53h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss53h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      {
        if (cardId == "ULD_282")
          yield return (object) uldaDungeonBoss53h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerJarDealer_01);
      }
      else
        yield return (object) uldaDungeonBoss53h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_53h.VO_ULDA_BOSS_53h_Female_Vulpera_BossTriggerDaringEscape_01);
    }
  }
}
