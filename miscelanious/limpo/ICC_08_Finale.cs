...
public class ICC_08_Finale : ICC_MissionEntity
{
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START && hero.GetCardId() == "HERO_04b")
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_ICC08_LichKing_Male_Human_YoungArthas_02.prefab:851d35d99b9a08a4da37334369d85e29", Notification.SpeechBubbleDirection.TopRight, actor));
    else if (opposingSidePlayer.GetTag(GAME_TAG.OVERRIDE_EMOTE_0) == this.PRIEST_GREETINGS_DISABLED_EMOTE_OVERRIDE_ID)
    {
      if (!this.m_mutedResponses.m_triggers.Contains(emoteType))
        return;
      this.PlayNextEmoteResponse(this.m_mutedResponses, actor);
  ...
  {
    string lichKingIntroLine = this.m_LichKingIntroLines[UnityEngine.Random.Range(0, this.m_LichKingIntroLines.Count)];
    ...
    this.m_emoteResponseGroups = new List<MissionEntity.EmoteResponseGroup>()
    {
      ...
      new MissionEntity.EmoteResponseGroup()
      {
        ...
        m_responses = new List<MissionEntity.EmoteResponse>()
        {
          new MissionEntity.EmoteResponse()
          {
            m_soundName = lichKingIntroLine,
            m_stringTag = new AssetReference(lichKingIntroLine).GetLegacyAssetName()
          }
        }
      },
      new MissionEntity.EmoteResponseGroup()
  ...
  {
    ICC_08_Finale icc08Finale = this;
    while (icc08Finale.m_enemySpeaking)
      yield return (object) null;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    if (turn == 6)
    {
      string kingRandomTurnLine = icc08Finale.m_LichKingRandomTurnLines[UnityEngine.Random.Range(0, icc08Finale.m_LichKingRandomTurnLines.Count)];
      GameState.Get().SetBusy(true);
      if (kingRandomTurnLine == "VO_ICC08_LichKing_Male_Human_Turn6_07")
      {
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Turn6_07.prefab:026da99d6a478b84ebed0b175a8d0827");
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Turn6_08.prefab:172183a2e12a5fe4ea780fc4ec93fec3");
      }
      else
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, kingRandomTurnLine);
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    switch (missionEvent)
    {
      case 2:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_GenericStart_03.prefab:46e864c0ffc68d349bfd31e4b4c15a08");
        GameState.Get().SetBusy(false);
        break;
      case 3:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Hunter_01.prefab:e2d9e2c74bf2a854fabd7324492aa47d");
        GameState.Get().SetBusy(false);
        break;
      case 4:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Mage_01.prefab:57e937f989d277e41b0e47890e7b47fb");
        GameState.Get().SetBusy(false);
        break;
      case 5:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Paladin_01.prefab:34b0a3dcd009efa45b06359422c8b368");
        GameState.Get().SetBusy(false);
        break;
      case 6:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Priest_01.prefab:3d968d835dffada4383d11d82fd47e0b");
        GameState.Get().SetBusy(false);
        break;
      case 7:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Rogue_01.prefab:4138e64fc05f5114ba2b34540f0a3ec5");
        GameState.Get().SetBusy(false);
        break;
      case 8:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Shaman_01.prefab:7003d55c6554cca48a55c71490e2fa71");
        GameState.Get().SetBusy(false);
        break;
      case 9:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Warlock_01.prefab:0c577be64f38882468d65fd25d51d737");
        GameState.Get().SetBusy(false);
        break;
      case 10:
        GameState.Get().SetBusy(true);
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Warrior_01.prefab:4e5cf13fe9eed3c41a24e254d9b27478");
        GameState.Get().SetBusy(false);
        break;
      case 101:
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_EndOfTurn4_01.prefab:6574626660e288f4eb796194bf6fea45");
        break;
      case 103:
        if (icc08Finale.m_GhostLines.Count != 0)
        {
          trappedSoulActors = icc08Finale.GetBossTrappedSoulActors();
          if (trappedSoulActors.Count != 0)
          {
            randomGhostLine = icc08Finale.m_GhostLines[UnityEngine.Random.Range(0, icc08Finale.m_GhostLines.Count)];
            trappedSoulActors.Sort((Comparison<Actor>) ((x, y) => (double) UnityEngine.Random.value >= 0.5 ? 1 : -1));
            GameState.Get().SetBusy(true);
            ...
            {
              yield return (object) icc08Finale.PlayLineOnlyOnce(trappedSoulActors[0], "VO_ICCA08_033_Male_HumanGhost_Flavor_03.prefab:ad2f6e62803a52b498446ccb3cbdc89e");
              yield return (object) icc08Finale.PlayLineOnlyOnce(trappedSoulActors[1], "VO_ICCA08_033_Male_HumanGhost_Flavor_04.prefab:bb379b9e4548b4a4084ca109875ebabf");
              yield return (object) icc08Finale.PlayLineOnlyOnce(trappedSoulActors[2], "VO_ICCA08_033_Male_HumanGhost_Flavor_05.prefab:1e614b8b56fe881468603687a4afe437");
              icc08Finale.m_GhostLines.Remove(randomGhostLine);
            }
            ...
            {
              yield return (object) icc08Finale.PlayLineOnlyOnce(trappedSoulActors[0], randomGhostLine);
              icc08Finale.m_GhostLines.Remove(randomGhostLine);
            }
            GameState.Get().SetBusy(false);
            break;
        ...
        break;
      case 105:
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_PhaseTransition_02.prefab:7544481ca8382ad4a9969284813a029d");
        break;
      case 107:
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Wounded_02.prefab:c81d4dcd56e1b2e45a91576dd48688bd");
        break;
      case 108:
        yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Death_01.prefab:fca6e9173db669c49adcc3bb0a7a9cdc");
        break;
      case 109:
        if (!icc08Finale.m_playedLines.Contains("109"))
        {
          icc08Finale.m_playedLines.Add("109");
          GameState.Get().SetBusy(true);
          if (UnityEngine.Random.Range(0, 10) == 0)
            yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Frostmourne_02.prefab:ae04eda3fb2d4124d9f669ff0a8900a4");
          else
            yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, icc08Finale.m_FrostmournePlayLines[UnityEngine.Random.Range(0, icc08Finale.m_FrostmournePlayLines.Count)]);
          GameState.Get().SetBusy(false);
          break;
        }
        break;
      case 110:
        yield return (object) icc08Finale.PlayLineOnlyOnce(enemyActor, "VO_ICC08_LichKing_Male_Human_Phase03_01.prefab:a3a557c5ae7daff4abb5d9cdb7df9fc6");
        break;
      case 111:
        yield return (object) new WaitForSeconds(0.3f);
        yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Mograine_01.prefab:f6e5161911c3d4e4da50ae3106c41f98");
        break;
      case 112:
        if (icc08Finale.isMissingeLastHorseMen())
        {
          yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Horsemen_01.prefab:318348d96afbbd149896e6d32ae03e5a");
          break;
        }
        break;
      case 113:
        yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_IndestructableWeapon_01.prefab:410f9f1ef41f1bd45b8565fc191a9443");
        break;
      case 114:
        yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_MageSpellReflect_02.prefab:47512997dd73e0943a941cbf069d7ce8");
        break;
      case 115:
        yield return (object) new WaitForSeconds(1f);
        yield return (object) icc08Finale.PlayBossLine(enemyActor, "VO_ICC08_LichKing_Male_Human_MageSpellReflect_01.prefab:4578c14e2604b9140b4c4259a384afe5");
        break;
    }
    trappedSoulActors = (List<Actor>) null;
    randomGhostLine = (string) null;
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!icc08Finale.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) icc08Finale.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      icc08Finale.m_playedLines.Add(cardId);
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      switch (cardId)
      {
        case "AT_036":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_LichKing_Male_Human_ResponseAnubaArak_01.prefab:f07f56be69a5482478280e7e5278bf6e");
          break;
        case "EX1_016":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Sylvanas_01.prefab:4589860c323b62548b030d542e0da276");
          break;
        case "EX1_383":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Tirion_01.prefab:c20cf5d8a42d9f34faddc72368c39bef");
          break;
        case "EX1_559":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Archmage Antonidas_01.prefab:859e44d75d2591f4bafa299e89320a77");
          break;
        case "FP1_013":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Kelthuzad_01.prefab:3ddade3d8c1f22d4ca63960d8f4b4b05");
          break;
        case "GVG_021":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_LichKing_Male_Human_ResponseMalganis_01.prefab:75606e89824ea54418eca3c2b75abfd0");
          break;
        case "GVG_063":
        case "ICC_858":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Bolvar_01.prefab:9b9665e3f305ec34bbf6d482d0b8c85c");
          break;
        case "ICCA08_029":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_LichKingMuted_01.prefab:c50c633fe82ad47409a14886eea1c4df");
          break;
        case "ICC_023":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_LilLich_01.prefab:26542e402ab20f34d9aeecc6d684bd14");
          break;
        case "ICC_204":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Putricide_01.prefab:4dcd0d68d2594344a999c0011b83e880");
          break;
        case "ICC_314":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_LichKing_01.prefab:e721715f493c5c144a674274e3a835b7");
          yield return (object) icc08Finale.PlayEasterEggLine(icc08Finale.GetLichKingFriendlyMinion(), "VO_ICC08_LichKing_Male_Human_LichKing_02.prefab:b6789fd334aa9cb458511335ef404341");
          break;
        case "ICC_838":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Sindragosa_01.prefab:3f87312e12134dc4b9638d0ff88b3acd");
          break;
        case "ICC_841":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Lanathel_01.prefab:7eb2a2125339ded459279f66de43ea76");
          break;
        case "ICC_854":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_Arfas_01.prefab:c8c81d9c0e52c5b4fbe75016840f3582");
          break;
        case "ICC_902":
          yield return (object) icc08Finale.PlayEasterEggLine(enemyActor, "VO_ICC08_LichKing_Male_Human_PowerReplace_01.prefab:de29c2c3a08b3314887c3f4ab1fd5942");
          break;
      }
      yield return (object) icc08Finale.IfPlayerPlaysDKHeroVO(entity, enemyActor, "VO_ICC08_LichKing_Male_Human_TransformDK_01.prefab:a2c40f0880b9cbd4784f39d745d0d50e");
    }
  }
  ...
  protected override IEnumerator HandleGameOverWithTiming(TAG_PLAYSTATE gameResult)
  {
    ...
    if (gameResult == TAG_PLAYSTATE.LOST)
    {
      ...
      if (!NotificationManager.Get().HasSoundPlayedThisSession(soundPath))
        yield return (object) Gameplay.Get().StartCoroutine(icc08Finale.PlayCharacterQuoteAndWait("LichKing_Banner_Quote.prefab:d42a8f4f69919f449b3dd8ebceaf2a3c", soundPath));
    }
  }
  ...
  private List<Actor> GetBossTrappedSoulActors()
  {
    ...
    foreach (Card card in opposingSidePlayer.GetBattlefieldZone().GetCards())
    {
      ...
      if (entity.GetControllerId() == opposingSidePlayer.GetPlayerId() && entity.GetCardId() == "ICCA08_033")
        trappedSoulActors.Add(entity.GetCard().GetActor());
    }
  ...
  private bool isMissingeLastHorseMen()
  {
    ...
    {
      Entity entity = card.GetEntity();
      if (entity.GetControllerId() == opposingSidePlayer.GetPlayerId() && stringList.Contains(entity.GetCardId()))
        stringList.Remove(entity.GetCardId());
    }
  ...
  {
    bool finished = false;
    NotificationManager.Get().CreateBigCharacterQuoteWithText("Tirion_BigQuote.prefab:878fcebc1cddaf24f828c44edb07f7f8", NotificationManager.DEFAULT_CHARACTER_POS, "VO_ICC08_Tirion_Male_Human_Win_01.prefab:e97467bae07fb0340a24b6772b048608", GameStrings.Get("VO_ICC08_Tirion_Male_Human_Win_01"), 2f, bubbleDir: Notification.SpeechBubbleDirection.BottomLeft).OnFinishDeathState += (Action<int>) (groupId => finished = true);
    while (!finished)
      yield return (object) null;
  }

  public IEnumerator PlayFriendlyHeroVictoryVO(
    Actor actor,
    AudioSource preTransformationAudio,
    AudioSource midTransformationAudio)
  {
    ICC_08_Finale icc08Finale = this;
    TAG_CLASS key = GameState.Get().GetFriendlySidePlayer().GetStartingHero().GetClass();
    string[] voLines;
    if (icc08Finale.m_HeroVictoryLines.TryGetValue(key, out voLines))
    {
      float scale = (bool) UniversalInputManager.UsePhoneUI ? 0.5f : 0.75f;
      if ((UnityEngine.Object) preTransformationAudio != (UnityEngine.Object) null)
        SoundManager.Get().Play(preTransformationAudio);
      yield return (object) icc08Finale.PlaySoundAndBlockSpeech(voLines[0], Notification.SpeechBubbleDirection.BottomLeft, actor, 2f, parentBubbleToActor: false, bubbleScale: scale);
      if ((UnityEngine.Object) midTransformationAudio != (UnityEngine.Object) null)
        SoundManager.Get().Play(midTransformationAudio);
      yield return (object) new WaitForSeconds(0.5f);
      yield return (object) icc08Finale.PlaySoundAndBlockSpeech(voLines[1], Notification.SpeechBubbleDirection.BottomLeft, actor, 2f, parentBubbleToActor: false, bubbleScale: scale);
    }
  }
}
