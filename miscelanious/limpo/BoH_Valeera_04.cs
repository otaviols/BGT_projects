...
public class BoH_Valeera_04 : BoH_Valeera_Dungeon
{
  ...
  {
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_01,
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_02,
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_01,
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_02,
    (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4ExchangeB_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4ExchangeC_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4Victory_04,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Death_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4EmoteResponse_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4ExchangeA_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4HeroPower_03,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Idle_03,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Intro_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Loss_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Victory_01,
      (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4ExchangeB_01,
      (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4ExchangeC_03,
      (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4Intro_02,
      (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4Victory_03,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4ExchangeA_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4ExchangeC_01,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4ExchangeC_03,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Intro_03,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Victory_02,
      (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Victory_05
    };
  ...
  {
    BoH_Valeera_04 boHValeera04 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHValeera04.MissionPlayVO(actor, (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Intro_01);
    yield return (object) boHValeera04.MissionPlayVO(BoH_Valeera_04.BrollBrassRing, (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4Intro_02);
    yield return (object) boHValeera04.MissionPlayVO(friendlyActor, (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Intro_03);
  ...
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Death_01;
    this.m_OverrideMusicTrack = MusicPlaylistType.InGame_BT;
    this.m_standardEmoteResponseLine = (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4EmoteResponse_01;
  }
  ...
  {
    BoH_Valeera_04 boHValeera04 = this;
    while (boHValeera04.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 102:
        GameState.Get().SetBusy(true);
        yield return (object) boHValeera04.PlayLineAlways(actor, (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 103:
        GameState.Get().SetBusy(true);
        yield return (object) boHValeera04.PlayLineAlways(friendlyActor, (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Victory_02);
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.BrollBrassRing, (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4Victory_03);
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.VarianBrassRing, (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4Victory_04);
        yield return (object) boHValeera04.PlayLineAlways(friendlyActor, (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4Victory_05);
        GameState.Get().SetBusy(false);
        break;
      case 507:
        yield return (object) boHValeera04.PlayLineAlways(actor, (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4Loss_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHValeera04.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Valeera_04 boHValeera04 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHValeera04.\u003C\u003En__1(entity);
    while (boHValeera04.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHValeera04.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHValeera04.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHValeera04.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHValeera04.\u003C\u003En__2(entity);
      yield return (object) boHValeera04.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHValeera04.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHValeera04.PlayLineAlways(actor, (string) BoH_Valeera_04.VO_Story_Hero_Vendellin_Male_BloodElf_Story_Valeera_Mission4ExchangeA_01);
        yield return (object) boHValeera04.PlayLineAlways(friendlyActor, (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4ExchangeA_02);
        break;
      case 7:
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.BrollBrassRing, (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4ExchangeB_01);
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.VarianBrassRing, (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4ExchangeB_02);
        break;
      case 11:
        yield return (object) boHValeera04.PlayLineAlways(friendlyActor, (string) BoH_Valeera_04.VO_Story_Hero_Valeera_Female_BloodElf_Story_Valeera_Mission4ExchangeC_01);
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.VarianBrassRing, (string) BoH_Valeera_04.VO_Story_Hero_Varian_Male_Human_Story_Valeera_Mission4ExchangeC_02);
        yield return (object) boHValeera04.PlayLineAlways((string) BoH_Valeera_04.BrollBrassRing, (string) BoH_Valeera_04.VO_Story_Minion_Broll_Male_NightElf_Story_Valeera_Mission4ExchangeC_03);
        break;
    }
  }
}
