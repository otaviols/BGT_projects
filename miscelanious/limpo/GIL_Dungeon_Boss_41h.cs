...
public class GIL_Dungeon_Boss_41h : GIL_Dungeon
{
  ...
  {
    GIL_Dungeon_Boss_41h gilDungeonBoss41h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) gilDungeonBoss41h.\u003C\u003En__0(entity);
    while (gilDungeonBoss41h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    yield return (object) gilDungeonBoss41h.WaitForEntitySoundToFinish(entity);
    string cardId = entity.GetCardId();
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    if (cardId == "GILA_BOSS_41t")
    {
      string line = gilDungeonBoss41h.PopRandomLineWithChance(gilDungeonBoss41h.m_HackLines);
      if (line != null)
        yield return (object) gilDungeonBoss41h.PlayLineOnlyOnce(actor, line);
    }
  }
  ...
  protected override string GetBossDeathLine() => "VO_GILA_BOSS_41h_Male_NightElf_Death_01.prefab:4a86b581b0c06f54f8566bd5def843a8";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Male_NightElf_Intro_01.prefab:2ee1227d69533f24197e3d948f21f858", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_41h_Male_NightElf_EmoteResponse_02.prefab:b6265a8078217254181079a5796fcc1f", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }
}
