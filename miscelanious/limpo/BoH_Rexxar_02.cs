...
public class BoH_Rexxar_02 : BoH_Rexxar_Dungeon
{
  ...
  {
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_01,
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_02,
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_03
  };
  private List<string> m_VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2IdleLines = new List<string>()
  {
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_01,
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_02,
    (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_03
  };
  ...
  public BoH_Rexxar_02() => this.m_gameOptions.AddBooleanOptions(BoH_Rexxar_02.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2EmoteResponse_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeA_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeB_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeC_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeC_02,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeD_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_02,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPower_03,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_02,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Idle_03,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Intro_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Loss_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Victory_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeA_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeB_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeC_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Intro_01,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Intro_02,
      (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Victory_01
    };
  ...
  {
    BoH_Rexxar_02 boHRexxar02 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Intro_01);
    yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Intro_01);
    yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Intro_02);
    GameState.Get().SetBusy(false);
  }

  public override List<string> GetIdleLines() => this.m_VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2IdleLines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2HeroPowerLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2EmoteResponse_01;
  }
  ...
  {
    BoH_Rexxar_02 boHRexxar02 = this;
    while (boHRexxar02.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) boHRexxar02.PlayLineAlways(actor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Victory_01);
        yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHRexxar02.PlayLineAlways(actor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHRexxar02.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Rexxar_02 boHRexxar02 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHRexxar02.\u003C\u003En__1(entity);
    while (boHRexxar02.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHRexxar02.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHRexxar02.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHRexxar02.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHRexxar02.\u003C\u003En__2(entity);
      yield return (object) boHRexxar02.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHRexxar02.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeA_01);
        yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeA_01);
        break;
      case 3:
        yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeB_01);
        yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeB_01);
        break;
      case 5:
        yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeC_01);
        yield return (object) boHRexxar02.PlayLineAlways(friendlyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Rexxar_Male_OrcOgre_Story_Rexxar_Mission2ExchangeC_01);
        yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeC_02);
        break;
      case 11:
        yield return (object) boHRexxar02.PlayLineAlways(enemyActor, (string) BoH_Rexxar_02.VO_Story_Hero_Blackhand_Male_Orc_Story_Rexxar_Mission2ExchangeD_01);
        break;
    }
  }
