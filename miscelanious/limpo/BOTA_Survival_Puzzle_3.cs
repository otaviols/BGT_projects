...
public class BOTA_Survival_Puzzle_3 : BOTA_MissionEntity
{
  ...
  private string COMPLETE_LINE = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Complete_01;
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Complete_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_EmoteResponse_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_EmoteResponse_02,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_EmoteResponse_03,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_02,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_03,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_04,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_05,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_06,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Idle_07,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Intro_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_02,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_03,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_04,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_05,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_06,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_07,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Restart_08,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Return_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_01,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_03,
      (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_04
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Return_01;
    this.s_victoryLine_1 = (string) null;
    this.s_victoryLine_2 = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_04;
    this.s_victoryLine_3 = (string) null;
    this.s_victoryLine_4 = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_01;
    this.s_victoryLine_5 = (string) null;
    this.s_victoryLine_6 = (string) BOTA_Survival_Puzzle_3.VO_BOTA_BOSS_17h_Male_Mech_Puzzle_03;
  ...
  {
    BOTA_Survival_Puzzle_3 botaSurvivalPuzzle3 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    if (missionEvent == 99)
    {
      while (botaSurvivalPuzzle3.m_enemySpeaking)
        yield return (object) null;
      GameState.Get().SetBusy(true);
      yield return (object) botaSurvivalPuzzle3.PlayBossLine(enemyActor, botaSurvivalPuzzle3.COMPLETE_LINE);
