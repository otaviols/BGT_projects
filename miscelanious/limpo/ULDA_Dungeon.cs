...
public class ULDA_Dungeon : ULDA_MissionEntity
{
  ...
  {
    (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_01,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_02,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_03
  };
  private List<string> m_BossMadnessPlotTwistTauntLines = new List<string>()
  {
    (string) ULDA_Dungeon.VO_ULDA_BOSS_38h_Male_PlagueLord_BossPlotTwistTaunt_01,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_38h_Male_PlagueLord_BossPlotTwistTaunt_02,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_38h_Male_PlagueLord_BossPlotTwistTaunt_03
  };
  private List<string> m_BossMurlocPlotTwistTauntLines = new List<string>()
  {
    (string) ULDA_Dungeon.VO_ULDA_BOSS_39h_Male_PlagueLord_BossPlotTwistTaunt_01,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_39h_Male_PlagueLord_BossPlotTwistTaunt_02,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_39h_Male_PlagueLord_BossPlotTwistTaunt_03
  };
  private List<string> m_BossWrathPlotTwistTauntLines = new List<string>()
  {
    (string) ULDA_Dungeon.VO_ULDA_BOSS_40h_Female_PlagueLord_BossPlotTwistTaunt_01,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_40h_Female_PlagueLord_BossPlotTwistTaunt_02,
    (string) ULDA_Dungeon.VO_ULDA_BOSS_40h_Female_PlagueLord_BossPlotTwistTaunt_03
  };
  private List<string> m_EliseTreasureAddarah = new List<string>()
  {
    (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureAddarah_01,
    (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureAddarah_02
  };
  ...
  public static ULDA_Dungeon InstantiateULDADungeonMissionEntityForBoss(
    ...
    Network.HistCreateGame createGame)
  {
    ...
    switch (opposingHeroCardId)
    {
      case "TB_TempleOutrunHHorsema":
        return (ULDA_Dungeon) new TB_TempleOutrun_Headless();
      case "TB_TempleOutrun_Ammunae":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_71h();
      case "TB_TempleOutrun_Battrund":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_31h();
      case "TB_TempleOutrun_Colossus":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_22h();
      case "TB_TempleOutrun_Ichabod":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_17h();
      case "TB_TempleOutrun_Isiset":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_69h();
      case "TB_TempleOutrun_Jar":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_47h();
      case "TB_TempleOutrun_Jythiros":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_58h();
      case "TB_TempleOutrun_Kasmut":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_51h();
      case "TB_TempleOutrun_Kham":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_20h();
      case "TB_TempleOutrun_LichBazhial":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_52h();
      case "TB_TempleOutrun_Octosari":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_78h();
      case "TB_TempleOutrun_Pillager":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_31h();
      case "TB_TempleOutrun_Rajh":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_70h();
      case "TB_TempleOutrun_Setesh":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_72h();
      case "TB_TempleOutrun_Sothis":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_19h();
      case "TB_TempleOutrun_Toomba":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_27h();
      case "TB_TempleOutrun_TrapRoom":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_44h();
      case "TB_TempleOutrun_Zafarr":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_02h();
      case "TB_TempleOutrun_Zaraam":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_52h();
      case "ULDA_BOSS_01h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_01h();
      case "ULDA_BOSS_02h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_02h();
      case "ULDA_BOSS_03h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_03h();
      case "ULDA_BOSS_04h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_04h();
      case "ULDA_BOSS_05h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_05h();
      case "ULDA_BOSS_06h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_06h();
      case "ULDA_BOSS_07h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_07h();
      case "ULDA_BOSS_08h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_08h();
      case "ULDA_BOSS_09h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_09h();
      case "ULDA_BOSS_10h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_10h();
      case "ULDA_BOSS_11h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_11h();
      case "ULDA_BOSS_12h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_12h();
      case "ULDA_BOSS_13h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_13h();
      case "ULDA_BOSS_14h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_14h();
      case "ULDA_BOSS_15h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_15h();
      case "ULDA_BOSS_16h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_16h();
      case "ULDA_BOSS_17h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_17h();
      case "ULDA_BOSS_18h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_18h();
      case "ULDA_BOSS_19h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_19h();
      case "ULDA_BOSS_20h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_20h();
      case "ULDA_BOSS_21h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_21h();
      case "ULDA_BOSS_22h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_22h();
      case "ULDA_BOSS_23h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_23h();
      case "ULDA_BOSS_24h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_24h();
      case "ULDA_BOSS_25h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_25h();
      case "ULDA_BOSS_26h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_26h();
      case "ULDA_BOSS_27h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_27h();
      case "ULDA_BOSS_28h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_28h();
      case "ULDA_BOSS_29h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_29h();
      case "ULDA_BOSS_30h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_30h();
      case "ULDA_BOSS_31h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_31h();
      case "ULDA_BOSS_32h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_32h();
      case "ULDA_BOSS_33h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_33h();
      case "ULDA_BOSS_34h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_34h();
      case "ULDA_BOSS_35h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_35h();
      case "ULDA_BOSS_36h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_36h();
      case "ULDA_BOSS_37h":
      case "ULDA_BOSS_37h2":
      case "ULDA_BOSS_37h3":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_37h();
      case "ULDA_BOSS_38h":
      case "ULDA_BOSS_38h2":
      case "ULDA_BOSS_38h3":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_38h();
      case "ULDA_BOSS_39h":
      case "ULDA_BOSS_39h2":
      case "ULDA_BOSS_39h3":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_39h();
      case "ULDA_BOSS_40h":
      case "ULDA_BOSS_40h2":
      case "ULDA_BOSS_40h3":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_40h();
      case "ULDA_BOSS_41h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_41h();
      case "ULDA_BOSS_42h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_42h();
      case "ULDA_BOSS_43h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_43h();
      case "ULDA_BOSS_44h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_44h();
      case "ULDA_BOSS_45h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_45h();
      case "ULDA_BOSS_46h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_46h();
      case "ULDA_BOSS_47h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_47h();
      case "ULDA_BOSS_48h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_48h();
      case "ULDA_BOSS_49h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_49h();
      case "ULDA_BOSS_50h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_50h();
      case "ULDA_BOSS_51h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_51h();
      case "ULDA_BOSS_52h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_52h();
      case "ULDA_BOSS_53h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_53h();
      case "ULDA_BOSS_54h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_54h();
      case "ULDA_BOSS_55h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_55h();
      case "ULDA_BOSS_56h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_56h();
      case "ULDA_BOSS_57h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_57h();
      case "ULDA_BOSS_58h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_58h();
      case "ULDA_BOSS_59h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_59h();
      case "ULDA_BOSS_60h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_60h();
      case "ULDA_BOSS_61h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_61h();
      case "ULDA_BOSS_62h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_62h();
      case "ULDA_BOSS_63h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_63h();
      case "ULDA_BOSS_65h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_65h();
      case "ULDA_BOSS_66h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_66h();
      case "ULDA_BOSS_67h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_67h();
      case "ULDA_BOSS_68h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_68h();
      case "ULDA_BOSS_69h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_69h();
      case "ULDA_BOSS_70h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_70h();
      ...
      case "ULDA_BOSS_72h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_72h();
      case "ULDA_BOSS_73h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_73h();
      case "ULDA_BOSS_74h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_74h();
      case "ULDA_BOSS_75h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_75h();
      case "ULDA_BOSS_76h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_76h();
      case "ULDA_BOSS_77h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_77h();
      case "ULDA_BOSS_78h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_78h();
      case "ULDA_BOSS_79h":
        return (ULDA_Dungeon) new ULDA_Dungeon_Boss_79h();
      default:
        Log.All.PrintError("ULDA_Dungeon.InstantiateULDADungeonMissionEntityForBoss() - Found unsupported enemy Boss {0}.", (object) opposingHeroCardId);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_KillCommand_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_SecretTrap_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_Whirlwind_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_Innervate_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_Silence_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_SpreadingPlague_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Bloodlust_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Consecration_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Tip_the_Scales_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Burgle_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Fireball_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Frostbolt_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TUT_PlagueLord_Turn1_Brann_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_Elise_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswer_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswerSelf_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_TUT_PlagueLord_Turn1_Finley_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TUT_PlagueLord_Turn1_Reno_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter01a_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter02a_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter03a_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter04a_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Elise_Chapter02b_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter01b_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter03b_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter04b_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Reno_Chapter01b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter01b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter02b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter03b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter04b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter01a_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter02a_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter03a_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter04a_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Reno_Chapter02b_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Reno_Chapter04b_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Elise_Chapter01b_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter01a_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter02a_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter03a_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter04a_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Reno_Chapter03b_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Elise_Chapter03b_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Elise_Chapter04b_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Finley_Chapter02b_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter01a_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter02a_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter03a_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter04a_01,
      (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_01,
      (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_02,
      (string) ULDA_Dungeon.VO_ULDA_BOSS_37h_Female_PlagueLord_BossPlotTwistTaunt_03,
      (string) ULDA_Dungeon.VO_ULDA_BOSS_38h_Male_PlagueLord_BossPlotTwistTaunt_01,
      ...
      (string) ULDA_Dungeon.VO_ULDA_BOSS_40h_Female_PlagueLord_BossPlotTwistTaunt_02,
      (string) ULDA_Dungeon.VO_ULDA_BOSS_40h_Female_PlagueLord_BossPlotTwistTaunt_03,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureGatlingWand_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureHat_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureJrExplorer_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureLei_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureTitanRing_01,
      (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureWhip_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseJrExplorer_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureAddarah_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureAddarah_02,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureDruidStaff_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureMachete_01,
      (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureScarabStatue_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureBlunderbuss_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureFlo_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureGiantEgg_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureJrExplorer_01,
      (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureSaddle_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureJrExplorer_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureKarl_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureLance_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureMurkyHorn_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasurePandarenTeaSet_01,
      (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureScarabMount_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Copycard_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_CopyCards_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_CostRandomizer_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_DrawExtra_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Emptyhand_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_ExtraMana_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_ExtraTurn_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Fatigue_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FatigueReset_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FreeMinions_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FreezeMinions_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_HealPlayer_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Minionwipe_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_MirrorImage_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_RandomCast_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_RandomLegendary_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SaveLife_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SelfDamage_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SpellCast_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Start_01,
      (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Treasure_01
    };
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    ULDA_Dungeon uldaDungeon = this;
    if (num != 0)
      return false;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if (uldaDungeon.m_enemySpeaking || entity.GetCardType() == TAG_CARDTYPE.INVALID || entity.GetCardType() != TAG_CARDTYPE.HERO_POWER || entity.GetControllerSide() != Player.Side.OPPOSING)
      return false;
    uldaDungeon.OnBossHeroPowerPlayed(entity);
    return false;
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (uldaDungeon.m_enemySpeaking)
      yield return (object) null;
    yield return (object) uldaDungeon.WaitForEntitySoundToFinish(entity);
    ...
    if (playerHeroCardID == "ULDA_Reno")
    {
      ...
      {
        case "AT_033":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Burgle_01);
          break;
        case "CS2_024":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Frostbolt_01);
          break;
        case "CS2_029":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TRIGGER_Fireball_01);
          break;
        case "ULDA_016":
        case "ULDA_021":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureJrExplorer_01);
          break;
        case "ULDA_201":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureWhip_01);
          break;
        case "ULDA_203":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureHat_01);
          break;
        case "ULDA_206":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureLei_01);
          break;
        case "ULDA_207":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_RenoTreasureGatlingWand_01);
          break;
      }
    }
    if (playerHeroCardID == "ULDA_Finley")
    {
      ...
      {
        case "CS2_046":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Bloodlust_01);
          break;
        case "CS2_093":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Consecration_01);
          break;
        case "ULDA_010":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureMurkyHorn_01);
          break;
        case "ULDA_015":
        case "ULDA_020":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureJrExplorer_01);
          break;
        case "ULDA_501":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureScarabMount_01);
          break;
        case "ULDA_504":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasurePandarenTeaSet_01);
          break;
        case "ULDA_505":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureLance_01);
          break;
        case "ULDA_507":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_FinleyTreasureKarl_01);
          break;
        case "ULD_716":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_Trigger_Tip_the_Scales_01);
          break;
      }
    }
    if (playerHeroCardID == "ULDA_Elise")
    {
      ...
      {
        case "EX1_169":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_Innervate_01);
          break;
        case "EX1_332":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_Silence_01);
          break;
        case "ICC_054":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TRIGGER_SpreadingPlague_01);
          break;
        case "ULDA_003":
          yield return (object) uldaDungeon.PlayAndRemoveRandomLineOnlyOnce(playerActor, uldaDungeon.m_EliseTreasureAddarah);
          break;
        case "ULDA_017":
        case "ULDA_022":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseJrExplorer_01);
          break;
        case "ULDA_302":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureScarabStatue_01);
          break;
        case "ULDA_304":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureDruidStaff_01);
          break;
        case "ULDA_305":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_EliseTreasureMachete_01);
          break;
      }
    }
    if (playerHeroCardID == "ULDA_Brann")
    {
      switch (cardID)
      {
        ...
        case "ICC_200":
        case "LOE_021":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_SecretTrap_01);
          break;
        case "EX1_400":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_Whirlwind_01);
          break;
        case "EX1_539":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TRIGGER_KillCommand_01);
          break;
        case "ULDA_002":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureFlo_01);
          break;
        case "ULDA_018":
        case "ULDA_023":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureJrExplorer_01);
          break;
        case "ULDA_401":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureBlunderbuss_01);
          break;
        case "ULDA_402":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureSaddle_01);
          break;
        case "ULDA_405":
          yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_BrannTreasureGiantEgg_01);
          break;
      }
    }
  }
  ...
  protected float ChanceToPlayMurlocPlotTwistVOLine() => 0.1f;

  protected float ChanceToPlayMadnessPlotTwistVOLine() => 0.1f;

  protected float ChanceToPlayDeathPlotTwistVOLine() => 0.5f;

  protected float ChanceToPlayWrathPlotTwistVOLine() => 0.05f;

  public IEnumerator PlayAndRemoveRandomLineOnlyOnce(Actor actor, List<string> lines)
  {
    ULDA_Dungeon uldaDungeon = this;
    string line = uldaDungeon.PopRandomLine(lines);
    if (line != null)
      yield return (object) uldaDungeon.PlayLineOnlyOnce(actor, line);
  }
  ...
  public IEnumerator PlayRandomLineAlways(Actor actor, List<string> lines)
  {
    ...
    string line = uldaDungeon.PopRandomLine(lines);
    if (line != null)
      yield return (object) uldaDungeon.PlayBossLine(actor, line);
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    bool flag = false;
    int num2 = uldaDungeon.GetTag(GAME_TAG.TURN) - GameState.Get().GetGameEntity().GetTag(GAME_TAG.EXTRA_TURNS_TAKEN_THIS_GAME);
    ...
    {
      case 505:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Copycard_01);
        break;
      case 506:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_CopyCards_01);
        break;
      case 507:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_CostRandomizer_01);
        break;
      case 508:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_DrawExtra_01);
        break;
      case 509:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Emptyhand_01);
        break;
      case 510:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_ExtraMana_01);
        break;
      case 511:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_ExtraTurn_01);
        break;
      case 512:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Fatigue_01);
        break;
      case 513:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FatigueReset_01);
        break;
      case 514:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FreeMinions_01);
        break;
      case 515:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_FreezeMinions_01);
        break;
      case 516:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_HealPlayer_01);
        break;
      case 517:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Minionwipe_01);
        break;
      case 518:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_MirrorImage_01);
        break;
      case 519:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_RandomCast_01);
        break;
      case 520:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_RandomLegendary_01);
        break;
      case 521:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SaveLife_01);
        break;
      case 522:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SelfDamage_01);
        break;
      case 523:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_SpellCast_01);
        break;
      case 524:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Start_01);
        break;
      case 525:
        yield return (object) uldaDungeon.PlayBossLine((string) ULDA_Dungeon.Wisdomball_Pop_up_BrassRing_Quote, (string) ULDA_Dungeon.VO_DALA_BOSS_60h_Male_Human_FloatingHead_Trigger_Treasure_01);
        break;
      case 801:
        if ((double) uldaDungeon.ChanceToPlayDeathPlotTwistVOLine() < (double) num1 || uldaDungeon.TurnOfPlotTwistLastPlayed >= num2)
          break;
        uldaDungeon.TurnOfPlotTwistLastPlayed = num2;
        if (flag)
        {
          yield return (object) uldaDungeon.PlayRandomLineAlways(actor2, uldaDungeon.m_BossDeathPlotTwistTauntLines);
          break;
        }
        uldaDungeon.TurnOfPlotTwistLastPlayed = num2;
        yield return (object) uldaDungeon.PlayRandomLineAlways((string) ULDA_Dungeon.Tombs_of_Terror_Xatma_BrassRing_Quote, uldaDungeon.m_BossDeathPlotTwistTauntLines);
        break;
      case 802:
        if ((double) uldaDungeon.ChanceToPlayMadnessPlotTwistVOLine() < (double) num1 || uldaDungeon.TurnOfPlotTwistLastPlayed >= num2)
          break;
        uldaDungeon.TurnOfPlotTwistLastPlayed = num2;
        if (flag)
        {
          yield return (object) uldaDungeon.PlayRandomLineAlways(actor2, uldaDungeon.m_BossMadnessPlotTwistTauntLines);
          break;
        }
        yield return (object) uldaDungeon.PlayRandomLineAlways((string) ULDA_Dungeon.Tombs_of_Terror_Kzrath_BrassRing_Quote, uldaDungeon.m_BossMadnessPlotTwistTauntLines);
        break;
      case 803:
        if ((double) uldaDungeon.ChanceToPlayMurlocPlotTwistVOLine() < (double) num1 || uldaDungeon.TurnOfPlotTwistLastPlayed >= num2)
          break;
        uldaDungeon.TurnOfPlotTwistLastPlayed = num2;
        if (flag)
        {
          yield return (object) uldaDungeon.PlayRandomLineAlways(actor2, uldaDungeon.m_BossMurlocPlotTwistTauntLines);
          break;
        }
        yield return (object) uldaDungeon.PlayRandomLineAlways((string) ULDA_Dungeon.Tombs_of_Terror_Vesh_BrassRing_Quote, uldaDungeon.m_BossMurlocPlotTwistTauntLines);
        break;
      case 804:
        if ((double) uldaDungeon.ChanceToPlayWrathPlotTwistVOLine() < (double) num1 || uldaDungeon.TurnOfPlotTwistLastPlayed >= num2)
          break;
        uldaDungeon.TurnOfPlotTwistLastPlayed = num2;
        if (flag)
        {
          yield return (object) uldaDungeon.PlayRandomLineAlways(actor2, uldaDungeon.m_BossWrathPlotTwistTauntLines);
          break;
        }
        yield return (object) uldaDungeon.PlayRandomLineAlways((string) ULDA_Dungeon.Tombs_of_Terror_Icarax_BrassRing_Quote, uldaDungeon.m_BossWrathPlotTwistTauntLines);
        break;
      case 1000:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        if (uldaDungeon.m_PlayPlayerVOLineIndex + 1 >= uldaDungeon.m_PlayerVOLines.Count)
          uldaDungeon.m_PlayPlayerVOLineIndex = 0;
        else
          ++uldaDungeon.m_PlayPlayerVOLineIndex;
        SceneDebugger.Get().AddMessage(uldaDungeon.m_PlayerVOLines[uldaDungeon.m_PlayPlayerVOLineIndex]);
        yield return (object) uldaDungeon.PlayBossLine(actor1, uldaDungeon.m_PlayerVOLines[uldaDungeon.m_PlayPlayerVOLineIndex]);
        break;
      case 1001:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(uldaDungeon.m_PlayerVOLines[uldaDungeon.m_PlayPlayerVOLineIndex]);
      ...
      case 1002:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        if (uldaDungeon.m_PlayBossVOLineIndex + 1 >= uldaDungeon.m_BossVOLines.Count)
          uldaDungeon.m_PlayBossVOLineIndex = 0;
        else
          ++uldaDungeon.m_PlayBossVOLineIndex;
        SceneDebugger.Get().AddMessage(uldaDungeon.m_BossVOLines[uldaDungeon.m_PlayBossVOLineIndex]);
        yield return (object) uldaDungeon.PlayBossLine(actor2, uldaDungeon.m_BossVOLines[uldaDungeon.m_PlayBossVOLineIndex]);
        break;
      case 1003:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(uldaDungeon.m_BossVOLines[uldaDungeon.m_PlayBossVOLineIndex]);
      ...
      default:
        ...
        yield return (object) uldaDungeon.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    if (turn == 1 & ULDA_MissionEntity.GetIsFirstBoss() && GameState.Get() != null && GameState.Get().GetFriendlySidePlayer() != null && GameState.Get().GetFriendlySidePlayer().GetHero() != null)
    {
      switch (missionId)
      {
        ...
        case ScenarioDbId.ULDA_CITY_HEROIC:
          if (!(playerHeroCardID == "ULDA_Reno"))
          {
            if (playerHeroCardID == "ULDA_Finley")
            {
              yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter01a_01);
              yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Brann_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter01b_01);
              break;
            }
            if (playerHeroCardID == "ULDA_Brann")
            {
              yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter01a_01);
              yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter01b_01);
              break;
            }
            if (playerHeroCardID == "ULDA_Elise")
            {
              yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter01a_01);
              yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Finley_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Elise_Chapter01b_01);
              break;
            }
            break;
          }
        ...
        case ScenarioDbId.ULDA_DESERT_HEROIC:
          if (playerHeroCardID == "ULDA_Reno")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter02a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Reno_Chapter02b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Finley")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter02a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Reno_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Finley_Chapter02b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Brann")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter02a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter02b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Elise")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter02a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Brann_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Elise_Chapter02b_01);
            break;
          }
          break;
        ...
        case ScenarioDbId.ULDA_TOMB_HEROIC:
          if (playerHeroCardID == "ULDA_Reno")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter03a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Finley_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Reno_Chapter03b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Finley")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter03a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Brann_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter03b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Brann")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter03a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter03b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Elise")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter03a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Reno_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Elise_Chapter03b_01);
            break;
          }
          break;
        ...
        case ScenarioDbId.ULDA_HALLS_HEROIC:
          if (playerHeroCardID == "ULDA_Reno")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Reno_Chapter04a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Reno_Chapter04b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Finley")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_STORY_Banter_Finley_Chapter04a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Brann_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Finley_Chapter04b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Brann")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_STORY_Banter_Brann_Chapter04a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Brann_Chapter04b_01);
            break;
          }
          if (playerHeroCardID == "ULDA_Elise")
          {
            yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_STORY_Banter_Elise_Chapter04a_01);
            yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Reno_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_STORY_Banter_Elise_Chapter04b_01);
            break;
          }
          break;
      }
    }
    int num = GameUtils.GetDefeatedBossCount() == uldaDungeon.GetDefeatedBossCountForFinalBoss() ? 1 : 0;
    int currentHealth = GameState.Get().GetOpposingSidePlayer().GetHero().GetCurrentHealth();
    if (num != 0 && uldaDungeon.GetDefeatedBossCountForFinalBoss() != 0 && currentHealth == 300)
    {
      if (playerHeroCardID == "ULDA_Reno")
      {
        GameState.Get().SetBusy(true);
        yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Reno_Male_Human_TUT_PlagueLord_Turn1_Reno_01);
        yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswer_01);
        GameState.Get().SetBusy(false);
      }
      else if (playerHeroCardID == "ULDA_Finley")
      {
        GameState.Get().SetBusy(true);
        yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Finley_Male_Murloc_TUT_PlagueLord_Turn1_Finley_01);
        yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswer_01);
        GameState.Get().SetBusy(false);
      }
      ...
      {
        GameState.Get().SetBusy(true);
        yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Brann_Male_Dwarf_TUT_PlagueLord_Turn1_Brann_01);
        yield return (object) uldaDungeon.PlayLineOnlyOnce((string) ULDA_Dungeon.Tombs_of_Terror_Elise_BrassRing_Quote, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswer_01);
        GameState.Get().SetBusy(false);
      }
      ...
      {
        GameState.Get().SetBusy(true);
        yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_Elise_01);
        yield return (object) uldaDungeon.PlayLineOnlyOnce(playerActor, (string) ULDA_Dungeon.VO_ULDA_Elise_Female_NightElf_TUT_PlagueLord_Turn1_EliseAnswerSelf_01);
        GameState.Get().SetBusy(false);
      }
    }
  }
