...
public class BoH_Anduin_06 : BoH_Anduin_Dungeon
{
  ...
  {
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_01,
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_02,
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_01,
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_02,
    (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_03
  };
  ...
  public BoH_Anduin_06() => this.m_gameOptions.AddBooleanOptions(BoH_Anduin_06.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6ExchangeA_02,
      (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6ExchangeA_03,
      (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6Intro_01,
      (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6Victory_02,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_02,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_03,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_04,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6EmoteResponse_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeA_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeB_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeC_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeD_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeE_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_02,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6HeroPower_03,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_01,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_02,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Idle_03,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Intro_02,
      (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Loss_01,
      (string) BoH_Anduin_06.VO_Story_Minion_SamtheWise_Male_Pandaren_TriggerDone_01
    };
  ...
  {
    BoH_Anduin_06 boHAnduin06 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHAnduin06.MissionPlayVO(actor, (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6Intro_01);
    yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Intro_02);
  ...
  public override void OnCreateGame()
  {
    ...
    this.m_standardEmoteResponseLine = (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6EmoteResponse_01;
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    {
      GameState.Get().SetBusy(true);
      while (boHAnduin06.m_enemySpeaking)
    ...
    else
    {
      ...
      switch (missionEvent)
      {
        case 102:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeA_01);
          yield return (object) boHAnduin06.MissionPlayVO(friendlyActor, (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6ExchangeA_02);
          yield return (object) boHAnduin06.MissionPlayVO(friendlyActor, (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6ExchangeA_03);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeB_01);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeC_01);
          GameState.Get().SetBusy(false);
          break;
        case 103:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeD_01);
          GameState.Get().SetBusy(false);
          break;
        case 105:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(boHAnduin06.GetEnemyActorByCardId("Story_05_SamtheWise"), (string) BoH_Anduin_06.VO_Story_Minion_SamtheWise_Male_Pandaren_TriggerDone_01);
          GameState.Get().SetBusy(false);
          break;
        case 106:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6ExchangeE_01);
          GameState.Get().SetBusy(false);
          break;
        case 228:
          GameState.Get().SetBusy(true);
          boHAnduin06.ShowMinionMoveTutorial();
          yield return (object) new WaitForSeconds(3f);
          boHAnduin06.HideNotification(boHAnduin06.m_minionMoveTutorialNotification);
          GameState.Get().SetBusy(false);
          break;
        case 504:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_01);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_03);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_02);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6_Victory_04);
          yield return (object) boHAnduin06.MissionPlayVO(friendlyActor, (string) BoH_Anduin_06.VO_Story_Hero_Anduin_Male_Human_Story_Anduin_Mission6Victory_02);
          GameState.Get().SetBusy(false);
          break;
        case 507:
          GameState.Get().SetBusy(true);
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, (string) BoH_Anduin_06.VO_Story_Hero_MonkeyKing_Male_Hozen_Story_Anduin_Mission6Loss_01);
          GameState.Get().SetBusy(false);
          break;
        case 515:
          yield return (object) boHAnduin06.MissionPlayVO(enemyActor, boHAnduin06.m_standardEmoteResponseLine);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) boHAnduin06.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Anduin_06 boHAnduin06 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHAnduin06.\u003C\u003En__1(entity);
    while (boHAnduin06.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHAnduin06.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHAnduin06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHAnduin06.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHAnduin06.\u003C\u003En__2(entity);
      yield return (object) boHAnduin06.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHAnduin06.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
