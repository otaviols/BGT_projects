...
public class ULDA_Dungeon_Boss_75h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_02,
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_03,
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_04,
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Idle_01,
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Idle_02,
    (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerDesertSpear_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerHuntersPack_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerKillCommand_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerWastelandScorpid_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Death_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_02,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_03,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_04,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_HeroPower_05,
      ...
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Idle_02,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Idle_03,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Intro_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Brann_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Elise_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Finley_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Reno_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Desert_Hare_01,
      (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Oasis_Surger_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_EmoteResponse_01;
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ULDA_Dungeon_Boss_75h uldaDungeonBoss75h = this;
    while (uldaDungeonBoss75h.m_enemySpeaking)
      yield return (object) null;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss75h.\u003C\u003En__0(missionEvent);
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      if (cardId == "ULDA_Reno")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Reno_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else if (cardId == "ULDA_Elise")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Elise_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else if (cardId == "ULDA_Brann")
      {
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Brann_01, Notification.SpeechBubbleDirection.TopRight, actor));
      }
      else
      {
        if (!(cardId == "ULDA_Finley"))
          return;
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_IntroSpecial_Finley_01, Notification.SpeechBubbleDirection.TopRight, actor));
      }
    }
    else
    {
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_75h uldaDungeonBoss75h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss75h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss75h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss75h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss75h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss75h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_719"))
      {
        if (cardId == "ULD_292")
          yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Oasis_Surger_01);
      }
      else
        yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_PlayerTrigger_Desert_Hare_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss75h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss75h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss75h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_430"))
      {
        if (!(cardId == "EX1_539"))
        {
          ...
          {
            if (cardId == "ULD_429")
              yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerHuntersPack_01);
          }
          else
            yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerWastelandScorpid_01);
        }
        else
          yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerKillCommand_01);
      }
      else
        yield return (object) uldaDungeonBoss75h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_75h.VO_ULDA_BOSS_75h_Male_NefersetTolvir_BossTriggerDesertSpear_01);
    }
  }
}
