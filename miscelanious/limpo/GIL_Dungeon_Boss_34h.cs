...
public class GIL_Dungeon_Boss_34h : GIL_Dungeon
{
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_34h_Male_Demon_Intro_01.prefab:127d0d9c805d73b4798b6a933fd79e8d", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_34h_Male_Demon_EmoteResponse_01.prefab:36cd563aa82e55f46a02e7a260706d03", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override string GetBossDeathLine() => "VO_GILA_BOSS_34h_Male_Demon_Death_01.prefab:a25d8865da590d64084a27bc4bde34e7";
