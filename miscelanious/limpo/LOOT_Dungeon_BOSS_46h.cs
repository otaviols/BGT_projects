...
public class LOOT_Dungeon_BOSS_46h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_46h_Male_Murloc_Death_01.prefab:3cc732e6f7fd04b459e5dece964b7eba";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_46h_Male_Murloc_Intro_01.prefab:71c2c439e7f1f3e42be72c6b02d4a013", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_46h_Male_Murloc_EmoteResponse_01.prefab:00a42aa4cdea4954f968e90a4c2f2758", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_46h lootDungeonBoss46h = this;
    while (lootDungeonBoss46h.m_enemySpeaking)
      yield return (object) null;
    yield return (object) lootDungeonBoss46h.PlayLoyalSideKickBetrayal(missionEvent);
  }
}
