...
public class BoH_Garrosh_01 : BoH_Garrosh_Dungeon
{
  ...
  {
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_01,
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_02,
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_03
  };
  private List<string> m_VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1IdleLines = new List<string>()
  {
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_01,
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_02,
    (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1EmoteResponse_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeA_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeB_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeC_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeD_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_02,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPower_03,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_02,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Idle_03,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Intro_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Loss_01,
      (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Victory_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeB_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeC_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeD_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1Intro_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1Victory_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Thrall_Male_Orc_Story_Garrosh_Mission1Victory_01,
      (string) BoH_Garrosh_01.VO_Story_Hero_Thrall_Male_Orc_Story_Garrosh_Mission1Victory_02
    };
  ...
  {
    BoH_Garrosh_01 boHGarrosh01 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHGarrosh01.PlayLineAlways(actor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Intro_01);
    yield return (object) boHGarrosh01.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1Intro_01);
    GameState.Get().SetBusy(false);
  }

  public override List<string> GetIdleLines() => this.m_VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1IdleLines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1HeroPowerLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1EmoteResponse_01;
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    {
      GameState.Get().SetBusy(true);
      while (boHGarrosh01.m_enemySpeaking)
    ...
    else
    {
      ...
      switch (missionEvent)
      {
        case 501:
          GameState.Get().SetBusy(true);
          yield return (object) boHGarrosh01.PlayLineAlways(actor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Victory_01);
          yield return (object) boHGarrosh01.PlayLineAlways((string) BoH_Garrosh_01.ThrallBrassRing, (string) BoH_Garrosh_01.VO_Story_Hero_Thrall_Male_Orc_Story_Garrosh_Mission1Victory_01);
          yield return (object) boHGarrosh01.PlayLineAlways((string) BoH_Garrosh_01.ThrallBrassRing, (string) BoH_Garrosh_01.VO_Story_Hero_Thrall_Male_Orc_Story_Garrosh_Mission1Victory_02);
          yield return (object) boHGarrosh01.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1Victory_01);
          GameState.Get().SetBusy(false);
          break;
        case 504:
          GameState.Get().SetBusy(true);
          yield return (object) boHGarrosh01.PlayLineAlways(actor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1Loss_01);
          GameState.Get().SetBusy(false);
          break;
        default:
          // ISSUE: reference to a compiler-generated method
          yield return (object) boHGarrosh01.\u003C\u003En__0(missionEvent);
          break;
      }
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Garrosh_01 boHGarrosh01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHGarrosh01.\u003C\u003En__1(entity);
    while (boHGarrosh01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHGarrosh01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHGarrosh01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHGarrosh01.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHGarrosh01.\u003C\u003En__2(entity);
      yield return (object) boHGarrosh01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHGarrosh01.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHGarrosh01.PlayLineAlways(enemyActor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeA_01);
        break;
      case 3:
        yield return (object) boHGarrosh01.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeB_01);
        yield return (object) boHGarrosh01.PlayLineAlways(enemyActor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeB_01);
        break;
      case 5:
        yield return (object) boHGarrosh01.PlayLineAlways(enemyActor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeC_01);
        yield return (object) boHGarrosh01.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeC_01);
        break;
      case 7:
        yield return (object) boHGarrosh01.PlayLineAlways(friendlyActor, (string) BoH_Garrosh_01.VO_Story_Hero_Garrosh_Male_Orc_Story_Garrosh_Mission1ExchangeD_01);
        yield return (object) boHGarrosh01.PlayLineAlways(enemyActor, (string) BoH_Garrosh_01.VO_Story_04_Geyah_Female_Orc_Story_Garrosh_Mission1ExchangeD_01);
        break;
    }
  }
