...
public class DALA_Dungeon_Boss_07h : DALA_Dungeon
{
  ...
  {
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_02,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_03,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_04,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_06,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_07
  };
  private static List<string> m_IdleLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Idle_01,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Idle_02,
    (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_BossBeastBig_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Death_02,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_DefeatPlayer_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_EmoteResponse_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_02,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_03,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_04,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_HeroPower_06,
      ...
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Idle_02,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Idle_03,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Intro_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_IntroKriziki_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_IntroOlBarkeye_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerFlightMaster_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerLeokk_01,
      (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerUnleashtheBeast_01
    };
  ...
  public override List<string> GetIdleLines() => DALA_Dungeon_Boss_07h.m_IdleLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_introLine = (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Intro_01;
    this.m_deathLine = (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_Death_02;
    this.m_standardEmoteResponseLine = (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_EmoteResponse_01;
  }
  ...
  {
    DALA_Dungeon_Boss_07h dalaDungeonBoss07h = this;
    while (dalaDungeonBoss07h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    switch (missionEvent)
    {
      case 101:
        yield return (object) dalaDungeonBoss07h.PlayLineOnlyOnce(actor, (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_BossBeastBig_01);
        break;
      case 102:
        yield return (object) dalaDungeonBoss07h.PlayAndRemoveRandomLineOnlyOnce(actor, DALA_Dungeon_Boss_07h.m_HeroPowerTrigger);
        break;
      case 103:
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) dalaDungeonBoss07h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "DALA_Barkeye")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_IntroOlBarkeye_01, Notification.SpeechBubbleDirection.TopRight, actor));
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DALA_Dungeon_Boss_07h dalaDungeonBoss07h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dalaDungeonBoss07h.\u003C\u003En__1(entity);
    while (dalaDungeonBoss07h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaDungeonBoss07h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      yield return (object) dalaDungeonBoss07h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss07h.m_playedLines.Add(cardId);
      if (!(cardId == "DAL_747"))
      {
        if (!(cardId == "LOEA02_10a") && !(cardId == "NEW1_033"))
        {
          if (cardId == "DAL_378" || cardId == "DAL_378ts")
            yield return (object) dalaDungeonBoss07h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerUnleashtheBeast_01);
        }
        else
          yield return (object) dalaDungeonBoss07h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerLeokk_01);
      }
      else
        yield return (object) dalaDungeonBoss07h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_07h.VO_DALA_BOSS_07h_Male_BloodElf_PlayerFlightMaster_01);
    }
  }
