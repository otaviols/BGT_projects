...
public class TRL_Dungeon_Boss_200h : TRL_Dungeon
{
  ...
  {
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Dragon_01,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Dragon_02,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Dragon_03
  };
  private List<string> m_WeaponLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Weapon_01,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Weapon_02,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Weapon_03
  };
  private List<string> m_ArmorLines = new List<string>()
  {
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_01,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_02,
    (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Death_Long_02,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Greetings_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Wow_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Threaten_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Well_Played_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Thanks_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Oops_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Sorry_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Kill_Shrine_Generic_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Kill_Shrine_Generic_02,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Kill_Shrine_Generic_03,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Kill_Shrine_Generic_04,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Shrine_Killed_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Shrine_Killed_02,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Shrine_Killed_03,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_02,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_03,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineDoesThing_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Akali_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_SpiritOfTheRhino_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Hakkar_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Janalai_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Ragewing_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_01,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_02,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Armor_03,
      (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_EVENT_Dragon_01,
  ...
  {
    base.OnCreateGame();
    TRL_Dungeon.s_deathLine = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Death_Long_02;
    TRL_Dungeon.s_responseLineGreeting = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Greetings_01;
    TRL_Dungeon.s_responseLineOops = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Oops_01;
    TRL_Dungeon.s_responseLineSorry = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Sorry_01;
    TRL_Dungeon.s_responseLineThanks = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Thanks_01;
    TRL_Dungeon.s_responseLineThreaten = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Threaten_01;
    TRL_Dungeon.s_responseLineWellPlayed = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Well_Played_01;
    TRL_Dungeon.s_responseLineWow = (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Emote_Respond_Wow_01;
  ...
  {
    TRL_Dungeon_Boss_200h trlDungeonBoss200h = this;
    while (trlDungeonBoss200h.m_enemySpeaking)
      yield return (object) null;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 1001:
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_01);
        break;
      case 1002:
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_02);
        break;
      case 1003:
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineComesBack_03);
        break;
      case 1004:
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_ShrineDoesThing_01);
        break;
      case 1005:
        yield return (object) trlDungeonBoss200h.PlayAndRemoveRandomLineOnlyOnce(actor, trlDungeonBoss200h.m_ArmorLines);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) trlDungeonBoss200h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!trlDungeonBoss200h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) trlDungeonBoss200h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      trlDungeonBoss200h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "TRL_316")
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(actor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Janalai_01);
    }
  }
    ...
    if (!trlDungeonBoss200h.m_playedLines.Contains(entity.GetCardId()))
    {
      ...
      if (!(cardId == "TRL_329"))
      {
        if (!(cardId == "TRL_327"))
        {
          ...
          {
            if (cardId == "TRL_548")
              yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(enemyActor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Ragewing_01);
          }
          else
            yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(enemyActor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Hakkar_01);
        }
        else
          yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(enemyActor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_SpiritOfTheRhino_01);
      }
      else
        yield return (object) trlDungeonBoss200h.PlayLineOnlyOnce(enemyActor, (string) TRL_Dungeon_Boss_200h.VO_TRLA_200h_Male_Troll_Play_Akali_01);
      if (entity.HasRace(TAG_RACE.DRAGON))
        yield return (object) trlDungeonBoss200h.PlayAndRemoveRandomLineOnlyOnce(enemyActor, trlDungeonBoss200h.m_DragonLines);
      if (entity.GetCardType() == TAG_CARDTYPE.WEAPON)
        yield return (object) trlDungeonBoss200h.PlayAndRemoveRandomLineOnlyOnce(enemyActor, trlDungeonBoss200h.m_WeaponLines);
    }
  }
}
