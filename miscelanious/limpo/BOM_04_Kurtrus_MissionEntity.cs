...
public abstract class BOM_04_Kurtrus_MissionEntity : GenericDungeonMissionEntity
{
  ...
  private static Map<GameEntityOption, bool> s_booleanOptions = BOM_04_Kurtrus_MissionEntity.InitBooleanOptions();
  ...
  public BOM_04_Kurtrus_MissionEntity() => this.m_gameOptions.AddBooleanOptions(BOM_04_Kurtrus_MissionEntity.s_booleanOptions);
  ...
  {
    BOM_04_Kurtrus_MissionEntity kurtrusMissionEntity = this;
    float bossHeroPowerVoLine = kurtrusMissionEntity.ChanceToPlayBossHeroPowerVOLine();
    float num = UnityEngine.Random.Range(0.0f, 1f);
    if (!kurtrusMissionEntity.m_enemySpeaking && !kurtrusMissionEntity.m_MissionDisableAutomaticVO && (double) bossHeroPowerVoLine >= (double) num && !((UnityEngine.Object) GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor() == (UnityEngine.Object) null))
      yield return (object) kurtrusMissionEntity.HandleMissionEventWithTiming(510);
  }

  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BOM_04_Kurtrus_MissionEntity kurtrusMissionEntity = this;
    if (!kurtrusMissionEntity.m_MissionDisableAutomaticVO && !kurtrusMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.FRIENDLY)
      yield return (object) kurtrusMissionEntity.HandleMissionEventWithTiming(508);
  }

  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    BOM_04_Kurtrus_MissionEntity kurtrusMissionEntity = this;
    if (!kurtrusMissionEntity.m_MissionDisableAutomaticVO && !kurtrusMissionEntity.m_enemySpeaking && entity.GetCardType() != TAG_CARDTYPE.INVALID && entity.GetCardType() == TAG_CARDTYPE.HERO_POWER && entity.GetControllerSide() == Player.Side.OPPOSING)
      yield return (object) kurtrusMissionEntity.OnBossHeroPowerPlayed(entity);
  }
  ...
  public override IEnumerator OnPlayThinkEmoteWithTiming()
  {
    ...
    if (!kurtrusMissionEntity.m_enemySpeaking)
    {
      Player currentPlayer = GameState.Get().GetCurrentPlayer();
      if (currentPlayer.IsFriendlySide() && !currentPlayer.GetHeroCard().HasActiveEmoteSound())
      {
        GameState.Get().GetOpposingSidePlayer().GetHero().GetCardId();
        if ((kurtrusMissionEntity.m_Mission_FriendlyPlayIdleLines || kurtrusMissionEntity.m_Mission_EnemyPlayIdleLines) && (double) kurtrusMissionEntity.GetThinkIdleChancePercentage() >= (double) UnityEngine.Random.Range(0.0f, 1f))
        {
          if (((double) kurtrusMissionEntity.GetThinkEmoteBossIdleChancePercentage() < (double) UnityEngine.Random.Range(0.0f, 1f) || !kurtrusMissionEntity.m_Mission_FriendlyPlayIdleLines) && kurtrusMissionEntity.m_Mission_EnemyPlayIdleLines)
          {
            if (kurtrusMissionEntity.m_Mission_EnemyPlayIdleLinesUseingEmoteSystem)
              yield return (object) kurtrusMissionEntity.MissionPlayThinkEmote(actor1);
            else
              yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.HandleMissionEventWithTiming(517));
          }
          else if (kurtrusMissionEntity.m_Mission_FriendlyPlayIdleLines)
          {
            if (kurtrusMissionEntity.m_Mission_FriendlyPlayIdleLinesUseingEmoteSystem)
              yield return (object) kurtrusMissionEntity.MissionPlayThinkEmote(actor2);
            else
              yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.HandleMissionEventWithTiming(518));
          }
        }
      }
    }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    {
      Notification.SpeechBubbleDirection speakerDirection = kurtrusMissionEntity.GetDirection(actor);
      if (kurtrusMissionEntity.m_forceAlwaysPlayLine)
        yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlayLine(actor, line, shouldPlay, 2.5f));
      ...
      if (shouldPlay() == kurtrusMissionEntity.InternalShouldPlayAlways())
        yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlaySoundAndBlockSpeech(line, speakerDirection, actor, 2.5f, parentBubbleToActor: parentBubbleToActor));
      else if (shouldPlay() == kurtrusMissionEntity.InternalShouldPlayOnlyOnce())
      {
        yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlaySoundAndBlockSpeechOnce(line, speakerDirection, actor, 2.5f, parentBubbleToActor: parentBubbleToActor));
        NotificationManager.Get().ForceAddSoundToPlayedList(line);
      }
      kurtrusMissionEntity.m_lastVOplayFinshtime = Time.time;
    }
  }
  ...
  public IEnumerator MissionPlayVO(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(Actor actor, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(actor, line, true, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    bool bPlayOrder = true)
  {
    ...
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Once && !kurtrusMissionEntity.m_forceAlwaysPlayLine)
      removeLine = true;
    string line = !bPlayOrder ? kurtrusMissionEntity.PopNextLine(lines, removeLine) : kurtrusMissionEntity.PopRandomLine(lines, removeLine);
    if (line != null)
      yield return (object) kurtrusMissionEntity.MissionPlayVO(speaker, line, bUseBubble, shouldPlay);
  }
  ...
  public IEnumerator MissionPlayVO(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnceInOrder(Actor actor, List<string> lines)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(actor, lines, new MissionEntity.ShouldPlay(((MissionEntity) kurtrusMissionEntity).InternalShouldPlayOnlyOnce), false);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
    ...
    MissionEntity.ShouldPlay shouldPlay)
  {
    ...
    kurtrusMissionEntity.m_enemySpeaking = true;
    if (kurtrusMissionEntity.m_forceAlwaysPlayLine)
      yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    if (shouldPlay() == MissionEntity.ShouldPlayValue.Always)
      yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlayBigCharacterQuoteAndWait(brassRing, line));
    else if (shouldPlay() == MissionEntity.ShouldPlayValue.Once)
    {
      yield return (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlayBigCharacterQuoteAndWaitOnce(brassRing, line));
      NotificationManager.Get().ForceAddSoundToPlayedList(line);
    }
    kurtrusMissionEntity.m_enemySpeaking = false;
  }
  ...
  public IEnumerator MissionPlayVO(AssetReference brassRing, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO((string) brassRing, line, true, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVOOnce(string minionSpeaker, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(kurtrusMissionEntity.GetActorByCardId(minionSpeaker), line, true, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayOnce));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlayVO(string minionSpeaker, string line)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) kurtrusMissionEntity.MissionPlayVO(kurtrusMissionEntity.GetActorByCardId(minionSpeaker), line, true, new MissionEntity.ShouldPlay(kurtrusMissionEntity.InternalShouldPlayAlways));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  public IEnumerator MissionPlaySound(string line)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) GameEntity.Coroutines.StartCoroutine(kurtrusMissionEntity.PlaySoundAndWait(line, (string) null, Notification.SpeechBubbleDirection.None, (Actor) null, waitTimeScale, parentBubbleToActor, delayCardSoundSpells));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  {
    yield return (object) this.MissionPlaySound(this.PopRandomLine(lines, false));
  }
