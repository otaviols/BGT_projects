...
public class BoH_Jaina_01 : BoH_Jaina_Dungeon
{
  ...
  {
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_01,
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_02,
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_03
  };
  private List<string> m_VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1IdleLines = new List<string>()
  {
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_01,
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_02,
    (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_03
  };
  ...
  public BoH_Jaina_01() => this.m_gameOptions.AddBooleanOptions(BoH_Jaina_01.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1EmoteResponse_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeB_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeC_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeC_02,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeD_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_02,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1HeroPower_03,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_02,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Idle_03,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Intro_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Loss_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Victory_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeA_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeB_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeC_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeD_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1Intro_01,
      (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1Victory_01
    };
  ...
  {
    BoH_Jaina_01 boHJaina01 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHJaina01.PlayLineAlways(actor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1Intro_01);
    yield return (object) boHJaina01.PlayLineAlways(enemyActor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Intro_01);
    GameState.Get().SetBusy(false);
  }

  public override List<string> GetIdleLines() => this.m_VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1IdleLines;
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1EmoteResponse_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    BoH_Jaina_01 boHJaina01 = this;
    while (boHJaina01.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) boHJaina01.PlayLineAlways(actor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Victory_01);
        yield return (object) boHJaina01.PlayLineAlways(friendlyActor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1Victory_01);
        GameState.Get().SetBusy(false);
        break;
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHJaina01.PlayLineAlways(actor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHJaina01.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Jaina_01 boHJaina01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHJaina01.\u003C\u003En__1(entity);
    while (boHJaina01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHJaina01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHJaina01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHJaina01.m_playedLines.Add(cardId);
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "CS2_022")
      {
        yield return (object) boHJaina01.PlayLineAlways(actor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeB_01);
        yield return (object) boHJaina01.PlayLineAlways(enemyActor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeB_01);
      }
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHJaina01.\u003C\u003En__2(entity);
      yield return (object) boHJaina01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHJaina01.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHJaina01.PlayLineAlways(friendlyActor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeA_01);
        break;
      case 4:
        yield return (object) boHJaina01.PlayLineAlways(enemyActor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeC_01);
        yield return (object) boHJaina01.PlayLineAlways(friendlyActor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeC_01);
        yield return (object) boHJaina01.PlayLineAlways(enemyActor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeC_02);
        break;
      case 8:
        yield return (object) boHJaina01.PlayLineAlways(enemyActor, (string) BoH_Jaina_01.VO_Story_Hero_Antonidas_Male_Human_Story_Jaina_Mission1ExchangeD_01);
        yield return (object) boHJaina01.PlayLineAlways(friendlyActor, (string) BoH_Jaina_01.VO_Story_Hero_Jaina_Human_Female_Story_Jaina_Mission1ExchangeD_01);
        break;
    }
  }

  public override void StartGameplaySoundtracks() => MusicManager.Get().StartPlaylist(MusicPlaylistType.InGame_LOOT);
}
