...
public class BTA_Fight_03 : BTA_Dungeon
{
  ...
  {
    (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryA_01,
    (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_VictoryB_01
  };
  ...
  public BTA_Fight_03() => this.m_gameOptions.AddBooleanOptions(BTA_Fight_03.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_Aranna_Misc_01,
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_Aranna_Response_01,
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_PlayerStart_01,
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryA_01,
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryA_Alt_01,
      (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryC_Alt_01,
      (string) BTA_Fight_03.VO_BTA_05_Male_Sporelok_Mission_Fight_03_VictoryB_Alt_01,
      (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_BronzeRingNaga_01,
      (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_Shalja_Play_01,
      (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_VictoryB_01,
      (string) BTA_Fight_03.BTA_BOSS_03h_BossStart_01,
      (string) BTA_Fight_03.VO_BTA_BOSS_10h2_Male_Sporelok_Death_02
    };
  ...
  {
    BTA_Fight_03 btaFight03 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) btaFight03.PlayLineAlways(actor, (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_PlayerStart_01);
    yield return (object) btaFight03.PlayLineAlways(enemyActor, (string) BTA_Fight_03.BTA_BOSS_03h_BossStart_01);
  ...
  {
    BTA_Fight_03 btaFight03 = this;
    while (btaFight03.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 101:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight03.PlayLineAlwaysWithBrassRing(btaFight03.GetFriendlyActorByCardId("BTA_05"), BTA_Dungeon.SklibbBrassRing, (string) BTA_Fight_03.VO_BTA_BOSS_10h2_Male_Sporelok_Death_02);
        GameState.Get().SetBusy(false);
        break;
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight03.PlayLineAlways(friendlyActor, (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryA_Alt_01);
        yield return (object) btaFight03.PlayLineAlwaysWithBrassRing(btaFight03.GetFriendlyActorByCardId("BTA_05"), BTA_Dungeon.SklibbBrassRing, (string) BTA_Fight_03.VO_BTA_05_Male_Sporelok_Mission_Fight_03_VictoryB_Alt_01);
        yield return (object) btaFight03.PlayLineAlways(friendlyActor, (string) BTA_Fight_03.VO_BTA_01_Female_NightElf_Mission_Fight_03_VictoryC_Alt_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight03.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_03 btaFight03 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight03.\u003C\u003En__1(entity);
    while (btaFight03.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight03.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight03.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (cardId == "BTA_09")
        yield return (object) btaFight03.PlayLineAlwaysWithBrassRing(btaFight03.GetFriendlyActorByCardId("BTA_09"), BTA_Dungeon.ShaljaBrassRing, (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_Shalja_Play_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight03.\u003C\u003En__2(entity);
      yield return (object) btaFight03.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight03.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    if (turn == 1)
      yield return (object) btaFight03.PlayLineAlwaysWithBrassRing(btaFight03.GetFriendlyActorByCardId("BTA_09"), BTA_Dungeon.ShaljaBrassRing, (string) BTA_Fight_03.VO_BTA_09_Female_Naga_Mission_Fight_03_BronzeRingNaga_01);
  }
}
