...
public class BTA_Fight_01 : BTA_Dungeon
{
  ...
  {
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_IdleA_01,
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_IdleB_01,
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_IdleC_01
  };
  private List<string> m_VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_Lines = new List<string>()
  {
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_01,
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_02,
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_03,
    (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_04
  };
  ...
  public BTA_Fight_01() => this.m_gameOptions.AddBooleanOptions(BTA_Fight_01.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_PlayerStart_01,
      (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_TurnOne_01,
      (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_VictoryB_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Attack_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Deteriorate_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_HandofGuldan_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_RustedVoidwalker_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_UnstableFelboltFriendlyDies_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_BossDeath_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_BossStart_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Emote_Response_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_BamboozleTrigger_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_FanofKnives_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_Sprint_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_02,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_03,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_04,
      ...
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_IdleB_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_IdleC_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_TurnOneResponse_01,
      (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_VictoryA_01
    };
  ...
  public override List<string> GetIdleLines() => this.m_VO_BTA_BOSS_01h_IdleLines;

  public override List<string> GetBossHeroPowerRandomLines() => this.m_VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_HeroPower_Lines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_deathLine = (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_BossDeath_01;
  }
  ...
  {
    BTA_Fight_01 btaFight01 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor actor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_PlayerStart_01);
    yield return (object) btaFight01.PlayLineAlways(enemyActor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_BossStart_01);
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
      return;
    Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Emote_Response_01, Notification.SpeechBubbleDirection.TopRight, actor));
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    BTA_Fight_01 btaFight01 = this;
    while (btaFight01.m_enemySpeaking)
    ...
    {
      case 101:
        yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_UnstableFelboltFriendlyDies_01);
        break;
      case 102:
        yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_BamboozleTrigger_01);
        break;
      case 500:
        yield return (object) btaFight01.PlayLineOnlyOnce(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Attack_01);
        break;
      case 501:
        GameState.Get().SetBusy(true);
        yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_VictoryA_01);
        yield return (object) btaFight01.PlayLineAlways(friendlyActor, (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_VictoryB_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) btaFight01.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BTA_Fight_01 btaFight01 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) btaFight01.\u003C\u003En__1(entity);
    while (btaFight01.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!btaFight01.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) btaFight01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight01.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "CS2_077"))
      {
        if (cardId == "EX1_129")
          yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_FanofKnives_01);
      }
      else
        yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Hero_Sprint_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) btaFight01.\u003C\u003En__2(entity);
      yield return (object) btaFight01.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      btaFight01.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      ...
      if (!(cardId == "BT_300"))
      {
        ...
        {
          if (cardId == "BTA_17")
            yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_RustedVoidwalker_01);
        }
        else
          yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_Deteriorate_01);
      }
      else
        yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_Boss_HandofGuldan_01);
    }
  }
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    if (turn == 1)
    {
      yield return (object) btaFight01.PlayLineAlways(actor, (string) BTA_Fight_01.VO_BTA_01_Female_NightElf_Mission_Fight_01_TurnOne_01);
      yield return (object) btaFight01.PlayLineAlways(enemyActor, (string) BTA_Fight_01.VO_BTA_BOSS_01h_Male_Demon_Mission_Fight_01_TurnOneResponse_01);
    }
  }
}
