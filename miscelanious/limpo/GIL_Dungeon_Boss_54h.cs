...
public class GIL_Dungeon_Boss_54h : GIL_Dungeon
{
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_54h_Male_Golem_Intro_01.prefab:a7eed47f4791e1043841fdd3da622045", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_GILA_BOSS_54h_Male_Golem_EmoteResponse_01.prefab:a5682fcdb8af9a746b62a25402984208", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override string GetBossDeathLine() => "VO_GILA_BOSS_54h_Male_Golem_Death_02.prefab:e817d284956060a4b9d8e8f9355ab6a4";
