...
public class ULDA_Dungeon_Boss_21h : ULDA_Dungeon
{
  ...
  {
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_02,
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_03,
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_04,
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_05
  };
  private List<string> m_IdleLines = new List<string>()
  {
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Idle_01,
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Idle_02,
    (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossCalltoAdventure_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossSecretkeeper_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossSubdue_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Death_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_DefeatPlayer_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_EmoteResponse_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_02,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_03,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_04,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_HeroPower_05,
      ...
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Idle_02,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Idle_03,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Intro_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_PlayerTranslatingHieroglyphics_01,
      (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_PlayerUnsealtheVault_01
    };
  ...
  {
    base.OnCreateGame();
    this.m_introLine = (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Intro_01;
    this.m_deathLine = (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_Death_01;
    this.m_standardEmoteResponseLine = (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_EmoteResponse_01;
  }
  ...
  {
    ULDA_Dungeon_Boss_21h uldaDungeonBoss21h = this;
    while (uldaDungeonBoss21h.m_enemySpeaking)
      yield return (object) null;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss21h.\u003C\u003En__0(missionEvent);
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ULDA_Dungeon_Boss_21h uldaDungeonBoss21h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) uldaDungeonBoss21h.\u003C\u003En__1(entity);
    while (uldaDungeonBoss21h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!uldaDungeonBoss21h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) uldaDungeonBoss21h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss21h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "ULD_276"))
      {
        if (cardId == "ULD_155")
          yield return (object) uldaDungeonBoss21h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_PlayerUnsealtheVault_01);
      }
      else
        yield return (object) uldaDungeonBoss21h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_PlayerTranslatingHieroglyphics_01);
    }
  }
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) uldaDungeonBoss21h.\u003C\u003En__2(entity);
      yield return (object) uldaDungeonBoss21h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      uldaDungeonBoss21h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "DAL_727"))
      {
        ...
        {
          if (cardId == "ULD_728")
            yield return (object) uldaDungeonBoss21h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossSubdue_01);
        }
        else
          yield return (object) uldaDungeonBoss21h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossSecretkeeper_01);
      }
      else
        yield return (object) uldaDungeonBoss21h.PlayLineOnlyOnce(actor, (string) ULDA_Dungeon_Boss_21h.VO_ULDA_BOSS_21h_Female_BloodElf_BossCalltoAdventure_01);
    }
  }
}
