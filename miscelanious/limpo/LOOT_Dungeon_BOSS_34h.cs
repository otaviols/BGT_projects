...
public class LOOT_Dungeon_BOSS_34h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_34h_Male_Demon_Death_01.prefab:61c182fcaec41bb4e8f14fcc0f55e4f4";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_34h_Male_Demon_Intro_01.prefab:f920329aab2358b46acc4a4078ac1d47", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_34h_Male_Demon_EmoteResponse_01.prefab:f6ab96c6db6844141868af6c3719748c", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_34h lootDungeonBoss34h = this;
    while (lootDungeonBoss34h.m_enemySpeaking)
      yield return (object) null;
    yield return (object) lootDungeonBoss34h.PlayLoyalSideKickBetrayal(missionEvent);
  }
}
