...
public class BoH_Malfurion_05 : BoH_Malfurion_Dungeon
{
  ...
  {
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_01,
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_02,
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_03
  };
  private new List<string> m_BossIdleLines = new List<string>()
  {
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_01,
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_02,
    (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_03
  };
  ...
  public BoH_Malfurion_05() => this.m_gameOptions.AddBooleanOptions(BoH_Malfurion_05.s_booleanOptions);
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5_Victory_02,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5_Victory_03,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5EmoteResponse_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_03,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_04,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeC_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_02,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5HeroPower_03,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_02,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Idle_03,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Intro_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Loss_01,
      (string) BoH_Malfurion_05.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission5ExchangeA_02,
      (string) BoH_Malfurion_05.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission5Victory_01,
      (string) BoH_Malfurion_05.VO_Story_Minion_Maiev_Female_NightElf_Story_Malfurion_Mission5ExchangeA_01,
      (string) BoH_Malfurion_05.VO_Story_Minion_Tyrande_Female_NightElf_Story_Malfurion_Mission5ExchangeB_02,
      (string) BoH_Malfurion_05.VO_Story_Minion_Tyrande_Female_NightElf_Story_Malfurion_Mission5ExchangeA_02
    };
  ...
  {
    BoH_Malfurion_05 boHMalfurion05 = this;
    Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    Actor friendlyActor = GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetActor();
    GameState.Get().SetBusy(true);
    yield return (object) boHMalfurion05.MissionPlayVO(actor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Intro_01);
    yield return (object) boHMalfurion05.MissionPlayVO(friendlyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission5ExchangeA_02);
  ...
  public override void OnCreateGame()
  {
    ...
    base.OnCreateGame();
    this.m_standardEmoteResponseLine = (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5EmoteResponse_01;
  }
  ...
  {
    BoH_Malfurion_05 boHMalfurion05 = this;
    while (boHMalfurion05.m_enemySpeaking)
    ...
    switch (missionEvent)
    {
      case 504:
        GameState.Get().SetBusy(true);
        yield return (object) boHMalfurion05.PlayLineAlways(actor, (string) BoH_Malfurion_05.VO_Story_Hero_Malfurion_Male_NightElf_Story_Malfurion_Mission5Victory_01);
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5_Victory_02);
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5_Victory_03);
        GameState.Get().SetBusy(false);
        break;
      case 507:
        GameState.Get().SetBusy(true);
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5Loss_01);
        GameState.Get().SetBusy(false);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) boHMalfurion05.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    BoH_Malfurion_05 boHMalfurion05 = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) boHMalfurion05.\u003C\u003En__1(entity);
    while (boHMalfurion05.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!boHMalfurion05.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      yield return (object) boHMalfurion05.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHMalfurion05.m_playedLines.Add(cardId);
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      yield return (object) boHMalfurion05.\u003C\u003En__2(entity);
      yield return (object) boHMalfurion05.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      boHMalfurion05.m_playedLines.Add(cardId);
      GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
  ...
  protected override IEnumerator HandleStartOfTurnWithTiming(int turn)
  {
    ...
    {
      case 1:
        yield return (object) boHMalfurion05.PlayLineAlways((string) BoH_Malfurion_05.MaievBrassRing, (string) BoH_Malfurion_05.VO_Story_Minion_Maiev_Female_NightElf_Story_Malfurion_Mission5ExchangeA_01);
        yield return (object) boHMalfurion05.PlayLineAlways((string) BoH_Malfurion_05.TyrandeBrassRing, (string) BoH_Malfurion_05.VO_Story_Minion_Tyrande_Female_NightElf_Story_Malfurion_Mission5ExchangeA_02);
        break;
      case 3:
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_01);
        yield return (object) boHMalfurion05.PlayLineAlways((string) BoH_Malfurion_05.TyrandeBrassRing, (string) BoH_Malfurion_05.VO_Story_Minion_Tyrande_Female_NightElf_Story_Malfurion_Mission5ExchangeB_02);
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_03);
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeB_04);
        break;
      case 5:
        yield return (object) boHMalfurion05.PlayLineAlways(enemyActor, (string) BoH_Malfurion_05.VO_Story_Hero_Illidan_Male_NightElf_Story_Malfurion_Mission5ExchangeC_01);
        break;
    }
  }
}
