...
public class BOTA_Lethal_Puzzle_2 : BOTA_MissionEntity
{
  ...
  private string COMPLETE_LINE = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_04;
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_EmoteResponse_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_EmoteResponse_02,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_EmoteResponse_03,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_02,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_03,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_04,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_05,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_06,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Idle_07,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Intro_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_02,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_03,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_04,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_05,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Restart_06,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Return_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_02,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_04,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_01,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_02,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_03,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_04,
      (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Lethal_05
    })
  ...
  {
    base.OnCreateGame();
    BOTA_MissionEntity.s_introLine = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Intro_01;
    BOTA_MissionEntity.s_returnLine = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Return_01;
    this.s_victoryLine_1 = (string) null;
    this.s_victoryLine_2 = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_01;
    this.s_victoryLine_3 = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_04;
    this.s_victoryLine_4 = (string) null;
    this.s_victoryLine_5 = (string) BOTA_Lethal_Puzzle_2.VO_BOTA_BOSS_14h_Female_Undead_Puzzle_02;
  ...
  {
    BOTA_Lethal_Puzzle_2 botaLethalPuzzle2 = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    switch (missionEvent)
    {
      case 99:
        while (botaLethalPuzzle2.m_enemySpeaking)
          yield return (object) null;
        GameState.Get().SetBusy(true);
        yield return (object) botaLethalPuzzle2.PlayBossLine(enemyActor, botaLethalPuzzle2.COMPLETE_LINE);
        GameState.Get().SetBusy(false);
        break;
      case 777:
        string lethalCompleteLine = botaLethalPuzzle2.GetLethalCompleteLine();
        if (lethalCompleteLine == null)
          break;
        yield return (object) botaLethalPuzzle2.PlayBossLine(enemyActor, lethalCompleteLine);
        break;
    }
  }
}
