...
public class LOOT_Dungeon_BOSS_53h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_53h2_Female_Undead_Death_01.prefab:47609d8c37e31cc42b9201af07985ed1";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_Intro_01.prefab:1b2a36b185a12124d93aa365ea6e09da", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      ...
      if (cardId == "LOOTA_BOSS_53h")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_EmoteResponse_01.prefab:bbf07041f5574b248a637c1f32854c1a", Notification.SpeechBubbleDirection.TopRight, actor));
      if (!(cardId == "LOOTA_BOSS_53h2"))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_53h2_Female_Undead_TimeRewindPlayCard1_01.prefab:0fc1a8ac09c4dff4e9c77d0e585b1e09", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_53h lootDungeonBoss53h = this;
    while (lootDungeonBoss53h.m_enemySpeaking)
      yield return (object) null;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    string str = "PLAYED_MISSION_EVENT_" + (object) missionEvent;
    if (!lootDungeonBoss53h.m_playedLines.Contains(str))
    {
      yield return (object) lootDungeonBoss53h.PlayLoyalSideKickBetrayal(missionEvent);
      switch (missionEvent)
      {
        case 101:
          ...
          if (lootDungeonBoss53h.m_ExtraTurnLines.Count == 0 || num1 < num2)
            break;
          GameState.Get().SetBusy(true);
          string randomLine = lootDungeonBoss53h.m_ExtraTurnLines[Random.Range(0, lootDungeonBoss53h.m_ExtraTurnLines.Count)];
          yield return (object) lootDungeonBoss53h.PlayLineOnlyOnce(enemyActor, randomLine);
          GameState.Get().SetBusy(false);
          lootDungeonBoss53h.m_ExtraTurnLines.Remove(randomLine);
          yield return (object) null;
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!lootDungeonBoss53h.m_playedLines.Contains(entity.GetCardId()))
    {
      yield return (object) lootDungeonBoss53h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      lootDungeonBoss53h.m_playedLines.Add(cardId);
      Actor actor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      if (!(cardId == "UNG_028t") && !(cardId == "LOOTA_830"))
      {
        if (cardId == "LOOTA_811")
          yield return (object) lootDungeonBoss53h.PlayEasterEggLine(actor, "VO_LOOTA_BOSS_53h2_Female_Undead_EventManaDestroyed_01.prefab:9380576598589cb4b8d813599e80a5a1");
      }
      else
        yield return (object) lootDungeonBoss53h.PlayEasterEggLine(actor, "VO_LOOTA_BOSS_53h2_Female_Undead_EventPlayerTimeWalk_01.prefab:670d03d507a53de41b3ad656aeb5a568");
    }
  }
}
