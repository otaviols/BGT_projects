...
public class LOOT_Dungeon_BOSS_43h : LOOT_Dungeon
{
  ...
  protected override string GetBossDeathLine() => "VO_LOOTA_BOSS_43h_Female_Djinn_Death_01.prefab:2947452bb2cf9a644983baf0e5d720e7";
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    {
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_43h_Female_Djinn_Intro_01.prefab:d807d173b15d7a349ac7633f4d6d49cb", Notification.SpeechBubbleDirection.TopRight, actor));
    }
    else
    {
      if (!MissionEntity.STANDARD_EMOTE_RESPONSE_TRIGGERS.Contains(emoteType))
        return;
      Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech("VO_LOOTA_BOSS_43h_Female_Djinn_EmoteResponse_01.prefab:b0b146264452748448f38ba8653c4152", Notification.SpeechBubbleDirection.TopRight, actor));
    }
  }

  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    LOOT_Dungeon_BOSS_43h lootDungeonBoss43h = this;
    while (lootDungeonBoss43h.m_enemySpeaking)
      yield return (object) null;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHeroCard().GetActor();
    string str = "PLAYED_MISSION_EVENT_" + (object) missionEvent;
    if (!lootDungeonBoss43h.m_playedLines.Contains(str))
    {
      yield return (object) lootDungeonBoss43h.PlayLoyalSideKickBetrayal(missionEvent);
      string randomLine;
      switch (missionEvent)
      {
        case 101:
          ...
          if (lootDungeonBoss43h.m_NormalHeroLines.Count == 0 || num1 < num2)
            break;
          randomLine = lootDungeonBoss43h.m_NormalHeroLines[Random.Range(0, lootDungeonBoss43h.m_NormalHeroLines.Count)];
          yield return (object) lootDungeonBoss43h.PlayLineOnlyOnce(enemyActor, randomLine);
          lootDungeonBoss43h.m_NormalHeroLines.Remove(randomLine);
          yield return (object) null;
        ...
        case 102:
          ...
          if (lootDungeonBoss43h.m_BurnedHeroLines.Count == 0 || num3 < num4)
            break;
          randomLine = lootDungeonBoss43h.m_BurnedHeroLines[Random.Range(0, lootDungeonBoss43h.m_BurnedHeroLines.Count)];
          yield return (object) lootDungeonBoss43h.PlayLineOnlyOnce(enemyActor, randomLine);
          lootDungeonBoss43h.m_BurnedHeroLines.Remove(randomLine);
          yield return (object) null;
          randomLine = (string) null;
          break;
      }
