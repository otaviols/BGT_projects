...
public class BoH_Rexxar_Dungeon : BoH_Rexxar_MissionEntity
{
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    BoH_Rexxar_Dungeon boHRexxarDungeon = this;
    if (num != 0)
      return false;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if (boHRexxarDungeon.m_enemySpeaking || entity.GetCardType() == TAG_CARDTYPE.INVALID || entity.GetCardType() != TAG_CARDTYPE.HERO_POWER || entity.GetControllerSide() != Player.Side.OPPOSING)
      return false;
    boHRexxarDungeon.OnBossHeroPowerPlayed(entity);
    return false;
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (boHRexxarDungeon.m_enemySpeaking)
      yield return (object) null;
    yield return (object) boHRexxarDungeon.WaitForEntitySoundToFinish(entity);
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    switch (missionEvent)
    {
      case 1000:
        ...
        if (boHRexxarDungeon.m_PlayPlayerVOLineIndex + 1 >= boHRexxarDungeon.m_PlayerVOLines.Count)
          boHRexxarDungeon.m_PlayPlayerVOLineIndex = 0;
        else
          ++boHRexxarDungeon.m_PlayPlayerVOLineIndex;
        SceneDebugger.Get().AddMessage(boHRexxarDungeon.m_PlayerVOLines[boHRexxarDungeon.m_PlayPlayerVOLineIndex]);
        yield return (object) boHRexxarDungeon.PlayBossLine(actor1, boHRexxarDungeon.m_PlayerVOLines[boHRexxarDungeon.m_PlayPlayerVOLineIndex]);
        break;
      case 1001:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(boHRexxarDungeon.m_PlayerVOLines[boHRexxarDungeon.m_PlayPlayerVOLineIndex]);
      ...
      case 1002:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        if (boHRexxarDungeon.m_PlayBossVOLineIndex + 1 >= boHRexxarDungeon.m_BossVOLines.Count)
          boHRexxarDungeon.m_PlayBossVOLineIndex = 0;
        else
          ++boHRexxarDungeon.m_PlayBossVOLineIndex;
        SceneDebugger.Get().AddMessage(boHRexxarDungeon.m_BossVOLines[boHRexxarDungeon.m_PlayBossVOLineIndex]);
        yield return (object) boHRexxarDungeon.PlayBossLine(actor2, boHRexxarDungeon.m_BossVOLines[boHRexxarDungeon.m_PlayBossVOLineIndex]);
        break;
      case 1003:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(boHRexxarDungeon.m_BossVOLines[boHRexxarDungeon.m_PlayBossVOLineIndex]);
        ...
        break;
      case 1010:
        if (boHRexxarDungeon.m_forceAlwaysPlayLine)
        {
          boHRexxarDungeon.m_forceAlwaysPlayLine = false;
          break;
        }
        boHRexxarDungeon.m_forceAlwaysPlayLine = true;
        break;
      case 58023:
      ...
      default:
        ...
        yield return (object) boHRexxarDungeon.\u003C\u003En__0(missionEvent);
        break;
    }
  }
