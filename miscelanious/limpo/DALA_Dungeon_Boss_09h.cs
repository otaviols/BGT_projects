...
public class DALA_Dungeon_Boss_09h : DALA_Dungeon
{
  ...
  {
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_01,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_02,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_03,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_04
  };
  private List<string> m_HeroPowerBigLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPowerBig_01,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPowerBig_02
  };
  private static List<string> m_IdleLines = new List<string>()
  {
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Idle_01,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Idle_02,
    (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Idle_03
  };
  ...
  public override void PreloadAssets()
  {
    ...
    {
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_BossBigMinion_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Death_02,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_DefeatPlayer_02,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_EmoteResponse_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_02,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_03,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_HeroPower_04,
      ...
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Idle_02,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Idle_03,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Intro_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_IntroGeorge_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_IntroTekahn_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerBorrowedTime_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerKelthuzad_01,
      (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerTimeWarp_01
    };
  ...
  public override List<string> GetIdleLines() => DALA_Dungeon_Boss_09h.m_IdleLines;

  public override void OnCreateGame()
  {
    base.OnCreateGame();
    this.m_introLine = (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Intro_01;
    this.m_deathLine = (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_Death_02;
    this.m_standardEmoteResponseLine = (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_EmoteResponse_01;
  }
  ...
  protected override void PlayEmoteResponse(EmoteType emoteType, CardSoundSpell emoteSpell)
  {
    ...
    if (emoteType == EmoteType.START)
    {
      if (cardId == "DALA_George")
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_IntroGeorge_01, Notification.SpeechBubbleDirection.TopRight, actor));
      else if (cardId == "DALA_Tekahn")
      {
        Gameplay.Get().StartCoroutine(this.PlaySoundAndBlockSpeech((string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_IntroTekahn_01, Notification.SpeechBubbleDirection.TopRight, actor));
      }
      else
      {
  ...
  {
    DALA_Dungeon_Boss_09h dalaDungeonBoss09h = this;
    Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
    while (dalaDungeonBoss09h.m_enemySpeaking)
      yield return (object) null;
    switch (missionEvent)
    {
      case 101:
        yield return (object) dalaDungeonBoss09h.PlayAndRemoveRandomLineOnlyOnce(enemyActor, dalaDungeonBoss09h.m_HeroPowerBigLines);
        break;
      case 102:
        yield return (object) dalaDungeonBoss09h.PlayAndRemoveRandomLineOnlyOnce(enemyActor, dalaDungeonBoss09h.m_HeroPowerLines);
        break;
      case 103:
        yield return (object) dalaDungeonBoss09h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_BossBigMinion_01);
        break;
      default:
        // ISSUE: reference to a compiler-generated method
        yield return (object) dalaDungeonBoss09h.\u003C\u003En__0(missionEvent);
        break;
    }
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    DALA_Dungeon_Boss_09h dalaDungeonBoss09h = this;
    // ISSUE: reference to a compiler-generated method
    yield return (object) dalaDungeonBoss09h.\u003C\u003En__1(entity);
    while (dalaDungeonBoss09h.m_enemySpeaking)
      yield return (object) null;
    while (entity.GetCardType() == TAG_CARDTYPE.INVALID)
      yield return (object) null;
    if (!dalaDungeonBoss09h.m_playedLines.Contains(entity.GetCardId()) || entity.GetCardType() == TAG_CARDTYPE.HERO_POWER)
    {
      Actor enemyActor = GameState.Get().GetOpposingSidePlayer().GetHero().GetCard().GetActor();
      yield return (object) dalaDungeonBoss09h.WaitForEntitySoundToFinish(entity);
      string cardId = entity.GetCardId();
      dalaDungeonBoss09h.m_playedLines.Add(cardId);
      if (!(cardId == "DALA_700"))
      {
        if (!(cardId == "FP1_013"))
        {
          if (cardId == "UNG_028t")
            yield return (object) dalaDungeonBoss09h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerTimeWarp_01);
        }
        else
          yield return (object) dalaDungeonBoss09h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerKelthuzad_01);
      }
      else
        yield return (object) dalaDungeonBoss09h.PlayLineOnlyOnce(enemyActor, (string) DALA_Dungeon_Boss_09h.VO_DALA_BOSS_09h_Female_Draenei_PlayerBorrowedTime_01);
    }
  }
