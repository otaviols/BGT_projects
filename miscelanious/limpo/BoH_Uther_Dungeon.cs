...
public class BoH_Uther_Dungeon : BoH_Uther_MissionEntity
{
  ...
  protected override IEnumerator RespondToPlayedCardWithTiming(Entity entity)
  {
    ...
    BoH_Uther_Dungeon boHUtherDungeon = this;
    if (num != 0)
      return false;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if (boHUtherDungeon.m_MissionDisableAutomaticVO || boHUtherDungeon.m_enemySpeaking || entity.GetCardType() == TAG_CARDTYPE.INVALID || entity.GetCardType() != TAG_CARDTYPE.HERO_POWER || entity.GetControllerSide() != Player.Side.OPPOSING)
      return false;
    boHUtherDungeon.OnBossHeroPowerPlayed(entity);
    return false;
  }
  ...
  protected override IEnumerator RespondToFriendlyPlayedCardWithTiming(Entity entity)
  {
    ...
    while (boHUtherDungeon.m_enemySpeaking)
      yield return (object) null;
    yield return (object) boHUtherDungeon.WaitForEntitySoundToFinish(entity);
  }
  ...
  protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
  {
    ...
    switch (missionEvent)
    {
      case 1000:
        ...
        if (boHUtherDungeon.m_PlayPlayerVOLineIndex + 1 >= boHUtherDungeon.m_PlayerVOLines.Count)
          boHUtherDungeon.m_PlayPlayerVOLineIndex = 0;
        else
          ++boHUtherDungeon.m_PlayPlayerVOLineIndex;
        SceneDebugger.Get().AddMessage(boHUtherDungeon.m_PlayerVOLines[boHUtherDungeon.m_PlayPlayerVOLineIndex]);
        yield return (object) boHUtherDungeon.PlayBossLine(actor1, boHUtherDungeon.m_PlayerVOLines[boHUtherDungeon.m_PlayPlayerVOLineIndex]);
        break;
      case 1001:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(boHUtherDungeon.m_PlayerVOLines[boHUtherDungeon.m_PlayPlayerVOLineIndex]);
      ...
      case 1002:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        if (boHUtherDungeon.m_PlayBossVOLineIndex + 1 >= boHUtherDungeon.m_BossVOLines.Count)
          boHUtherDungeon.m_PlayBossVOLineIndex = 0;
        else
          ++boHUtherDungeon.m_PlayBossVOLineIndex;
        SceneDebugger.Get().AddMessage(boHUtherDungeon.m_BossVOLines[boHUtherDungeon.m_PlayBossVOLineIndex]);
        yield return (object) boHUtherDungeon.PlayBossLine(actor2, boHUtherDungeon.m_BossVOLines[boHUtherDungeon.m_PlayBossVOLineIndex]);
        break;
      case 1003:
        GameState.Get().GetGameEntity().SetTag(GAME_TAG.MISSION_EVENT, 0);
        SceneDebugger.Get().AddMessage(boHUtherDungeon.m_BossVOLines[boHUtherDungeon.m_PlayBossVOLineIndex]);
        ...
        break;
      case 1010:
        if (boHUtherDungeon.m_forceAlwaysPlayLine)
        {
          boHUtherDungeon.m_forceAlwaysPlayLine = false;
          break;
        }
        boHUtherDungeon.m_forceAlwaysPlayLine = true;
        break;
      case 1100:
        GameState.Get().SetBusy(true);
        boHUtherDungeon.m_MissionDisableAutomaticVO = true;
        GameState.Get().SetBusy(false);
        break;
      case 1101:
        GameState.Get().SetBusy(true);
        boHUtherDungeon.m_MissionDisableAutomaticVO = false;
        GameState.Get().SetBusy(false);
        break;
      case 58023:
      ...
      default:
        ...
        yield return (object) boHUtherDungeon.\u003C\u003En__0(missionEvent);
        break;
    }
  }
