...
Coordenadas em "unidades de mundo" (ver `PLAYER_MOVE_SPEED` em `src/config/game_constants.nvgt`), sem
...
**Tasks comuns** (`COMMON_TASK_TYPES` em `src/config/game_constants.nvgt`): hoje só `swipe_card`. Regra:
